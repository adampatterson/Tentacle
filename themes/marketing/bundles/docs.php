...
<link type="text/css" rel="stylesheet" href="<?=THEME; ?>/docs/styles/main.css">
<script type="text/javascript" src="<?=THEME; ?>/docs/javascript/main.js"></script>
<script type="text/javascript" src="<?=THEME; ?>/docs/javascript/prettify.js"></script>