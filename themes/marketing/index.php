		...
		<div class="container">
			...
			<div class="row">
				<div class="span5">
					...
					<p class="lead">
						<br /><a href="<?= BASE_URL ?>download/" onClick="_gaq.push(['_trackEvent', 'Header Link', 'Download', 'v 0.9.5.2 Beta']); mixpanel.track('Content', { 'Button': 'Download', 'version': 'v 0.9.5.2 Beta' });" class="btn btn-primary btn-large btn-block">&nbsp;&nbsp;&nbsp;Download v0.9.5.2 Beta&nbsp;&nbsp;&nbsp;</a>
					</p>
				</div>
