<? load::view('template-header', array('title' => '- Step 4'));?>
  <div class="content">
	...
	<ul class="breadcrumb">
		<li><a href='#'>Lisence</a><span class="divider">/</span></li>
    ...
    <div class="row">
      <div class="span14">
		...
		<? if (file_exists('../application/config/deployment/db.php')): ?>
			<p id="results" class="pass">✔ All right everything is ready to roll, Lets install the MySQL!</p>
			<div class="one-half">
		...
		<? else: ?>
			<p id="results" class="fail">✘ Something went wrong.</p>
			<div class="one-half">
