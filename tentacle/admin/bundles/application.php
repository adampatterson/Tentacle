...
<!--
	...
	<script type="text/javascript" src="<?=TENTACLE_JS; ?>bootstrap-tabs.min.js"></script>
	<script type="text/javascript" src="<?=TENTACLE_JS; ?>bootstrap-alerts.min.js"></script>
	<script type="text/javascript" src="<?=TENTACLE_JS; ?>bootstrap-dropdown.min.js"></script>
	<script type="text/javascript" src="<?=TENTACLE_JS; ?>bootstrap-scrollspy.min.js"></script>
	<script type="text/javascript" src="<?=TENTACLE_JS; ?>bootstrap-modal.min.js"></script>
	<script type="text/javascript" src="<?=TENTACLE_JS; ?>bootstrap-twipsy.min.js"></script>
