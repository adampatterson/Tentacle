 ...
 */
window.rangy=function(){function m(a,c){var d=typeof a[c];return d==b||!!(d==e&&a[c])||"unknown"==d}function w(a,b){return!!(typeof a[b]==e&&a[b])}function a(a,b){return typeof a[b]!=j}function c(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function d(a){return a&&q(a,p)&&x(a,n)}function g(a){window.alert("Rangy not supported in your browser. Reason: "+a);r.initialized=!0;r.supported=!1}function f(){if(!r.initialized){var a,b=!1,c=!1;m(document,"createRange")&&
(a=document.createRange(),q(a,o)&&x(a,l)&&(b=!0),a.detach());if((a=w(document,"body")?document.body:document.getElementsByTagName("body")[0])&&m(a,"createTextRange"))a=a.createTextRange(),d(a)&&(c=!0);!b&&!c&&g("Neither Range nor TextRange are implemented");r.initialized=!0;r.features={implementsDomRange:b,implementsTextRange:c};b=F.concat(D);c=0;for(a=b.length;c<a;++c)try{b[c](r)}catch(e){w(window,"console")&&m(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
    e)}}}function h(a){this.name=a;this.supported=this.initialized=!1}var e="object",b="function",j="undefined",l="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),o="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
    n="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),p="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),q=c(m),s=c(w),x=c(a),r={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:m,isHostObject:w,isHostProperty:a,areHostMethods:q,areHostObjects:s,areHostProperties:x,isTextRange:d},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
    r.fail=g;r.warn=function(a){a="Rangy warning: "+a;r.config.alertOnWarn?window.alert(a):typeof window.console!=j&&typeof window.console.log!=j&&window.console.log(a)};({}).hasOwnProperty?r.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:g("hasOwnProperty not supported");var D=[],F=[];r.init=f;r.addInitListener=function(a){r.initialized?a(r):D.push(a)};var E=[];r.addCreateMissingNativeApiListener=function(a){E.push(a)};r.createMissingNativeApi=function(a){a=a||window;f();
        for(var b=0,c=E.length;b<c;++b)E[b](a)};h.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};h.prototype.warn=function(a){r.warn("Module "+this.name+": "+a)};h.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};r.createModule=function(a,b){var c=new h(a);r.modules[a]=c;F.push(function(a){b(a,c);c.initialized=!0;c.supported=!0})};r.requireModules=function(a){for(var b=0,c=a.length,d,e;b<
        c;++b){e=a[b];d=r.modules[e];if(!d||!(d instanceof h))throw Error("Module '"+e+"' not found");if(!d.supported)throw Error("Module '"+e+"' not supported");}};var B=!1,s=function(){B||(B=!0,r.initialized||f())};if(typeof window==j)g("No window found");else if(typeof document==j)g("No document found");else return m(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),m(window,"addEventListener")?window.addEventListener("load",s,!1):m(window,"attachEvent")?window.attachEvent("onload",
        s):g("Window does not have required addEventListener or attachEvent method"),r}();
rangy.createModule("DomUtil",function(m,w){function a(a){for(var b=0;a=a.previousSibling;)b++;return b}function c(a,b){var c=[],d;for(d=a;d;d=d.parentNode)c.push(d);for(d=b;d;d=d.parentNode)if(q(c,d))return d;return null}function d(a,b,c){for(c=c?a:a.parentNode;c;){a=c.parentNode;if(a===b)return c;c=a}return null}function g(a){a=a.nodeType;return 3==a||4==a||8==a}function f(a,b){var c=b.nextSibling,d=b.parentNode;c?d.insertBefore(a,c):d.appendChild(a);return a}function h(a){if(9==a.nodeType)return a;
    ...
    n.areHostMethods(p,["splitText","deleteData","insertData","appendData","cloneNode"])||w.fail("Incomplete Text Node implementation");var q=function(a,b){for(var c=a.length;c--;)if(a[c]===b)return!0;return!1};b.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,b;if(this._current){b=a.firstChild;if(!b)for(b=null;a!==this.root&&!(b=a.nextSibling);)a=a.parentNode;this._next=b}return this._current},detach:function(){this._current=this._next=this.root=
        null}};j.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+e(this.node)+":"+this.offset+")]"}};l.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};l.prototype.toString=function(){return this.message};m.dom={arrayContains:q,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==o||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
        b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:a,getNodeLength:function(a){var b;return g(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:c,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:d,isCharacterDataNode:g,insertAfter:f,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);f(c,a);return c},getDocument:h,getWindow:function(a){a=h(a);
        ...
        throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return n.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(b,e,f,g){var j;if(b==f)return e===g?0:e<g?-1:1;if(j=d(f,b,!0))return e<=a(j)?-1:1;if(j=d(b,f,!0))return a(j)<g?-1:1;e=c(b,f);b=b===e?e:d(b,e,!0);f=f===e?e:d(f,e,!0);if(b===f)throw Error("comparePoints got to case 4 and childA and childB are the same!");
        for(e=e.firstChild;e;){if(e===b)return-1;if(e===f)return 1;e=e.nextSibling}throw Error("Should not be here!");},inspectNode:e,fragmentFromNodeChildren:function(a){for(var b=h(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new b(a)},DomPosition:j};m.DOMException=l});
rangy.createModule("DomRange",function(m){function w(a,b){return 3!=a.nodeType&&(t.isAncestorOf(a,b.startContainer,!0)||t.isAncestorOf(a,b.endContainer,!0))}function a(a){return t.getDocument(a.startContainer)}function c(a,b,c){if(b=a._listeners[b])for(var d=0,e=b.length;d<e;++d)b[d].call(a,{target:a,args:c})}function d(a){return new R(a.parentNode,t.getNodeIndex(a))}function g(a){return new R(a.parentNode,t.getNodeIndex(a)+1)}function f(a,b,c){var d=11==a.nodeType?a.firstChild:a;t.isCharacterDataNode(b)?
    c==b.length?t.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:t.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function h(b){for(var c,d,e=a(b.range).createDocumentFragment();d=b.next();){c=b.isPartiallySelectedSubtree();d=d.cloneNode(!c);c&&(c=b.getSubtreeIterator(),d.appendChild(h(c)),c.detach(!0));if(10==d.nodeType)throw new N("HIERARCHY_REQUEST_ERR");e.appendChild(d)}return e}function e(a,b,c){for(var d,k,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
    b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),e(d,b,c),d.detach(!0),c.stop)break}else for(d=t.createIterator(d);k=d.next();)if(!1===b(k)){c.stop=!0;return}}function b(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),b(c),c.detach(!0)):a.remove()}function j(b){for(var c,d=a(b.range).createDocumentFragment(),e;c=b.next();){b.isPartiallySelectedSubtree()?(c=c.cloneNode(!1),e=b.getSubtreeIterator(),c.appendChild(j(e)),e.detach(!0)):b.remove();if(10==c.nodeType)throw new N("HIERARCHY_REQUEST_ERR");
    d.appendChild(c)}return d}function l(a,b,c){var d=!(!b||!b.length),k,f=!!c;d&&(k=RegExp("^("+b.join("|")+")$"));var g=[];e(new n(a,!1),function(a){(!d||k.test(a.nodeType))&&(!f||c(a))&&g.push(a)});return g}function o(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+t.inspectNode(a.startContainer)+":"+a.startOffset+", "+t.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function n(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
    ...
    this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=l(a,b,c);this._next=this.nodes[0];this._position=0}function s(a){return function(b,c){for(var d,e=c?b:b.parentNode;e;){d=e.nodeType;if(t.arrayContains(a,d))return e;e=e.parentNode}return null}}function x(a,b){if(P(a,b))throw new p("INVALID_NODE_TYPE_ERR");}function r(a){if(!a.startContainer)throw new N("INVALID_STATE_ERR");}function D(a,b){if(!t.arrayContains(b,a.nodeType))throw new p("INVALID_NODE_TYPE_ERR");
}function F(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new N("INDEX_SIZE_ERR");}function E(a,b){if(V(a,!0)!==V(b,!0))throw new N("WRONG_DOCUMENT_ERR");}function B(a){if(W(a,!0))throw new N("NO_MODIFICATION_ALLOWED_ERR");}function z(a,b){if(!a)throw new N(b);}function H(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(J,a.startContainer.nodeType)&&!V(a.startContainer,!0))&&!(!t.arrayContains(J,a.endContainer.nodeType)&&!V(a.endContainer,!0))&&a.startOffset<=
    (t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function A(a){r(a);if(!H(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function O(){}function I(a){a.START_TO_START=ia;a.START_TO_END=$;a.END_TO_END=k;a.END_TO_START=v;a.NODE_BEFORE=y;a.NODE_AFTER=K;a.NODE_BEFORE_AND_AFTER=S;a.NODE_INSIDE=X}function u(a){I(a);
    I(a.prototype)}function Y(a,b){return function(){A(this);var c=this.startContainer,d=this.startOffset,k=this.commonAncestorContainer,f=new n(this,!0);c!==k&&(c=t.getClosestAncestorIn(c,k,!0),d=g(c),c=d.node,d=d.offset);e(f,B);f.reset();k=a(f);f.detach();b(this,c,d,c,d);return k}}function T(a,c,e){function k(a,b){return function(c){r(this);D(c,L);D(aa(c),J);c=(a?d:g)(c);(b?f:i)(this,c.node,c.offset)}}function f(a,b,d){var e=a.endContainer,k=a.endOffset;if(b!==a.startContainer||d!==a.startOffset){if(aa(b)!=
    aa(e)||1==t.comparePoints(b,d,e,k))e=b,k=d;c(a,b,d,e,k)}}function i(a,b,d){var e=a.startContainer,k=a.startOffset;if(b!==a.endContainer||d!==a.endOffset){if(aa(b)!=aa(e)||-1==t.comparePoints(b,d,e,k))e=b,k=d;c(a,e,k,b,d)}}a.prototype=new O;m.util.extend(a.prototype,{setStart:function(a,b){r(this);x(a,!0);F(a,b);f(this,a,b)},setEnd:function(a,b){r(this);x(a,!0);F(a,b);i(this,a,b)},setStartBefore:k(!0,!0),setStartAfter:k(!1,!0),setEndBefore:k(!0,!1),setEndAfter:k(!1,!1),collapse:function(a){A(this);
    a?c(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):c(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){r(this);x(a,!0);c(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){r(this);x(a,!1);D(a,L);var b=d(a),a=g(a);c(this,b.node,b.offset,a.node,a.offset)},extractContents:Y(j,c),deleteContents:Y(b,c),canSurroundContents:function(){A(this);B(this.startContainer);B(this.endContainer);var a=new n(this,!0),b=a._first&&
    w(a._first,this)||a._last&&w(a._last,this);a.detach();return!b},detach:function(){e(this)},splitBoundaries:function(){A(this);var a=this.startContainer,b=this.startOffset,d=this.endContainer,e=this.endOffset,k=a===d;t.isCharacterDataNode(d)&&0<e&&e<d.length&&t.splitDataNode(d,e);t.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=t.splitDataNode(a,b),k?(e-=b,d=a):d==a.parentNode&&e>=t.getNodeIndex(a)&&e++,b=0);c(this,a,b,d,e)},normalizeBoundaries:function(){A(this);var a=this.startContainer,b=this.startOffset,
    d=this.endContainer,e=this.endOffset,k=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(d=a,e=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},f=function(c){var k=c.previousSibling;if(k&&k.nodeType==c.nodeType){a=c;var f=c.length;b=k.length;c.insertData(0,k.data);k.parentNode.removeChild(k);a==d?(e+=b,d=a):d==c.parentNode&&(k=t.getNodeIndex(c),e==k?(d=c,e=f):e>k&&e--)}},g=!0;t.isCharacterDataNode(d)?d.length==e&&k(d):(0<e&&(g=d.childNodes[e-1])&&t.isCharacterDataNode(g)&&k(g),
    g=!this.collapsed);g?t.isCharacterDataNode(a)?0==b&&f(a):b<a.childNodes.length&&(k=a.childNodes[b])&&t.isCharacterDataNode(k)&&f(k):(a=d,b=e);c(this,a,b,d,e)},collapseToPoint:function(a,b){r(this);x(a,!0);F(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&c(this,a,b,a,b)}});u(a)}function i(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
    a.endContainer)}function U(a,b,d,e,k){var f=a.startContainer!==b||a.startOffset!==d,g=a.endContainer!==e||a.endOffset!==k;a.startContainer=b;a.startOffset=d;a.endContainer=e;a.endOffset=k;i(a);c(a,"boundarychange",{startMoved:f,endMoved:g})}function G(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};i(this)}m.requireModules(["DomUtil"]);var t=m.dom,R=t.DomPosition,N=m.DOMException;n.prototype={_current:null,_next:null,_first:null,
    _last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next;a&&(this._next=a!==this._last?a.nextSibling:null,t.isCharacterDataNode(a)&&this.clonePartiallySelectedTextNodes&&(a===this.ec&&(a=a.cloneNode(!0)).deleteData(this.eo,a.length-this.eo),this._current===this.sc&&(a=a.cloneNode(!0)).deleteData(0,this.so)));return a},remove:function(){var a=this._current,b,c;t.isCharacterDataNode(a)&&
        (a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return w(this._current,this.range)},getSubtreeIterator:function(){var b;if(this.isSingleCharacterDataNode)b=this.range.cloneRange(),b.collapse();else{b=new G(a(this.range));var c=this._current,d=c,e=0,k=c,f=t.getNodeLength(c);t.isAncestorOf(c,this.sc,!0)&&(d=this.sc,e=this.so);t.isAncestorOf(c,this.ec,!0)&&(k=
        this.ec,f=this.eo);U(b,d,e,k,f)}return new n(b,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};p.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};p.prototype.toString=function(){return this.message};q.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
    detach:function(){this._current=this._next=this.nodes=null}};var L=[1,3,4,5,7,8,10],J=[2,9,11],Q=[1,3,4,5,7,8,10,11],M=[1,3,4,5,7,8],aa=t.getRootContainer,V=s([9,11]),W=s([5,6,10,12]),P=s([6,10,12]),Z=document.createElement("style"),ea=!1;try{Z.innerHTML="<b>x</b>",ea=3==Z.firstChild.nodeType}catch(fa){}m.features.htmlParsingConforms=ea;var ga="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),ia=0,$=1,k=2,v=3,y=0,K=1,S=2,X=3;O.prototype={attachListener:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){A(this);E(this.startContainer,b.startContainer);var c=a==v||a==ia?"start":"end",d=a==$||a==ia?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){A(this);D(a,Q);B(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new N("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){A(this);
    var b,c;if(this.collapsed)return a(this).createDocumentFragment();if(this.startContainer===this.endContainer&&t.isCharacterDataNode(this.startContainer))return b=this.startContainer.cloneNode(!0),b.data=b.data.slice(this.startOffset,this.endOffset),c=a(this).createDocumentFragment(),c.appendChild(b),c;c=new n(this,!0);b=h(c);c.detach();return b},canSurroundContents:function(){A(this);B(this.startContainer);B(this.endContainer);var a=new n(this,!0),b=a._first&&w(a._first,this)||a._last&&w(a._last,
    this);a.detach();return!b},surroundContents:function(a){D(a,M);if(!this.canSurroundContents())throw new p("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){A(this);for(var b=new G(a(this)),c=ga.length,d;c--;)d=ga[c],b[d]=this[d];return b},toString:function(){A(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
    a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new n(this,!0);e(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){A(this);var b=a.parentNode,c=t.getNodeIndex(a);if(!b)throw new N("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?S:y:0<b?K:X},comparePoint:function(a,b){A(this);z(a,"HIERARCHY_REQUEST_ERR");E(a,this.startContainer);return 0>t.comparePoints(a,b,this.startContainer,
    this.startOffset)?-1:0<t.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:ea?function(a){var b=this.startContainer,c=t.getDocument(b);if(!b)throw new N("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:t.isCharacterDataNode(b)&&(d=t.parentElement(b));d=null===d||"HTML"==d.nodeName&&t.isHtmlNamespace(t.getDocument(d).documentElement)&&t.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return t.fragmentFromNodeChildren(d)}:function(b){r(this);
    var c=a(this).createElement("body");c.innerHTML=b;return t.fragmentFromNodeChildren(c)},toHtml:function(){A(this);var b=a(this).createElement("div");b.appendChild(this.cloneContents());return b.innerHTML},intersectsNode:function(b,c){A(this);z(b,"NOT_FOUND_ERR");if(t.getDocument(b)!==a(this))return!1;var d=b.parentNode,e=t.getNodeIndex(b);z(d,"NOT_FOUND_ERR");var k=t.comparePoints(d,e,this.endContainer,this.endOffset),d=t.comparePoints(d,e+1,this.startContainer,this.startOffset);return c?0>=k&&0<=
    d:0>k&&0<d},isPointInRange:function(a,b){A(this);z(a,"HIERARCHY_REQUEST_ERR");E(a,this.startContainer);return 0<=t.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=t.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(b,c){A(this);if(a(b)!=a(this))throw new N("WRONG_DOCUMENT_ERR");var d=t.comparePoints(this.startContainer,this.startOffset,b.endContainer,b.endOffset),e=t.comparePoints(this.endContainer,this.endOffset,b.startContainer,b.startOffset);return c?0>=
    d&&0<=e:0>d&&0<e},intersection:function(a){if(this.intersectsRange(a)){var b=t.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=t.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),d=this.cloneRange();-1==b&&d.setStart(a.startContainer,a.startOffset);1==c&&d.setEnd(a.endContainer,a.endOffset);return d}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==t.comparePoints(a.startContainer,a.startOffset,this.startContainer,
    this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==t.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new p("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==X},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,t.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},containsNodeText:function(a){var b=
    this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){A(this);return new q(this,a,b)},getNodes:function(a,b){A(this);return l(this,a,b)},getDocument:function(){return a(this)},collapseBefore:function(a){r(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){r(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},
    equals:function(a){return G.rangesEqual(this,a)},isValid:function(){return H(this)},inspect:function(){return o(this)}};T(G,U,function(a){r(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;c(a,"detach",null);a._listeners=null});m.rangePrototype=O.prototype;G.rangeProperties=ga;G.RangeIterator=n;G.copyComparisonConstants=u;G.createPrototypeRange=T;G.inspect=o;G.getRangeDocument=a;G.rangesEqual=function(a,b){return a.startContainer===b.startContainer&&
    a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};m.DomRange=G;m.RangeException=p});
rangy.createModule("WrappedRange",function(m){function w(a,b,c,f){var h=a.duplicate();h.collapse(c);var n=h.parentElement();d.isAncestorOf(b,n,!0)||(n=b);if(!n.canHaveHTML)return new g(n.parentNode,d.getNodeIndex(n));var b=d.getDocument(n).createElement("span"),p,q=c?"StartToStart":"StartToEnd";do n.insertBefore(b,b.previousSibling),h.moveToElementText(b);while(0<(p=h.compareEndPoints(q,a))&&b.previousSibling);q=b.nextSibling;if(-1==p&&q&&d.isCharacterDataNode(q)){h.setEndPoint(c?"EndToStart":"EndToEnd",
    a);if(/[\r\n]/.test(q.data)){n=h.duplicate();c=n.text.replace(/\r\n/g,"\r").length;for(c=n.moveStart("character",c);-1==n.compareEndPoints("StartToEnd",n);)c++,n.moveStart("character",1)}else c=h.text.length;n=new g(q,c)}else q=(f||!c)&&b.previousSibling,n=(c=(f||c)&&b.nextSibling)&&d.isCharacterDataNode(c)?new g(c,0):q&&d.isCharacterDataNode(q)?new g(q,q.length):new g(n,d.getNodeIndex(b));b.parentNode.removeChild(b);return n}function a(a,b){var c,f,g=a.offset,h=d.getDocument(a.node),p=h.body.createTextRange(),
    q=d.isCharacterDataNode(a.node);q?(c=a.node,f=c.parentNode):(c=a.node.childNodes,c=g<c.length?c[g]:null,f=a.node);h=h.createElement("span");h.innerHTML="&#feff;";c?f.insertBefore(h,c):f.appendChild(h);p.moveToElementText(h);p.collapse(!b);f.removeChild(h);if(q)p[b?"moveStart":"moveEnd"]("character",g);return p}m.requireModules(["DomUtil","DomRange"]);var c,d=m.dom,g=d.DomPosition,f=m.DomRange;if(m.features.implementsDomRange&&(!m.features.implementsTextRange||!m.config.preferTextRange))(function(){function a(b){for(var c=
    g.length,d;c--;)d=g[c],b[d]=b.nativeRange[d]}var b,g=f.rangeProperties,h;c=function(b){if(!b)throw Error("Range must be specified");this.nativeRange=b;a(this)};f.createPrototypeRange(c,function(a,b,c,d,e){var f=a.endContainer!==d||a.endOffset!=e;if(a.startContainer!==b||a.startOffset!=c||f)a.setEnd(d,e),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=g.length,c;b--;)c=g[b],a[c]=null});b=c.prototype;b.selectNode=function(b){this.nativeRange.selectNode(b);a(this)};b.deleteContents=
    ...
    c.prototype=new f(document);c.prototype.refresh=function(){var a,b,c=this.textRange;a=c.parentElement();var f=c.duplicate();f.collapse(!0);b=f.parentElement();f=c.duplicate();f.collapse(!1);c=f.parentElement();b=b==c?b:d.getCommonAncestor(b,c);b=b==a?b:d.getCommonAncestor(a,b);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?b=a=w(this.textRange,b,!0,!0):(a=w(this.textRange,b,!0,!1),b=w(this.textRange,b,!1,!1));this.setStart(a.node,a.offset);this.setEnd(b.node,b.offset)};f.copyComparisonConstants(c);
    var h=function(){return this}();"undefined"==typeof h.Range&&(h.Range=c);m.createNativeRange=function(a){return(a||document).body.createTextRange()}}m.features.implementsTextRange&&(c.rangeToTextRange=function(c){if(c.collapsed)return a(new g(c.startContainer,c.startOffset),!0);var b=a(new g(c.startContainer,c.startOffset),!0),f=a(new g(c.endContainer,c.endOffset),!1),c=d.getDocument(c.startContainer).body.createTextRange();c.setEndPoint("StartToStart",b);c.setEndPoint("EndToEnd",f);return c});c.prototype.getName=
    function(){return"WrappedRange"};m.WrappedRange=c;m.createRange=function(a){return new c(m.createNativeRange(a||document))};m.createRangyRange=function(a){return new f(a||document)};m.createIframeRange=function(a){return m.createRange(d.getIframeDocument(a))};m.createIframeRangyRange=function(a){return m.createRangyRange(d.getIframeDocument(a))};m.addCreateMissingNativeApiListener(function(a){a=a.document;if(typeof a.createRange=="undefined")a.createRange=function(){return m.createRange(this)};a=
    a=null})});
rangy.createModule("WrappedSelection",function(m,w){function a(a){return(a||window).getSelection()}function c(a){return(a||window).document.selection}function d(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function g(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function f(a){var b;a instanceof x?(b=a._selectionNativeRange,b||
    (b=m.createNativeRange(q.getDocument(a.startContainer)),b.setEnd(a.endContainer,a.endOffset),b.setStart(a.startContainer,a.startOffset),a._selectionNativeRange=b,a.attachListener("detach",function(){this._selectionNativeRange=null}))):a instanceof r?b=a.nativeRange:m.features.implementsDomRange&&a instanceof q.getWindow(a.startContainer).Range&&(b=a);return b}function h(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!q.isAncestorOf(b[0],b[c])){c=
    !1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function e(a,b){var c=new r(b);a._ranges=[c];d(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function b(a){a._ranges.length=0;if("None"==a.docSelection.type)g(a);else{var b=a.docSelection.createRange();if(b&&"undefined"!=typeof b.text)e(a,b);else{a.rangeCount=b.length;for(var c,f=q.getDocument(b.item(0)),i=0;i<a.rangeCount;++i)c=m.createRange(f),c.selectNode(b.item(i)),
    a._ranges.push(c);a.isCollapsed=1==a.rangeCount&&a._ranges[0].collapsed;d(a,a._ranges[a.rangeCount-1],!1)}}}function j(a,c){for(var d=a.docSelection.createRange(),e=h(c),f=q.getDocument(d.item(0)),f=q.getBody(f).createControlRange(),g=0,i=d.length;g<i;++g)f.add(d.item(g));try{f.add(e)}catch(j){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}f.select();b(a)}function l(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
    [];this.win=c;this.refresh()}function o(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),e=0,f;e<rangeCount;++e){f=h(c[e]);try{d.add(f)}catch(g){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();b(a)}function n(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new D("WRONG_DOCUMENT_ERR");}function p(a){var b=[],c=new F(a.anchorNode,a.anchorOffset),
    d=new F(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var f=0,g=a.rangeCount;f<g;++f)b[f]=x.inspect(a.getRangeAt(f));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}m.requireModules(["DomUtil","DomRange","WrappedRange"]);m.config.checkSelectionRanges=!0;var q=m.dom,s=m.util,x=m.DomRange,r=m.WrappedRange,D=m.DOMException,F=q.DomPosition,E,B,z=m.util.isHostMethod(window,"getSelection"),
    H=m.util.isHostObject(document,"selection"),A=H&&(!z||m.config.preferTextRange);A?(E=c,m.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||q.getDocument(b.createRange().parentElement())==a}):z?(E=a,m.isSelectionValid=function(){return!0}):w.fail("Neither document.selection or window.getSelection() detected.");m.getNativeSelection=E;var z=E(),O=m.createNativeRange(document),I=q.getBody(document),u=s.areHostObjects(z,s.areHostProperties(z,["anchorOffset","focusOffset"]));
    m.features.selectionHasAnchorAndFocus=u;var Y=s.isHostMethod(z,"extend");m.features.selectionHasExtend=Y;var T="number"==typeof z.rangeCount;m.features.selectionHasRangeCount=T;var i=!1,U=!0;s.areHostMethods(z,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof z.rangeCount&&m.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";I.appendChild(a);var b=q.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
        b.close();var c=q.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);U=c.rangeCount==1;c.removeAllRanges();var e=b.cloneRange();b.setStart(d,0);e.setEnd(d,2);c.addRange(b);c.addRange(e);i=c.rangeCount==2;b.detach();e.detach();I.removeChild(a)}();m.features.selectionSupportsMultipleRanges=i;m.features.collapsedNonEditableSelectionsSupported=U;var G=!1,t;I&&s.isHostMethod(I,"createControlRange")&&(t=I.createControlRange(),
        s.areHostProperties(t,["item","add"])&&(G=!0));m.features.implementsControlRange=G;B=u?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var R;s.isHostMethod(z,"getRangeAt")?R=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:u&&(R=function(a){var b=q.getDocument(a.anchorNode),b=m.createRange(b);b.setStart(a.anchorNode,a.anchorOffset);b.setEnd(a.focusNode,a.focusOffset);if(b.collapsed!==
        this.isCollapsed){b.setStart(a.focusNode,a.focusOffset);b.setEnd(a.anchorNode,a.anchorOffset)}return b});m.getSelection=function(a){var a=a||window,b=a._rangySelection,d=E(a),e=H?c(a):null;if(b){b.nativeSelection=d;b.docSelection=e;b.refresh(a)}else{b=new l(d,e,a);a._rangySelection=b}return b};m.getIframeSelection=function(a){return m.getSelection(q.getIframeWindow(a))};t=l.prototype;if(!A&&u&&s.areHostMethods(z,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
        g(this)};var N=function(a,b){var c=x.getRangeDocument(b),c=m.createRange(c);c.collapseToPoint(b.endContainer,b.endOffset);a.nativeSelection.addRange(f(c));a.nativeSelection.extend(b.startContainer,b.startOffset);a.refresh()};t.addRange=T?function(a,b){if(G&&H&&this.docSelection.type=="Control")j(this,a);else if(b&&Y)N(this,a);else{var c;if(i)c=this.rangeCount;else{this.removeAllRanges();c=0}this.nativeSelection.addRange(f(a));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==c+1){if(m.config.checkSelectionRanges)(c=
        R(this.nativeSelection,this.rangeCount-1))&&!x.rangesEqual(c,a)&&(a=new r(c));this._ranges[this.rangeCount-1]=a;d(this,a,Q(this.nativeSelection));this.isCollapsed=B(this)}else this.refresh()}}:function(a,b){if(b&&Y)N(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};t.setRanges=function(a){if(G&&a.length>1)o(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(z,"empty")&&s.isHostMethod(O,"select")&&G&&A)t.removeAllRanges=
        function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=q.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=q.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}g(this)},t.addRange=function(a){if(this.docSelection.type=="Control")j(this,a);else{r.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
        1;this.isCollapsed=this._ranges[0].collapsed;d(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?o(this,a):b&&this.addRange(a[0])};else return w.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new D("INDEX_SIZE_ERR");return this._ranges[a]};var L;if(A)L=function(a){var c;if(m.isSelectionValid(a.win))c=a.docSelection.createRange();else{c=q.getBody(a.win.document).createTextRange();c.collapse(true)}a.docSelection.type==
        "Control"?b(a):c&&typeof c.text!="undefined"?e(a,c):g(a)};else if(s.isHostMethod(z,"getRangeAt")&&"number"==typeof z.rangeCount)L=function(a){if(G&&H&&a.docSelection.type=="Control")b(a);else{a._ranges.length=a.rangeCount=a.nativeSelection.rangeCount;if(a.rangeCount){for(var c=0,e=a.rangeCount;c<e;++c)a._ranges[c]=new m.WrappedRange(a.nativeSelection.getRangeAt(c));d(a,a._ranges[a.rangeCount-1],Q(a.nativeSelection));a.isCollapsed=B(a)}else g(a)}};else if(u&&"boolean"==typeof z.isCollapsed&&"boolean"==
        typeof O.collapsed&&m.features.implementsDomRange)L=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=R(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=B(a)}else g(a)};else return w.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;t.refresh=function(a){var b=a?this._ranges.slice(0):null;L(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
        for(;a--;)if(!x.rangesEqual(b[a],this._ranges[a]))return false;return true}};var J=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var e=0,f=c.length;e<f;++e)d||b!==c[e]?a.addRange(c[e]):d=true;a.rangeCount||g(a)};t.removeRange=G?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=h(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),e,f=false,g=0,i=c.length;g<i;++g){e=c.item(g);e!==a||f?d.add(c.item(g)):f=true}d.select();
        b(this)}else J(this,a)}:function(a){J(this,a)};var Q;!A&&u&&m.features.implementsDomRange?(Q=function(a){var b=false;a.anchorNode&&(b=q.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return Q(this)}):Q=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(a,b){n(this,a);var c=m.createRange(q.getDocument(a));c.collapseToPoint(a,
        b);this.removeAllRanges();this.addRange(c);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new D("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new D("INVALID_STATE_ERR");};t.selectAllChildren=function(a){n(this,a);var b=m.createRange(q.getDocument(a));b.selectNodeContents(a);this.removeAllRanges();
        this.addRange(b)};t.deleteFromDocument=function(){if(G&&H&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
...
rangy.createModule("CssClassApplier",function(m,w){function a(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function c(b,c){b.className?a(b,c)||(b.className+=" "+c):b.className=c}function d(a){return a.split(/\s+/).sort().join(" ")}function g(a,b){return d(a.className)==d(b.className)}function f(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function h(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
    d=d?d.toString():"";c.detach();return""!=d}function e(a){return a.getNodes([3],function(b){return h(a,b)})}function b(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,e,f;c<d;++c)if(e=a.attributes[c],f=e.name,"class"!=f&&(f=b.attributes.getNamedItem(f),e.specified!=f.specified||e.specified&&e.nodeValue!==f.nodeValue))return!1;return!0}function j(a,b){for(var c=0,d=a.attributes.length,e;c<d;++c)if(e=a.attributes[c].name,(!b||!D.arrayContains(b,e))&&a.attributes[c].specified&&
    "class"!=e)return!0;return!1}function l(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||B(a)&&!B(a.parentNode))}function o(a){return(B(a)||1!=a.nodeType&&B(a.parentNode))&&!l(a)}function n(a){return a&&1==a.nodeType&&!z.test(E(a,"display"))}function p(a){if(0==a.data.length)return!0;if(H.test(a.data))return!1;switch(E(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return n(a.previousSibling)||
    n(a.nextSibling)}function q(a,b,c,d){var e,f=0==c;if(D.isAncestorOf(b,a))return a;if(D.isCharacterDataNode(b))if(0==c)c=D.getNodeIndex(b),b=b.parentNode;else if(c==b.length)c=D.getNodeIndex(b)+1,b=b.parentNode;else throw w.createError("splitNodeAt should not be called with offset in the middle of a data node ("+c+" in "+b.data);if(D.isCharacterDataNode(b)?0==c?b.previousSibling:c==b.length?b.nextSibling:1:0<c&&c<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");f=b.childNodes[c];)e.appendChild(f);
    D.insertAfter(e,b)}return b==a?e:q(a,e.parentNode,D.getNodeIndex(e),d)}return a!=b?(e=b.parentNode,b=D.getNodeIndex(b),f||b++,q(a,e,b,d)):a}function s(a){var c=a?"nextSibling":"previousSibling";return function(d,e){var f=d.parentNode,h=d[c];if(h){if(h&&3==h.nodeType)return h}else if(e&&(h=f[c])&&1==h.nodeType&&f.tagName==h.tagName&&g(f,h)&&b(f,h))return h[a?"firstChild":"lastChild"];return null}}function x(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
    function r(a,b,c){this.cssClass=a;var e,f,g=null;if("object"==typeof b&&null!==b){c=b.tagNames;g=b.elementProperties;for(e=0;f=I[e++];)b.hasOwnProperty(f)&&(this[f]=b[f]);e=b.normalize}else e=b;this.normalize="undefined"==typeof e?!0:e;this.attrExceptions=[];e=document.createElement(this.elementTagName);this.elementProperties={};for(var h in g)g.hasOwnProperty(h)&&(u.hasOwnProperty(h)&&(h=u[h]),e[h]=g[h],this.elementProperties[h]=e[h],this.attrExceptions.push(h));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
        d(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];e=0;for(a=c.length;e<a;++e)"*"==c[e]?this.applyToAnyTagName=!0:this.tagNames.push(c[e].toLowerCase())}else this.tagNames=[this.elementTagName]}m.requireModules(["WrappedSelection","WrappedRange"]);var D=m.dom,F=function(){function a(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),E;"undefined"!=typeof window.getComputedStyle?E=function(a,b){return D.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?E=function(a,b){return a.currentStyle[b]}:w.fail("No means of obtaining computed style properties found");var B;(function(){B="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
        1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||B(a.parentNode)}})();var z=/^inline(-block|-table)?$/i,H=/[^\r\n\t\f \u200B]/,A=s(!1),O=s(!0);x.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
        this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var I=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],u={"class":"className"};r.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(b){return 1==b.nodeType&&D.arrayContains(this.tagNames,b.tagName.toLowerCase())&&a(b,
        this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||o(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&p(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],f=[],g,h=d,j=e,n=0,p=e.length,l,q,o=0,s=a.length;o<s;++o)if(l=a[o],q=A(l,!c)){if(g||(g=new x(q),f.push(g)),g.textNodes.push(l),l===d&&(h=g.firstTextNode,
        n=h.length),l===e)j=g.firstTextNode,p=g.getLength()}else g=null;if(a=O(e,!c))g||(g=new x(e),f.push(g)),g.textNodes.push(a);if(f.length){o=0;for(s=f.length;o<s;++o)f[o].doMerge();b.setStart(h,n);b.setEnd(j,p)}},createContainer:function(a){a=a.createElement(this.elementTagName);m.util.extend(a,this.elementProperties);c(a,this.cssClass);return a},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&D.arrayContains(this.tagNames,b.tagName.toLowerCase())?c(b,this.cssClass):(b=this.createContainer(D.getDocument(a)),
        a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=d(a.className)==this.elementSortedClassName){var c;a:{b=this.elementProperties;for(c in b)if(b.hasOwnProperty(c)&&a[c]!==b[c]){c=!1;break a}c=!0}b=c&&!j(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,c){b.containsNode(c)||(a=b.cloneRange(),a.selectNode(c),a.isPointInRange(b.endContainer,b.endOffset)&&(q(c,b.endContainer,b.endOffset,
        [b]),b.setEndAfter(c)),a.isPointInRange(b.startContainer,b.startOffset)&&(c=q(c,b.startContainer,b.startOffset,[b])));this.isRemovable(c)?f(c):F(c,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=e(a);if(b.length){for(var c,d=0,f=b.length;d<f;++d)c=b[d],!this.isIgnorableWhiteSpaceNode(c)&&!this.getSelfOrAncestorWithClass(c)&&this.isModifiable(c)&&this.applyToTextNode(c);a.setStart(b[0],0);c=b[b.length-1];a.setEnd(c,c.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(a){var a=
        m.getSelection(a||window),b,c=a.getAllRanges();a.removeAllRanges();for(var d=c.length;d--;)b=c[d],this.applyToRange(b),a.addRange(b)},undoToRange:function(a){a.splitBoundaries();var b=e(a),c,d,f=b[b.length-1];if(b.length){for(var g=0,h=b.length;g<h;++g)c=b[g],(d=this.getSelfOrAncestorWithClass(c))&&this.isModifiable(c)&&this.undoToTextNode(c,a,d),a.setStart(b[0],0),a.setEnd(f,f.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(a){var a=m.getSelection(a||window),b=a.getAllRanges(),
        ...
        return!0},isAppliedToSelection:function(a){for(var a=m.getSelection(a||window).getAllRanges(),b=a.length;b--;)if(!this.isAppliedToRange(a[b]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};r.util={hasClass:a,addClass:c,removeClass:F,hasSameClasses:g,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:b,
        elementHasNonClassAttributes:j,splitNodeAt:q,isEditableElement:B,isEditingHost:l,isEditable:o};m.CssClassApplier=r;m.createCssClassApplier=function(a,b,c){return new r(a,b,c)}});
rangy.createModule("SaveRestore",function(m,w){function a(a,b){var c="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),d,g=f.getDocument(a.startContainer),n=a.cloneRange();n.collapse(b);d=g.createElement("span");d.id=c;d.style.lineHeight="0";d.style.display="none";d.className="rangySelectionBoundary";d.appendChild(g.createTextNode(h));n.insertNode(d);n.detach();return d}function c(a,b,c,d){(a=(a||document).getElementById(c))?(b[d?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
    w.warn("Marker element has been removed. Cannot restore selection.")}function d(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function g(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}m.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=m.dom,h="\ufeff";m.saveSelection=function(c){var c=c||window,b=c.document;if(m.isSelectionValid(c)){var f=m.getSelection(c),g=f.getAllRanges(),h=[],n,p;g.sort(d);for(var q=0,s=g.length;q<s;++q)n=g[q],n.collapsed?(p=a(n,
    !1),h.push({markerId:p.id,collapsed:!0})):(p=a(n,!1),n=a(n,!0),h[q]={startMarkerId:n.id,endMarkerId:p.id,collapsed:!1,backwards:1==g.length&&f.isBackwards()});for(q=s-1;0<=q;--q)n=g[q],n.collapsed?n.collapseBefore((b||document).getElementById(h[q].markerId)):(n.setEndBefore((b||document).getElementById(h[q].endMarkerId)),n.setStartAfter((b||document).getElementById(h[q].startMarkerId)));f.setRanges(g);return{win:c,doc:b,rangeInfos:h,restored:!1}}w.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
    m.restoreSelection=function(a,b){if(!a.restored){for(var d=a.rangeInfos,f=m.getSelection(a.win),g=[],h=d.length,p=h-1,q,s;0<=p;--p){q=d[p];s=m.createRange(a.doc);if(q.collapsed)if(q=(a.doc||document).getElementById(q.markerId)){q.style.display="inline";var x=q.previousSibling;x&&3==x.nodeType?(q.parentNode.removeChild(q),s.collapseToPoint(x,x.length)):(s.collapseBefore(q),q.parentNode.removeChild(q))}else w.warn("Marker element has been removed. Cannot restore selection.");else c(a.doc,s,q.startMarkerId,
        !0),c(a.doc,s,q.endMarkerId,!1);1==h&&s.normalizeBoundaries();g[p]=s}1==h&&b&&m.features.selectionHasExtend&&d[0].backwards?(f.removeAllRanges(),f.addRange(g[0],!0)):f.setRanges(g);a.restored=!0}};m.removeMarkerElement=g;m.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,f;c<d;++c)f=b[c],f.collapsed?g(a.doc,f.markerId):(g(a.doc,f.startMarkerId),g(a.doc,f.endMarkerId))}});
rangy.createModule("Serializer",function(m,w){function a(b,c){var c=c||[],d=b.nodeType,f=b.childNodes,e=f.length,g=[d,b.nodeName,e].join(":"),h="",j="";switch(d){case 3:h=b.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:h="<\!--"+b.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:h="<"+g+">",j="</>"}h&&c.push(h);for(d=0;d<e;++d)a(f[d],c);j&&c.push(j);return c}function c(b){b=a(b).join("");return l(b).toString(16)}function d(a,b,c){for(var d=[],f=a,c=c||o.getDocument(a).documentElement;f&&
    f!=c;)d.push(o.getNodeIndex(f,!0)),f=f.parentNode;return d.join("/")+":"+b}function g(a,b,c){b?c||o.getDocument(b):b=(c||document).documentElement;for(var a=a.split(":"),c=a[0]?a[0].split("/"):[],d=c.length,f;d--;)if(f=parseInt(c[d],10),f<b.childNodes.length)b=b.childNodes[parseInt(c[d],10)];else throw w.createError("deserializePosition failed: node "+o.inspectNode(b)+" has no child with index "+f+", "+d);return new o.DomPosition(b,parseInt(a[1],10))}function f(a,b,f){f=f||m.DomRange.getRangeDocument(a).documentElement;
    if(!o.isAncestorOf(f,a.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");a=d(a.startContainer,a.startOffset,f)+","+d(a.endContainer,a.endOffset,f);b||(a+="{"+c(f)+"}");return a}function h(a,b,d){b?d=d||o.getDocument(b):(d=d||document,b=d.documentElement);var a=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(a),f=a[4],e=c(b);if(f&&f!==c(b))throw Error("deserializeRange: checksums of serialized range root node ("+f+") and target root node ("+
    e+") do not match");f=g(a[1],b,d);b=g(a[2],b,d);d=m.createRange(d);d.setStart(f.node,f.offset);d.setEnd(b.node,b.offset);return d}function e(a,b,d){b?d||o.getDocument(b):b=(d||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===c(b)}function b(a,b,c){for(var a=a||m.getSelection(),a=a.getAllRanges(),d=[],e=0,g=a.length;e<g;++e)d[e]=f(a[e],b,c);return d.join("|")}function j(a,b,c){b?c=c||o.getWindow(b):(c=c||window,b=c.document.documentElement);for(var a=a.split("|"),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            d=m.getSelection(c),f=[],e=0,g=a.length;e<g;++e)f[e]=h(a[e],b,c.document);d.setRanges(f);return d}m.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&w.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var l=function(){var a=null;return function(b){for(var c=[],d=0,f=b.length,e;d<f;++d)e=b.charCodeAt(d),128>e?c.push(e):2048>e?c.push(e>>6|192,e&63|128):c.push(e>>12|224,e>>6&63|128,
    e&63|128);b=-1;if(!a){for(var d=[],f=0,g;256>f;++f){g=f;for(e=8;e--;)g=1==(g&1)?g>>>1^3988292384:g>>>1;d[f]=g>>>0}a=d}d=a;f=0;for(e=c.length;f<e;++f)g=(b^c[f])&255,b=b>>>8^d[g];return(b^-1)>>>0}}(),o=m.dom;m.serializePosition=d;m.deserializePosition=g;m.serializeRange=f;m.deserializeRange=h;m.canDeserializeRange=e;m.serializeSelection=b;m.deserializeSelection=j;m.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:o.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 c=0,f=a.length;c<f;++c)if(!e(a[c],b,d))return!1;return!0};m.restoreSelectionFromCookie=function(a){var a=a||window,b;a:{b=a.document.cookie.split(/[;,]/);for(var c=0,d=b.length,f;c<d;++c)if(f=b[c].split("="),"rangySerializedSelection"==f[0].replace(/^\s+/,"")&&(f=f[1])){b=decodeURIComponent(f.replace(/\s+$/,""));break a}b=null}b&&j(b,a.doc)};m.saveSelectionCookie=function(a,c){var a=a||window,c="object"==typeof c?c:{},d=c.expires?";expires="+c.expires.toUTCString():"",f=c.path?";path="+c.path:"",
    e=c.domain?";domain="+c.domain:"",g=c.secure?";secure":"",h=b(m.getSelection(a));a.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(h)+d+f+e+g};m.getElementChecksum=c});
(function(m){(function(a,c){function d(a){var b=U[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function g(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(R,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:i.isNumeric(d)?+d:t.test(d)?i.parseJSON(d):d}catch(f){}i.data(a,b,d)}else d=c;return d}function f(a){for(var b in a)if(!("data"===b&&i.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function h(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        b,c){var d=b+"defer",f=b+"queue",e=b+"mark",k=i._data(a,d);k&&("queue"===c||!i._data(a,f))&&("mark"===c||!i._data(a,e))&&setTimeout(function(){!i._data(a,f)&&!i._data(a,e)&&(i.removeData(a,d,!0),k.fire())},0)}function e(){return!1}function b(){return!0}function j(a,b,c){b=b||0;if(i.isFunction(b))return i.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return i.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=i.grep(a,function(a){return 1===a.nodeType});if(Ya.test(b))return i.filter(b,
    d,!c);b=i.filter(b,d)}return i.grep(a,function(a){return 0<=i.inArray(a,b)===c})}function l(a){var b=Ha.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function o(a,b){if(1===b.nodeType&&i.hasData(a)){var c,d,f;d=i._data(a);var e=i._data(b,d),k=d.events;if(k)for(c in delete e.handle,e.events={},k){d=0;for(f=k[c].length;d<f;d++)i.event.add(b,c,k[c][d])}e.data&&(e.data=i.extend({},e.data))}}function n(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
b.clearAttributes();b.mergeAttributes&&b.mergeAttributes(a);c=b.nodeName.toLowerCase();if("object"===c)b.outerHTML=a.outerHTML;else if("input"===c&&("checkbox"===a.type||"radio"===a.type)){if(a.checked&&(b.defaultChecked=b.checked=a.checked),b.value!==a.value)b.value=a.value}else"option"===c?b.selected=a.defaultSelected:"input"===c||"textarea"===c?b.defaultValue=a.defaultValue:"script"===c&&b.text!==a.text&&(b.text=a.text);b.removeAttribute(i.expando);b.removeAttribute("_submit_attached");b.removeAttribute("_change_attached")}}
    function p(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function q(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function s(a){var b=(a.nodeName||"").toLowerCase();"input"===b?q(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&i.grep(a.getElementsByTagName("input"),q)}function x(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,f="width"===b?1:0;if(0<d){if("border"!==
        c)for(;4>f;f+=2)c||(d-=parseFloat(i.css(a,"padding"+la[f]))||0),d="margin"===c?d+(parseFloat(i.css(a,c+la[f]))||0):d-(parseFloat(i.css(a,"border"+la[f]+"Width"))||0);return d+"px"}d=oa(a,b);if(0>d||null==d)d=a.style[b];if(za.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>f;f+=2)d+=parseFloat(i.css(a,"padding"+la[f]))||0,"padding"!==c&&(d+=parseFloat(i.css(a,"border"+la[f]+"Width"))||0),"margin"===c&&(d+=parseFloat(i.css(a,c+la[f]))||0);return d+"px"}function r(a){return function(b,c){"string"!==
        typeof b&&(c=b,b="*");if(i.isFunction(c))for(var d=b.toLowerCase().split(La),f=0,e=d.length,k,g;f<e;f++)k=d[f],(g=/^\+/.test(k))&&(k=k.substr(1)||"*"),k=a[k]=a[k]||[],k[g?"unshift":"push"](c)}}function m(a,b,d,f,e,k){e=e||b.dataTypes[0];k=k||{};k[e]=!0;for(var e=a[e],g=0,h=e?e.length:0,j=a===Aa,i;g<h&&(j||!i);g++)i=e[g](b,d,f),"string"===typeof i&&(!j||k[i]?i=c:(b.dataTypes.unshift(i),i=m(a,b,d,f,i,k)));if((j||!i)&&!k["*"])i=m(a,b,d,f,"*",k);return i}function F(a,b){var d,f,e=i.ajaxSettings.flatOptions||
    {};for(d in b)b[d]!==c&&((e[d]?a:f||(f={}))[d]=b[d]);f&&i.extend(!0,a,f)}function E(a,b,c,d){if(i.isArray(b))i.each(b,function(b,f){c||fb.test(a)?d(a,f):E(a+"["+("object"===typeof f?b:"")+"]",f,c,d)});else if(!c&&"object"===i.type(b))for(var f in b)E(a+"["+f+"]",b[f],c,d);else d(a,b)}function B(){try{return new a.XMLHttpRequest}catch(b){}}function z(){setTimeout(w,0);return ta=i.now()}function w(){ta=c}function A(a,b){var c={};i.each(ua.concat.apply([],ua.slice(0,b)),function(){c[this]=a});return c}
    function O(a){if(!Ba[a]){var b=u.body,c=i("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){da||(da=u.createElement("iframe"),da.frameBorder=da.width=da.height=0);b.appendChild(da);if(!pa||!da.createElement)pa=(da.contentWindow||da.contentDocument).document,pa.write((i.support.boxModel?"<!doctype html>":"")+"<html><body>"),pa.close();c=pa.createElement(a);pa.body.appendChild(c);d=i.css(c,"display");b.removeChild(da)}Ba[a]=d}return Ba[a]}function I(a){return i.isWindow(a)?
        a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var u=a.document,Y=a.navigator,T=a.location,i=function(){function b(){if(!d.isReady){try{u.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},f=a.jQuery,e=a.$,k,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,h=/\S/,j=/^\s+/,i=/\s+$/,v=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,n=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,y=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
        p=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,q=/(opera)(?:.*version)?[ \/]([\w.]+)/,s=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,S=/-([a-z]|[0-9])/ig,x=/^-ms-/,r=function(a,b){return(b+"").toUpperCase()},m=Y.userAgent,va,qa,gb=Object.prototype.toString,Ca=Object.prototype.hasOwnProperty,X=Array.prototype.push,sa=Array.prototype.slice,D=String.prototype.trim,t=Array.prototype.indexOf,F={};d.fn=d.prototype={constructor:d,init:function(a,b,f){var C;if(!a)return this;if(a.nodeType)return this.context=
        this[0]=a,this.length=1,this;if("body"===a&&!b&&u.body)return this.context=u,this[0]=u.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((C="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(C[1]||!b)){if(C[1])return f=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:u,(a=v.exec(a))?d.isPlainObject(b)?(a=[u.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[f.createElement(a[1])]:(a=d.buildFragment([C[1]],[f]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
        d.merge(this,a);if((b=u.getElementById(C[2]))&&b.parentNode){if(b.id!==C[2])return f.find(a);this.length=1;this[0]=b}this.context=u;this.selector=a;return this}return!b||b.jquery?(b||f).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return f.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return sa.call(this,0)},get:function(a){return null==a?this.toArray():
        0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var f=this.constructor();d.isArray(a)?X.apply(f,a):d.merge(f,a);f.prevObject=this;f.context=this.context;"find"===b?f.selector=this.selector+(this.selector?" ":"")+c:b&&(f.selector=this.selector+"."+b+"("+c+")");return f},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();va.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
        slice:function(){return this.pushStack(sa.apply(this,arguments),"slice",sa.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:X,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,f,C,e,k=arguments[0]||{},g=1,h=arguments.length,j=!1;"boolean"===typeof k&&(j=k,k=arguments[1]||{},g=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
    {});h===g&&(k=this,--g);for(;g<h;g++)if(null!=(a=arguments[g]))for(b in a)f=k[b],C=a[b],k!==C&&(j&&C&&(d.isPlainObject(C)||(e=d.isArray(C)))?(e?(e=!1,f=f&&d.isArray(f)?f:[]):f=f&&d.isPlainObject(f)?f:{},k[b]=d.extend(j,f,C)):C!==c&&(k[b]=C));return k};d.extend({noConflict:function(b){a.$===d&&(a.$=e);b&&a.jQuery===d&&(a.jQuery=f);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!u.body)return setTimeout(d.ready,
        1);d.isReady=!0;!0!==a&&0<--d.readyWait||(va.fireWith(u,[d]),d.fn.trigger&&d(u).trigger("ready").off("ready"))}},bindReady:function(){if(!va){va=d.Callbacks("once memory");if("complete"===u.readyState)return setTimeout(d.ready,1);if(u.addEventListener)u.addEventListener("DOMContentLoaded",qa,!1),a.addEventListener("load",d.ready,!1);else if(u.attachEvent){u.attachEvent("onreadystatechange",qa);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(f){}u.documentElement.doScroll&&
        c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:F[gb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!Ca.call(a,"constructor")&&!Ca.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var f in a);
        return f===c||Ca.call(a,f)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(n.test(b.replace(l,"@").replace(y,"]").replace(p,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var f,C;try{a.DOMParser?(C=new DOMParser,f=C.parseFromString(b,"text/xml")):
        (f=new ActiveXObject("Microsoft.XMLDOM"),f.async="false",f.loadXML(b))}catch(e){f=c}(!f||!f.documentElement||f.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return f},noop:function(){},globalEval:function(b){b&&h.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(x,"ms-").replace(S,r)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,f){var C,e=0,k=a.length,g=k===c||d.isFunction(a);
        if(f)if(g)for(C in a){if(!1===b.apply(a[C],f))break}else for(;e<k&&!1!==b.apply(a[e++],f););else if(g)for(C in a){if(!1===b.call(a[C],C,a[C]))break}else for(;e<k&&!1!==b.call(a[e],e,a[e++]););return a},trim:D?function(a){return null==a?"":D.call(a)}:function(a){return null==a?"":a.toString().replace(j,"").replace(i,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var f=d.type(a);null==a.length||"string"===f||"function"===f||"regexp"===f||d.isWindow(a)?X.call(c,a):d.merge(c,a)}return c},inArray:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        b,c){var d;if(b){if(t)return t.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,f=0;if("number"===typeof b.length)for(var C=b.length;f<C;f++)a[d++]=b[f];else for(;b[f]!==c;)a[d++]=b[f++];a.length=d;return a},grep:function(a,b,c){for(var d=[],f,c=!!c,C=0,e=a.length;C<e;C++)f=!!b(a[C],C),c!==f&&d.push(a[C]);return d},map:function(a,b,f){var C,e,k=[],g=0,h=a.length;if(a instanceof d||h!==c&&"number"===typeof h&&(0<
        h&&a[0]&&a[h-1]||0===h||d.isArray(a)))for(;g<h;g++)C=b(a[g],g,f),null!=C&&(k[k.length]=C);else for(e in a)C=b(a[e],e,f),null!=C&&(k[k.length]=C);return k.concat.apply([],k)},guid:1,proxy:function(a,b){if("string"===typeof b)var f=a[b],b=a,a=f;if(!d.isFunction(a))return c;var C=sa.call(arguments,2),f=function(){return a.apply(b,C.concat(sa.call(arguments)))};f.guid=a.guid=a.guid||f.guid||d.guid++;return f},access:function(a,b,f,C,e,k,g){var h,j=null==f,i=0,v=a.length;if(f&&"object"===typeof f){for(i in f)d.access(a,
        b,i,f[i],1,k,C);e=1}else if(C!==c){h=g===c&&d.isFunction(C);j&&(h?(h=b,b=function(a,b,c){return h.call(d(a),c)}):(b.call(a,C),b=null));if(b)for(;i<v;i++)b(a[i],f,h?C.call(a[i],i,b(a[i],f)):C,g);e=1}return e?a:j?b.call(a):v?b(a[0],f):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||q.exec(a)||s.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
        a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,f){f&&f instanceof d&&!(f instanceof a)&&(f=a(f));return d.fn.init.call(this,c,f,b)};a.fn.init.prototype=a.fn;var b=a(u);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){F["[object "+b+"]"]=b.toLowerCase()});m=d.uaMatch(m);m.browser&&(d.browser[m.browser]=!0,d.browser.version=m.version);d.browser.webkit&&(d.browser.safari=!0);h.test("\u00a0")&&
    (j=/^[\s\xA0]+/,i=/[\s\xA0]+$/);k=d(u);u.addEventListener?qa=function(){u.removeEventListener("DOMContentLoaded",qa,false);d.ready()}:u.attachEvent&&(qa=function(){if(u.readyState==="complete"){u.detachEvent("onreadystatechange",qa);d.ready()}});return d}(),U={};i.Callbacks=function(a){var a=a?U[a]||d(a):{},b=[],f=[],e,k,g,h,j,v,n=function(c){var d,f,e,k;d=0;for(f=c.length;d<f;d++)e=c[d],k=i.type(e),"array"===k?n(e):"function"===k&&(!a.unique||!y.has(e))&&b.push(e)},l=function(c,d){d=d||[];e=!a.memory||
        [c,d];g=k=!0;v=h||0;h=0;for(j=b.length;b&&v<j;v++)if(!1===b[v].apply(c,d)&&a.stopOnFalse){e=!0;break}g=!1;b&&(a.once?!0===e?y.disable():b=[]:f&&f.length&&(e=f.shift(),y.fireWith(e[0],e[1])))},y={add:function(){if(b){var a=b.length;n(arguments);g?j=b.length:e&&!0!==e&&(h=a,l(e[0],e[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,f=c.length;d<f;d++)for(var e=0;e<b.length&&!(c[d]===b[e]&&(g&&e<=j&&(j--,e<=v&&v--),b.splice(e--,1),a.unique));e++);return this},has:function(a){if(b)for(var c=
        0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=f=e=c;return this},disabled:function(){return!b},lock:function(){f=c;(!e||!0===e)&&y.disable();return this},locked:function(){return!f},fireWith:function(b,c){f&&(g?a.once||f.push([b,c]):(!a.once||!e)&&l(b,c));return this},fire:function(){y.fireWith(this,arguments);return this},fired:function(){return!!k}};return y};var G=[].slice;i.extend({Deferred:function(a){var b=i.Callbacks("once memory"),
        c=i.Callbacks("once memory"),d=i.Callbacks("memory"),f="pending",e={resolve:b,reject:c,notify:d},k={done:b.add,fail:c.add,progress:d.add,state:function(){return f},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){g.done(a).fail(b).progress(c);return this},always:function(){g.done.apply(g,arguments).fail.apply(g,arguments);return this},pipe:function(a,b,c){return i.Deferred(function(d){i.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],f=b[1],C;if(i.isFunction(c))g[a](function(){if((C=
            c.apply(this,arguments))&&i.isFunction(C.promise))C.promise().then(d.resolve,d.reject,d.notify);else d[f+"With"](this===g?d:this,[C])});else g[a](d[f])})}).promise()},promise:function(a){if(null==a)a=k;else for(var b in k)a[b]=k[b];return a}},g=k.promise({}),h;for(h in e)g[h]=e[h].fire,g[h+"With"]=e[h].fireWith;g.done(function(){f="resolved"},c.disable,d.lock).fail(function(){f="rejected"},b.disable,d.lock);a&&a.call(g,g);return g},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
        G.call(arguments,0):b;--g||h.resolveWith(h,d)}}function c(a){return function(b){k[a]=1<arguments.length?G.call(arguments,0):b;h.notifyWith(j,k)}}var d=G.call(arguments,0),f=0,e=d.length,k=Array(e),g=e,h=1>=e&&a&&i.isFunction(a.promise)?a:i.Deferred(),j=h.promise();if(1<e){for(;f<e;f++)d[f]&&d[f].promise&&i.isFunction(d[f].promise)?d[f].promise().then(b(f),h.reject,c(f)):--g;g||h.resolveWith(h,d)}else h!==a&&h.resolveWith(h,e?[a]:[]);return j}});i.support=function(){var b,c,d,f,e,k,g,h,j=u.createElement("div");
        j.setAttribute("className","t");j.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=j.getElementsByTagName("*");d=j.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};f=u.createElement("select");e=f.appendChild(u.createElement("option"));c=j.getElementsByTagName("input")[0];b={leadingWhitespace:3===j.firstChild.nodeType,tbody:!j.getElementsByTagName("tbody").length,htmlSerialize:!!j.getElementsByTagName("link").length,
            style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,checkOn:"on"===c.value,optSelected:e.selected,getSetAttribute:"t"!==j.className,enctype:!!u.createElement("form").enctype,html5Clone:"<:nav></:nav>"!==u.createElement("nav").cloneNode(!0).outerHTML,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0,
            pixelMargin:!0};i.boxModel=b.boxModel="CSS1Compat"===u.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;f.disabled=!0;b.optDisabled=!e.disabled;try{delete j.test}catch(v){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=u.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
            "t");j.appendChild(c);d=u.createDocumentFragment();d.appendChild(j.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(j);if(j.attachEvent)for(g in{submit:1,change:1,focusin:1})c="on"+g,h=c in j,h||(j.setAttribute(c,"return;"),h="function"===typeof j[c]),b[g+"Bubbles"]=h;d.removeChild(j);d=f=e=j=c=null;i(function(){var c,d,f,e,g=u.getElementsByTagName("body")[0];if(g){c=u.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
            g.insertBefore(c,g.firstChild);j=u.createElement("div");c.appendChild(j);j.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";k=j.getElementsByTagName("td");h=k[0].offsetHeight===0;k[0].style.display="";k[1].style.display="none";b.reliableHiddenOffsets=h&&k[0].offsetHeight===0;if(a.getComputedStyle){j.innerHTML="";d=u.createElement("div");d.style.width="0";d.style.marginRight="0";j.style.width="2px";j.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
                null)||{marginRight:0}).marginRight,10)||0)===0}if(typeof j.style.zoom!=="undefined"){j.innerHTML="";j.style.width=j.style.padding="1px";j.style.border=0;j.style.overflow="hidden";j.style.display="inline";j.style.zoom=1;b.inlineBlockNeedsLayout=j.offsetWidth===3;j.style.display="block";j.style.overflow="visible";j.innerHTML="<div style='width:5px;'></div>";b.shrinkWrapBlocks=j.offsetWidth!==3}j.style.cssText="position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:0;visibility:hidden;";
            j.innerHTML="<div style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;display:block;'><div style='padding:0;margin:0;border:0;display:block;overflow:hidden;'></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";d=j.firstChild;f=d.firstChild;e={doesNotAddBorder:f.offsetTop!==5,doesAddBorderForTableAndCells:d.nextSibling.firstChild.firstChild.offsetTop===
                5};f.style.position="fixed";f.style.top="20px";e.fixedPosition=f.offsetTop===20||f.offsetTop===15;f.style.position=f.style.top="";d.style.overflow="hidden";d.style.position="relative";e.subtractsBorderForOverflowNotVisible=f.offsetTop===-5;e.doesNotIncludeMarginInBodyOffset=g.offsetTop!==1;if(a.getComputedStyle){j.style.marginTop="1%";b.pixelMargin=(a.getComputedStyle(j,null)||{marginTop:0}).marginTop!=="1%"}if(typeof c.style.zoom!=="undefined")c.style.zoom=1;g.removeChild(c);j=null;i.extend(b,e)}});
        return b}();var t=/^(?:\{.*\}|\[.*\])$/,R=/([A-Z])/g;i.extend({cache:{},uuid:0,expando:"jQuery"+(i.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?i.cache[a[i.expando]]:a[i.expando];return!!a&&!f(a)},data:function(a,b,d,f){if(i.acceptData(a)){var e;e=i.expando;var k="string"===typeof b,g=a.nodeType,h=g?i.cache:a,j=g?a[e]:a[e]&&e,v="events"===b;if(j&&h[j]&&(v||f||h[j].data)||!(k&&d===c)){j||
    (g?a[e]=j=++i.uuid:j=e);h[j]||(h[j]={},g||(h[j].toJSON=i.noop));if("object"===typeof b||"function"===typeof b)f?h[j]=i.extend(h[j],b):h[j].data=i.extend(h[j].data,b);e=a=h[j];f||(a.data||(a.data={}),a=a.data);d!==c&&(a[i.camelCase(b)]=d);if(v&&!a[b])return e.events;k?(d=a[b],null==d&&(d=a[i.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(i.acceptData(a)){var d,e,k,g=i.expando,h=a.nodeType,j=h?i.cache:a,v=h?a[g]:g;if(j[v]){if(b&&(d=c?j[v]:j[v].data)){i.isArray(b)||(b in d?b=[b]:(b=i.camelCase(b),
        b=b in d?[b]:b.split(" ")));e=0;for(k=b.length;e<k;e++)delete d[b[e]];if(!(c?f:i.isEmptyObject)(d))return}if(!c&&(delete j[v].data,!f(j[v])))return;i.support.deleteExpando||!j.setInterval?delete j[v]:j[v]=null;h&&(i.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return i.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=i.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});i.fn.extend({data:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                b){var d,f,e,k,h,j=this[0],v=0,n=null;if(a===c){if(this.length&&(n=i.data(j),1===j.nodeType&&!i._data(j,"parsedAttrs"))){e=j.attributes;for(h=e.length;v<h;v++)k=e[v].name,0===k.indexOf("data-")&&(k=i.camelCase(k.substring(5)),g(j,k,n[k]));i._data(j,"parsedAttrs",!0)}return n}if("object"===typeof a)return this.each(function(){i.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";f=d[1]+"!";return i.access(this,function(b){if(b===c)return n=this.triggerHandler("getData"+f,[d[0]]),n===c&&j&&(n=i.data(j,
        a),n=g(j,a,n)),n===c&&d[1]?this.data(d[0]):n;d[1]=b;this.each(function(){var c=i(this);c.triggerHandler("setData"+f,d);i.data(this,a,b);c.triggerHandler("changeData"+f,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){i.removeData(this,a)})}});i.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",i._data(a,b,(i._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(i._data(b,d)||1)-1)?i._data(b,d,a):(i.removeData(b,
        ...
        a,a="fx",d--);return arguments.length<d?i.queue(this[0],a):b===c?this:this.each(function(){var c=i.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&i.dequeue(this,a)})},dequeue:function(a){return this.each(function(){i.dequeue(this,a)})},delay:function(a,b){a=i.fx?i.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){function d(){--g||f.resolveWith(e,[e])}"string"!==
        typeof a&&(b=a,a=c);for(var a=a||"fx",f=i.Deferred(),e=this,k=e.length,g=1,h=a+"defer",j=a+"queue",v=a+"mark",n;k--;)if(n=i.data(e[k],h,c,!0)||(i.data(e[k],j,c,!0)||i.data(e[k],v,c,!0))&&i.data(e[k],h,i.Callbacks("once memory"),!0))g++,n.add(d);d();return f.promise(b)}});var N=/[\n\t\r]/g,L=/\s+/,J=/\r/g,Q=/^(?:button|input)$/i,M=/^(?:button|input|object|select|textarea)$/i,aa=/^a(?:rea)?$/i,V=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
        W=i.support.getSetAttribute,P,Z,ea;i.fn.extend({attr:function(a,b){return i.access(this,i.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){i.removeAttr(this,a)})},prop:function(a,b){return i.access(this,i.prop,a,b,1<arguments.length)},removeProp:function(a){a=i.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,f,e,k,g;if(i.isFunction(a))return this.each(function(b){i(this).addClass(a.call(this,b,this.className))});
        if(a&&"string"===typeof a){b=a.split(L);c=0;for(d=this.length;c<d;c++)if(f=this[c],1===f.nodeType)if(!f.className&&1===b.length)f.className=a;else{e=" "+f.className+" ";k=0;for(g=b.length;k<g;k++)~e.indexOf(" "+b[k]+" ")||(e+=b[k]+" ");f.className=i.trim(e)}}return this},removeClass:function(a){var b,d,f,e,k,g,h;if(i.isFunction(a))return this.each(function(b){i(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===c){b=(a||"").split(L);d=0;for(f=this.length;d<f;d++)if(e=
        this[d],1===e.nodeType&&e.className)if(a){k=(" "+e.className+" ").replace(N," ");g=0;for(h=b.length;g<h;g++)k=k.replace(" "+b[g]+" "," ");e.className=i.trim(k)}else e.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return i.isFunction(a)?this.each(function(c){i(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var f,e=0,k=i(this),g=b,h=a.split(L);f=h[e++];)g=d?g:!k.hasClass(f),k[g?"addClass":"removeClass"](f);
    else if("undefined"===c||"boolean"===c)this.className&&i._data(this,"__className__",this.className),this.className=this.className||!1===a?"":i._data(this,"__className__")||""})},hasClass:function(a){for(var a=" "+a+" ",b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&-1<(" "+this[b].className+" ").replace(N," ").indexOf(a))return!0;return!1},val:function(a){var b,d,f,e=this[0];if(arguments.length)return f=i.isFunction(a),this.each(function(d){var e=i(this);if(1===this.nodeType&&(d=f?a.call(this,
        d,e.val()):a,null==d?d="":"number"===typeof d?d+="":i.isArray(d)&&(d=i.map(d,function(a){return a==null?"":a+""})),b=i.valHooks[this.type]||i.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(e){if((b=i.valHooks[e.type]||i.valHooks[e.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(e,"value"))!==c)return d;d=e.value;return"string"===typeof d?d.replace(J,""):null==d?"":d}}});i.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
        b.specified?a.value:a.text}},select:{get:function(a){var b,c,d=a.selectedIndex,f=[],e=a.options,k="select-one"===a.type;if(0>d)return null;a=k?d:0;for(c=k?d+1:e.length;a<c;a++)if(b=e[a],b.selected&&(i.support.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!i.nodeName(b.parentNode,"optgroup"))){b=i(b).val();if(k)return b;f.push(b)}return k&&!f.length&&e.length?i(e[d]).val():f},set:function(a,b){var c=i.makeArray(b);i(a).find("option").each(function(){this.selected=
        0<=i.inArray(i(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,f){var e,k,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(f&&b in i.attrFn)return i(a)[b](d);if("undefined"===typeof a.getAttribute)return i.prop(a,b,d);if(f=1!==g||!i.isXMLDoc(a))b=b.toLowerCase(),k=i.attrHooks[b]||(V.test(b)?Z:P);if(d!==c)if(null===d)i.removeAttr(a,b);else{if(k&&"set"in k&&f&&(e=k.set(a,d,b))!==c)return e;a.setAttribute(b,
        ""+d);return d}else{if(k&&"get"in k&&f&&null!==(e=k.get(a,b)))return e;e=a.getAttribute(b);return null===e?c:e}}},removeAttr:function(a,b){var c,d,f,e,k,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(L);for(e=d.length;g<e;g++)if(f=d[g])c=i.propFix[f]||f,(k=V.test(f))||i.attr(a,f,""),a.removeAttribute(W?f:c),k&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(Q.test(a.nodeName)&&a.parentNode)i.error("type property can't be changed");else if(!i.support.radioValue&&"radio"===b&&i.nodeName(a,
        "input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return P&&i.nodeName(a,"button")?P.get(a,b):b in a?a.value:null},set:function(a,b,c){if(P&&i.nodeName(a,"button"))return P.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
        prop:function(a,b,d){var f,e,k=a.nodeType;if(a&&!(3===k||8===k||2===k)){if(1!==k||!i.isXMLDoc(a))b=i.propFix[b]||b,e=i.propHooks[b];return d!==c?e&&"set"in e&&(f=e.set(a,d,b))!==c?f:a[b]=d:e&&"get"in e&&null!==(f=e.get(a,b))?f:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):M.test(a.nodeName)||aa.test(a.nodeName)&&a.href?0:c}}}});i.attrHooks.tabindex=i.propHooks.tabIndex;Z={get:function(a,b){var d,f=i.prop(a,b);return!0===
        f||"boolean"!==typeof f&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?i.removeAttr(a,c):(b=i.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};W||(ea={name:!0,id:!0,coords:!0},P=i.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(ea[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=u.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
        i.attrHooks.tabindex.set=P.set,i.each(["width","height"],function(a,b){i.attrHooks[b]=i.extend(i.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),i.attrHooks.contenteditable={get:P.get,set:function(a,b,c){""===b&&(b="false");P.set(a,b,c)}});i.support.hrefNormalized||i.each(["href","src","width","height"],function(a,b){i.attrHooks[b]=i.extend(i.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});i.support.style||(i.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
        ...
        {set:function(a,b){if(i.isArray(b))return a.checked=i.inArray(i(a).val(),b)>=0}})});var fa=/^(?:textarea|input|select)$/i,ga=/^([^\.]*)?(?:\.(.+))?$/,ia=/(?:^|\s)hover(\.\S+)?\b/,$=/^key/,k=/^(?:mouse|contextmenu)|click/,v=/^(?:focusinfocus|focusoutblur)$/,y=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,K=function(a){if(a=y.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},S=function(a){return i.event.special.hover?a:a.replace(ia,"mouseenter$1 mouseleave$1")};
    i.event={add:function(a,b,d,f,e){var k,g,h,j,v,n,l,y,p;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(k=i._data(a)))){if(d.handler){l=d;d=l.handler;e=l.selector}if(!d.guid)d.guid=i.guid++;h=k.events;if(!h)k.events=h={};g=k.handle;if(!g){k.handle=g=function(a){return typeof i!=="undefined"&&(!a||i.event.triggered!==a.type)?i.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=i.trim(S(b)).split(" ");for(k=0;k<b.length;k++){j=ga.exec(b[k])||[];v=j[1];n=(j[2]||"").split(".").sort();p=i.event.special[v]||
    {};v=(e?p.delegateType:p.bindType)||v;p=i.event.special[v]||{};j=i.extend({type:v,origType:j[1],data:f,handler:d,guid:d.guid,selector:e,quick:e&&K(e),namespace:n.join(".")},l);y=h[v];if(!y){y=h[v]=[];y.delegateCount=0;if(!p.setup||p.setup.call(a,f,n,g)===false)a.addEventListener?a.addEventListener(v,g,false):a.attachEvent&&a.attachEvent("on"+v,g)}if(p.add){p.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}e?y.splice(y.delegateCount++,0,j):y.push(j);i.event.global[v]=true}a=null}},global:{},
        remove:function(a,b,c,d,f){var e=i.hasData(a)&&i._data(a),k,g,h,j,v,n,l,y,p,o;if(e&&(l=e.events)){b=i.trim(S(b||"")).split(" ");for(k=0;k<b.length;k++){g=ga.exec(b[k])||[];h=j=g[1];g=g[2];if(h){y=i.event.special[h]||{};h=(d?y.delegateType:y.bindType)||h;p=l[h]||[];v=p.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(n=0;n<p.length;n++){o=p[n];if((f||j===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){p.splice(n--,
            1);o.selector&&p.delegateCount--;y.remove&&y.remove.call(a,o)}}if(p.length===0&&v!==p.length){(!y.teardown||y.teardown.call(a,g)===false)&&i.removeEvent(a,h,e.handle);delete l[h]}}else for(h in l)i.event.remove(a,h+b[k],c,d,true)}if(i.isEmptyObject(l)){if(b=e.handle)b.elem=null;i.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,f,e){if(!f||!(f.nodeType===3||f.nodeType===8)){var k=b.type||b,g=[],h,j,n,l,y;if(!v.test(k+i.event.triggered)){if(k.indexOf("!")>=
            0){k=k.slice(0,-1);h=true}if(k.indexOf(".")>=0){g=k.split(".");k=g.shift();g.sort()}if(f&&!i.event.customEvent[k]||i.event.global[k]){b=typeof b==="object"?b[i.expando]?b:new i.Event(k,b):new i.Event(k);b.type=k;b.isTrigger=true;b.exclusive=h;b.namespace=g.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;h=k.indexOf(":")<0?"on"+k:"";if(f){b.result=c;if(!b.target)b.target=f;d=d!=null?i.makeArray(d):[];d.unshift(b);n=i.event.special[k]||{};if(!(n.trigger&&
            n.trigger.apply(f,d)===false)){y=[[f,n.bindType||k]];if(!e&&!n.noBubble&&!i.isWindow(f)){l=n.delegateType||k;g=v.test(l+k)?f:f.parentNode;for(j=null;g;g=g.parentNode){y.push([g,l]);j=g}j&&j===f.ownerDocument&&y.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<y.length&&!b.isPropagationStopped();j++){g=y[j][0];b.type=y[j][1];(l=(i._data(g,"events")||{})[b.type]&&i._data(g,"handle"))&&l.apply(g,d);(l=h&&g[h])&&i.acceptData(g)&&l.apply(g,d)===false&&b.preventDefault()}b.type=k;if(!e&&!b.isDefaultPrevented()&&
            (!n._default||n._default.apply(f.ownerDocument,d)===false)&&!(k==="click"&&i.nodeName(f,"a"))&&i.acceptData(f))if(h&&f[k]&&(k!=="focus"&&k!=="blur"||b.target.offsetWidth!==0)&&!i.isWindow(f)){(j=f[h])&&(f[h]=null);i.event.triggered=k;f[k]();i.event.triggered=c;j&&(f[h]=j)}return b.result}}else{f=i.cache;for(j in f)f[j].events&&f[j].events[k]&&i.event.trigger(b,d,f[j].handle.elem,true)}}}}},dispatch:function(b){var b=i.event.fix(b||a.event),d=(i._data(this,"events")||{})[b.type]||[],f=d.delegateCount,
            e=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=i.event.special[b.type]||{},h=[],j,v,n,l,y,p,o;e[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(f&&!(b.button&&b.type==="click")){n=i(this);n.context=this.ownerDocument||this;for(v=b.target;v!=this;v=v.parentNode||this)if(v.disabled!==true){y={};p=[];n[0]=v;for(j=0;j<f;j++){l=d[j];o=l.selector;if(y[o]===c){var q=y,s=o,K;if(l.quick){K=l.quick;var S=v.attributes||{};K=(!K[1]||v.nodeName.toLowerCase()===
            K[1])&&(!K[2]||(S.id||{}).value===K[2])&&(!K[3]||K[3].test((S["class"]||{}).value))}else K=n.is(o);q[s]=K}y[o]&&p.push(l)}p.length&&h.push({elem:v,matches:p})}}d.length>f&&h.push({elem:this,matches:d.slice(f)});for(j=0;j<h.length&&!b.isPropagationStopped();j++){f=h[j];b.currentTarget=f.elem;for(d=0;d<f.matches.length&&!b.isImmediatePropagationStopped();d++){l=f.matches[d];if(k||!b.namespace&&!l.namespace||b.namespace_re&&b.namespace_re.test(l.namespace)){b.data=l.data;b.handleObj=l;l=((i.event.special[l.origType]||
        {}).handle||l.handler).apply(f.elem,e);if(l!==c){b.result=l;if(l===false){b.preventDefault();b.stopPropagation()}}}}}g.postDispatch&&g.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
            return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,f,e=b.button,k=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||u;f=d.documentElement;d=d.body;a.pageX=b.clientX+(f&&f.scrollLeft||d&&d.scrollLeft||0)-(f&&f.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(f&&f.scrollTop||d&&d.scrollTop||0)-(f&&f.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&k)a.relatedTarget=
            k===a.target?b.toElement:k;if(!a.which&&e!==c)a.which=e&1?1:e&2?3:e&4?2:0;return a}},fix:function(a){if(a[i.expando])return a;var b,d,f=a,e=i.event.fixHooks[a.type]||{},k=e.props?this.props.concat(e.props):this.props,a=i.Event(f);for(b=k.length;b;){d=k[--b];a[d]=f[d]}if(!a.target)a.target=f.srcElement||u;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return e.filter?e.filter(a,f):a},special:{ready:{setup:i.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
        ...
        c,false)}:function(a,b,c){a.detachEvent&&a.detachEvent("on"+b,c)};i.Event=function(a,c){if(!(this instanceof i.Event))return new i.Event(a,c);if(a&&a.type){this.originalEvent=a;this.type=a.type;this.isDefaultPrevented=a.defaultPrevented||a.returnValue===false||a.getPreventDefault&&a.getPreventDefault()?b:e}else this.type=a;c&&i.extend(this,c);this.timeStamp=a&&a.timeStamp||i.now();this[i.expando]=true};i.Event.prototype={preventDefault:function(){this.isDefaultPrevented=b;var a=this.originalEvent;
        if(a)a.preventDefault?a.preventDefault():a.returnValue=false},stopPropagation:function(){this.isPropagationStopped=b;var a=this.originalEvent;if(a){a.stopPropagation&&a.stopPropagation();a.cancelBubble=true}},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=b;this.stopPropagation()},isDefaultPrevented:e,isPropagationStopped:e,isImmediatePropagationStopped:e};i.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){i.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c=
        a.relatedTarget,d=a.handleObj,f;if(!c||c!==this&&!i.contains(this,c)){a.type=d.origType;f=d.handler.apply(this,arguments);a.type=b}return f}}});i.support.submitBubbles||(i.event.special.submit={setup:function(){if(i.nodeName(this,"form"))return false;i.event.add(this,"click._submit keypress._submit",function(a){a=a.target;if((a=i.nodeName(a,"input")||i.nodeName(a,"button")?a.form:c)&&!a._submit_attached){i.event.add(a,"submit._submit",function(a){a._submit_bubble=true});a._submit_attached=true}})},
        postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&i.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(i.nodeName(this,"form"))return false;i.event.remove(this,"._submit")}});i.support.changeBubbles||(i.event.special.change={setup:function(){if(fa.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){i.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
        true});i.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;i.event.simulate("change",this,a,true)}})}return false}i.event.add(this,"beforeactivate._change",function(a){a=a.target;if(fa.test(a.nodeName)&&!a._change_attached){i.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&i.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
        a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){i.event.remove(this,"._change");return fa.test(this.nodeName)}});i.support.focusinBubbles||i.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){i.event.simulate(b,a.target,i.event.fix(a),true)};i.event.special[b]={setup:function(){c++===0&&u.addEventListener(a,d,true)},teardown:function(){--c===0&&u.removeEventListener(a,d,true)}}});i.fn.extend({on:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 b,d,f,k){var g,h;if(typeof a==="object"){if(typeof b!=="string"){d=d||b;b=c}for(h in a)this.on(h,b,d,a[h],k);return this}if(d==null&&f==null){f=b;d=b=c}else if(f==null)if(typeof b==="string"){f=d;d=c}else{f=d;d=b;b=c}if(f===false)f=e;else if(!f)return this;if(k===1){g=f;f=function(a){i().off(a);return g.apply(this,arguments)};f.guid=g.guid||(g.guid=i.guid++)}return this.each(function(){i.event.add(this,a,f,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){if(a&&a.preventDefault&&
        a.handleObj){var f=a.handleObj;i(a.delegateTarget).off(f.namespace?f.origType+"."+f.namespace:f.origType,f.selector,f.handler);return this}if(typeof a==="object"){for(f in a)this.off(f,b,a[f]);return this}if(b===false||typeof b==="function"){d=b;b=c}d===false&&(d=e);return this.each(function(){i.event.remove(this,a,d,b)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},live:function(a,b,c){i(this.context).on(a,this.selector,b,c);return this},die:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     b){i(this.context).off(a,this.selector||"**",b);return this},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return arguments.length==1?this.off(a,"**"):this.off(b,a,c)},trigger:function(a,b){return this.each(function(){i.event.trigger(a,b,this)})},triggerHandler:function(a,b){if(this[0])return i.event.trigger(a,b,this[0],true)},toggle:function(a){var b=arguments,c=a.guid||i.guid++,d=0,f=function(c){var f=(i._data(this,"lastToggle"+a.guid)||0)%d;i._data(this,"lastToggle"+
        ...
        0?this.on(b,null,a,c):this.trigger(b)};i.attrFn&&(i.attrFn[b]=true);if($.test(b))i.event.fixHooks[b]=i.event.keyHooks;if(k.test(b))i.event.fixHooks[b]=i.event.mouseHooks});(function(){function a(b,c,d,e,k,g){for(var k=0,h=e.length;k<h;k++){var j=e[k];if(j){for(var i=false,j=j[b];j;){if(j[f]===d){i=e[j.sizset];break}if(j.nodeType===1&&!g){j[f]=d;j.sizset=k}if(j.nodeName.toLowerCase()===c){i=j;break}j=j[b]}e[k]=i}}}function b(a,c,d,e,k,g){for(var k=0,h=e.length;k<h;k++){var j=e[k];if(j){for(var i=false,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          j=j[a];j;){if(j[f]===d){i=e[j.sizset];break}if(j.nodeType===1){if(!g){j[f]=d;j.sizset=k}if(typeof c!=="string"){if(j===c){i=true;break}}else if(l.filter(c,[j]).length>0){i=j;break}}j=j[a]}e[k]=i}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,f="sizcache"+(Math.random()+"").replace(".",""),e=0,k=Object.prototype.toString,g=false,h=true,j=/\\/g,v=/\r\n/g,n=/\W/;[0,0].sort(function(){h=false;return 0});var l=
        function(a,b,c,f){var c=c||[],e=b=b||u;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,h,j,i,v,C=true,n=l.isXML(b),y=[],q=a;do{d.exec("");if(g=d.exec(q)){q=g[3];y.push(g[1]);if(g[2]){i=g[3];break}}}while(g);if(y.length>1&&o.exec(a))if(y.length===2&&p.relative[y[0]])h=m(y[0]+y[1],b,f);else for(h=p.relative[y[0]]?[b]:l(y.shift(),b);y.length;){a=y.shift();p.relative[a]&&(a=a+y.shift());h=m(a,h,f)}else{if(!f&&y.length>1&&b.nodeType===9&&!n&&p.match.ID.test(y[0])&&
            !p.match.ID.test(y[y.length-1])){g=l.find(y.shift(),b,n);b=g.expr?l.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=f?{expr:y.pop(),set:s(f)}:l.find(y.pop(),y.length===1&&(y[0]==="~"||y[0]==="+")&&b.parentNode?b.parentNode:b,n);h=g.expr?l.filter(g.expr,g.set):g.set;for(y.length>0?j=s(h):C=false;y.length;){g=v=y.pop();p.relative[v]?g=y.pop():v="";g==null&&(g=b);p.relative[v](j,g,n)}}else j=[]}j||(j=h);j||l.error(v||a);if(k.call(j)==="[object Array]")if(C)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
            (j[a]===true||j[a].nodeType===1&&l.contains(b,j[a]))&&c.push(h[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(h[a]);else c.push.apply(c,j);else s(j,c);if(i){l(i,e,c,f);l.uniqueSort(c)}return c};l.uniqueSort=function(a){if(x){g=h;a.sort(x);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};l.matches=function(a,b){return l(a,null,null,b)};l.matchesSelector=function(a,b){return l(b,null,null,[a]).length>0};l.find=function(a,b,c){var d,f,e,k,g,h;if(!a)return[];f=
        0;for(e=p.order.length;f<e;f++){g=p.order[f];if(k=p.leftMatch[g].exec(a)){h=k[1];k.splice(1,1);if(h.substr(h.length-1)!=="\\"){k[1]=(k[1]||"").replace(j,"");d=p.find[g](k,b,c);if(d!=null){a=a.replace(p.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};l.filter=function(a,b,d,f){for(var e,k,g,h,j,i,v,C,n=a,y=[],o=b,q=b&&b[0]&&l.isXML(b[0]);a&&b.length;){for(g in p.filter)if((e=p.leftMatch[g].exec(a))!=null&&e[2]){i=p.filter[g];
        j=e[1];k=false;e.splice(1,1);if(j.substr(j.length-1)!=="\\"){o===y&&(y=[]);if(p.preFilter[g])if(e=p.preFilter[g](e,o,d,y,f,q)){if(e===true)continue}else k=h=true;if(e)for(v=0;(j=o[v])!=null;v++)if(j){h=i(j,e,v,o);C=f^h;if(d&&h!=null)C?k=true:o[v]=false;else if(C){y.push(j);k=true}}if(h!==c){d||(o=y);a=a.replace(p.match[g],"");if(!k)return[];break}}}if(a===n)if(k==null)l.error(a);else break;n=a}return o};l.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var y=l.getText=
            function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(v,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+y(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+y(c));return d},p=l.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
            ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
            type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!n.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,f=a.length,e;d<f;d++)if(e=a[d]){for(;(e=e.previousSibling)&&e.nodeType!==1;);a[d]=c||e&&e.nodeName.toLowerCase()===b?e||false:e===b}c&&l.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",f=0,e=a.length;if(d&&!n.test(b))for(b=b.toLowerCase();f<e;f++){if(c=a[f]){c=c.parentNode;a[f]=c.nodeName.toLowerCase()===b?c:false}}else{for(;f<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         e;f++)(c=a[f])&&(a[f]=d?c.parentNode:c.parentNode===b);d&&l.filter(b,a,true)}},"":function(c,d,f){var k,g=e++,h=b;if(typeof d==="string"&&!n.test(d)){k=d=d.toLowerCase();h=a}h("parentNode",d,g,c,k,f)},"~":function(c,d,f){var k,g=e++,h=b;if(typeof d==="string"&&!n.test(d)){k=d=d.toLowerCase();h=a}h("previousSibling",d,g,c,k,f)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
            "undefined"){for(var c=[],d=b.getElementsByName(a[1]),f=0,e=d.length;f<e;f++)d[f].getAttribute("name")===a[1]&&c.push(d[f]);return c.length===0?null:c}},TAG:function(a,b){if(typeof b.getElementsByTagName!=="undefined")return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,f,e){a=" "+a[1].replace(j,"")+" ";if(e)return a;for(var e=0,k;(k=b[e])!=null;e++)k&&(f^(k.className&&(" "+k.className+" ").replace(/[\t\n\r]/g," ").indexOf(a)>=0)?c||d.push(k):c&&(b[e]=false));return false},ID:function(a){return a[1].replace(j,
            "")},TAG:function(a){return a[1].replace(j,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||l.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&l.error(a[0]);a[0]=e++;return a},ATTR:function(a,b,c,d,f,e){b=a[1]=a[1].replace(j,"");!e&&p.attrMap[b]&&(a[1]=p.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(j,"");a[2]==="~="&&(a[4]=" "+a[4]+
            " ");return a},PSEUDO:function(a,b,c,f,e){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=l(a[3],null,null,b);else{a=l.filter(a[3],b,c,1^e);c||f.push.apply(f,a);return false}else if(p.match.POS.test(a[0])||p.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
        a.parentNode.selectedIndex;return a.selected===true},parent:function(a){return!!a.firstChild},empty:function(a){return!a.firstChild},has:function(a,b,c){return!!l(c[3],a).length},header:function(a){return/h\d/i.test(a.nodeName)},text:function(a){var b=a.getAttribute("type"),c=a.type;return a.nodeName.toLowerCase()==="input"&&"text"===c&&(b===c||b===null)},radio:function(a){return a.nodeName.toLowerCase()==="input"&&"radio"===a.type},checkbox:function(a){return a.nodeName.toLowerCase()==="input"&&
            ...
            return b==="input"&&"button"===a.type||b==="button"},input:function(a){return/input|select|textarea|button/i.test(a.nodeName)},focus:function(a){return a===a.ownerDocument.activeElement}},setFilters:{first:function(a,b){return b===0},last:function(a,b,c,d){return b===d.length-1},even:function(a,b){return b%2===0},odd:function(a,b){return b%2===1},lt:function(a,b,c){return b<c[3]-0},gt:function(a,b,c){return b>c[3]-0},nth:function(a,b,c){return c[3]-0===b},eq:function(a,b,c){return c[3]-0===b}},filter:{PSEUDO:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       b,c,d){var f=b[1],e=p.filters[f];if(e)return e(a,c,b,d);if(f==="contains")return(a.textContent||a.innerText||y([a])||"").indexOf(b[3])>=0;if(f==="not"){b=b[3];c=0;for(d=b.length;c<d;c++)if(b[c]===a)return false;return true}l.error(f)},CHILD:function(a,b){var c,d,e,k,g,h;c=b[1];h=a;switch(c){case "only":case "first":for(;h=h.previousSibling;)if(h.nodeType===1)return false;if(c==="first")return true;h=a;case "last":for(;h=h.nextSibling;)if(h.nodeType===1)return false;return true;case "nth":c=b[2];d=
            b[3];if(c===1&&d===0)return true;e=b[0];if((k=a.parentNode)&&(k[f]!==e||!a.nodeIndex)){g=0;for(h=k.firstChild;h;h=h.nextSibling)if(h.nodeType===1)h.nodeIndex=++g;k[f]=e}h=a.nodeIndex-d;return c===0?h===0:h%c===0&&h/c>=0}},ID:function(a,b){return a.nodeType===1&&a.getAttribute("id")===b},TAG:function(a,b){return b==="*"&&a.nodeType===1||!!a.nodeName&&a.nodeName.toLowerCase()===b},CLASS:function(a,b){return(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)>-1},ATTR:function(a,b){var c=b[1],
            c=l.attr?l.attr(a,c):p.attrHandle[c]?p.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",f=b[2],e=b[4];return c==null?f==="!=":!f&&l.attr?c!=null:f==="="?d===e:f==="*="?d.indexOf(e)>=0:f==="~="?(" "+d+" ").indexOf(e)>=0:!e?d&&c!==false:f==="!="?d!==e:f==="^="?d.indexOf(e)===0:f==="$="?d.substr(d.length-e.length)===e:f==="|="?d===e||d.substr(0,e.length+1)===e+"-":false},POS:function(a,b,c,d){var f=p.setFilters[b[2]];if(f)return f(a,c,b,d)}}},o=p.match.POS,q=function(a,b){return"\\"+(b-0+1)},
        K;for(K in p.match){p.match[K]=RegExp(p.match[K].source+/(?![^\[]*\])(?![^\(]*\))/.source);p.leftMatch[K]=RegExp(/(^(?:.|\r|\n)*?)/.source+p.match[K].source.replace(/\\(\d+)/g,q))}p.match.globalPOS=o;var s=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(u.documentElement.childNodes,0)[0].nodeType}catch(S){s=function(a,b){var c=0,d=b||[];if(k.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
        "number")for(var f=a.length;c<f;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var x,r;if(u.documentElement.compareDocumentPosition)x=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{x=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,f=[],e=[];c=a.parentNode;d=b.parentNode;var k=c;if(c===d)return r(a,
        b);if(c){if(!d)return 1}else return-1;for(;k;){f.unshift(k);k=k.parentNode}for(k=d;k;){e.unshift(k);k=k.parentNode}c=f.length;d=e.length;for(k=0;k<c&&k<d;k++)if(f[k]!==e[k])return r(f[k],e[k]);return k===c?r(a,e[k],-1):r(f[k],b,1)};r=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=u.createElement("div"),b="script"+(new Date).getTime(),d=u.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(u.getElementById(b)){p.find.ID=
        function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};p.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=u.createElement("div");a.appendChild(u.createComment(""));if(a.getElementsByTagName("*").length>0)p.find.TAG=function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],f=0;c[f];f++)c[f].nodeType===1&&d.push(c[f]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")p.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();u.querySelectorAll&&function(){var a=l,b=u.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){l=
        function(b,c,d,f){c=c||u;if(!f&&!l.isXML(c)){var e=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(e&&(c.nodeType===1||c.nodeType===9)){if(e[1])return s(c.getElementsByTagName(b),d);if(e[2]&&p.find.CLASS&&c.getElementsByClassName)return s(c.getElementsByClassName(e[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return s([c.body],d);if(e&&e[3]){var k=c.getElementById(e[3]);if(k&&k.parentNode){if(k.id===e[3])return s([k],d)}else return s([],d)}try{return s(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
            1&&c.nodeName.toLowerCase()!=="object"){var e=c,h=(k=c.getAttribute("id"))||"__sizzle__",j=c.parentNode,i=/^\s*[+~]/.test(b);k?h=h.replace(/'/g,"\\$&"):c.setAttribute("id",h);if(i&&j)c=c.parentNode;try{if(!i||j)return s(c.querySelectorAll("[id='"+h+"'] "+b),d)}catch(v){}finally{k||e.removeAttribute("id")}}}return a(b,c,d,f)};for(var c in a)l[c]=a[c];b=null}}();(function(){var a=u.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(u.createElement("div"),
        "div"),d=false;try{b.call(u.documentElement,"[test!='']:sizzle")}catch(f){d=true}l.matchesSelector=function(a,f){f=f.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!l.isXML(a))try{if(d||!p.match.PSEUDO.test(f)&&!/!=/.test(f)){var e=b.call(a,f);if(e||!c||a.document&&a.document.nodeType!==11)return e}}catch(k){}return l(f,null,null,[a]).length>0}}})();(function(){var a=u.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
        0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){p.order.splice(1,0,"CLASS");p.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();l.contains=u.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:u.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};l.isXML=function(a){return(a=(a?a.ownerDocument||
        a:0).documentElement)?a.nodeName!=="HTML":false};var m=function(a,b,c){for(var d,f=[],e="",b=b.nodeType?[b]:b;d=p.match.PSEUDO.exec(a);){e=e+d[0];a=a.replace(p.match.PSEUDO,"")}a=p.relative[a]?a+"*":a;d=0;for(var k=b.length;d<k;d++)l(a,b[d],f,c);return l.filter(e,f)};l.attr=i.attr;l.selectors.attrMap={};i.find=l;i.expr=l.selectors;i.expr[":"]=i.expr.filters;i.unique=l.uniqueSort;i.text=l.getText;i.isXMLDoc=l.isXML;i.contains=l.contains})();var X=/Until$/,ka=/^(?:parents|prevUntil|prevAll)/,ca=/,/,
        Ya=/^.[^:#\[\.,]*$/,Za=Array.prototype.slice,Ga=i.expr.match.globalPOS,$a={children:!0,contents:!0,next:!0,prev:!0};i.fn.extend({find:function(a){var b=this,c,d;if(typeof a!=="string")return i(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(i.contains(b[c],this))return true});var f=this.pushStack("","find",a),e,k,g;c=0;for(d=this.length;c<d;c++){e=f.length;i.find(a,this[c],f);if(c>0)for(k=e;k<f.length;k++)for(g=0;g<e;g++)if(f[g]===f[k]){f.splice(k--,1);break}}return f},has:function(a){var b=i(a);
        return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(i.contains(this,b[a]))return true})},not:function(a){return this.pushStack(j(this,a,false),"not",a)},filter:function(a){return this.pushStack(j(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?Ga.test(a)?i(a,this.context).index(this[0])>=0:i.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,b){var c=[],d,f,e=this[0];if(i.isArray(a)){for(f=1;e&&e.ownerDocument&&e!==b;){for(d=0;d<a.length;d++)i(e).is(a[d])&&
    c.push({selector:a[d],elem:e,level:f});e=e.parentNode;f++}return c}var k=Ga.test(a)||typeof a!=="string"?i(a,b||this.context):0;d=0;for(f=this.length;d<f;d++)for(e=this[d];e;)if(k?k.index(e)>-1:i.find.matchesSelector(e,a)){c.push(e);break}else{e=e.parentNode;if(!e||!e.ownerDocument||e===b||e.nodeType===11)break}c=c.length>1?i.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return!a?this[0]&&this[0].parentNode?this.prevAll().length:-1:typeof a==="string"?i.inArray(this[0],i(a)):
        ...
        "iframe")?a.contentDocument||a.contentWindow.document:i.makeArray(a.childNodes)}},function(a,b){i.fn[a]=function(c,d){var f=i.map(this,b,c);X.test(a)||(d=c);d&&typeof d==="string"&&(f=i.filter(d,f));f=this.length>1&&!$a[a]?i.unique(f):f;if((this.length>1||ca.test(d))&&ka.test(a))f=f.reverse();return this.pushStack(f,a,Za.call(arguments).join(","))}});i.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?i.find.matchesSelector(b[0],a)?[b[0]]:[]:i.find.matches(a,b)},dir:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              b,d){for(var f=[],a=a[b];a&&a.nodeType!==9&&(d===c||a.nodeType!==1||!i(a).is(d));){a.nodeType===1&&f.push(a);a=a[b]}return f},nth:function(a,b,c){for(var b=b||1,d=0;a;a=a[c])if(a.nodeType===1&&++d===b)break;return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)a.nodeType===1&&a!==b&&c.push(a);return c}});var Ha="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",ab=/ jQuery\d+="(?:\d+|null)"/g,
        ya=/^\s+/,Ia=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ja=/<([\w:]+)/,db=/<tbody/i,eb=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ka=RegExp("<(?:"+Ha+")[\\s/>]","i"),Ma=/checked\s*(?:[^=]|=\s*.checked.)/i,Na=/\/(java|ecma)script/i,hb=/^\s*<!(?:\[CDATA\[|\-\-)/,ba={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
            "<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Da=l(u);ba.optgroup=ba.option;ba.tbody=ba.tfoot=ba.colgroup=ba.caption=ba.thead;ba.th=ba.td;i.support.htmlSerialize||(ba._default=[1,"div<div>","</div>"]);i.fn.extend({text:function(a){return i.access(this,function(a){return a===c?i.text(this):this.empty().append((this[0]&&this[0].ownerDocument||u).createTextNode(a))},null,a,arguments.length)},
        wrapAll:function(a){if(i.isFunction(a))return this.each(function(b){i(this).wrapAll(a.call(this,b))});if(this[0]){var b=i(a,this[0].ownerDocument).eq(0).clone(true);this[0].parentNode&&b.insertBefore(this[0]);b.map(function(){for(var a=this;a.firstChild&&a.firstChild.nodeType===1;)a=a.firstChild;return a}).append(this)}return this},wrapInner:function(a){return i.isFunction(a)?this.each(function(b){i(this).wrapInner(a.call(this,b))}):this.each(function(){var b=i(this),c=b.contents();c.length?c.wrapAll(a):
            ...
            this[0].parentNode)return this.domManip(arguments,false,function(a){this.parentNode.insertBefore(a,this)});if(arguments.length){var a=i.clean(arguments);a.push.apply(a,this.toArray());return this.pushStack(a,"before",arguments)}},after:function(){if(this[0]&&this[0].parentNode)return this.domManip(arguments,false,function(a){this.parentNode.insertBefore(a,this.nextSibling)});if(arguments.length){var a=this.pushStack(this,"after",arguments);a.push.apply(a,i.clean(arguments));return a}},remove:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      b){for(var c=0,d;(d=this[c])!=null;c++)if(!a||i.filter(a,[d]).length){if(!b&&d.nodeType===1){i.cleanData(d.getElementsByTagName("*"));i.cleanData([d])}d.parentNode&&d.parentNode.removeChild(d)}return this},empty:function(){for(var a=0,b;(b=this[a])!=null;a++)for(b.nodeType===1&&i.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=a==null?false:a;b=b==null?a:b;return this.map(function(){return i.clone(this,a,b)})},html:function(a){return i.access(this,
            function(a){var b=this[0]||{},d=0,f=this.length;if(a===c)return b.nodeType===1?b.innerHTML.replace(ab,""):null;if(typeof a==="string"&&!bb.test(a)&&(i.support.leadingWhitespace||!ya.test(a))&&!ba[(Ja.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ia,"<$1></$2>");try{for(;d<f;d++){b=this[d]||{};if(b.nodeType===1){i.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(e){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(i.isFunction(a))return this.each(function(b){var c=
            i(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=i(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;i(this).remove();b?i(b).before(a):i(c).append(a)})}return this.length?this.pushStack(i(i.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var f,e,k,g=a[0],h=[];if(!i.support.checkClone&&arguments.length===3&&typeof g==="string"&&Ma.test(g))return this.each(function(){i(this).domManip(a,
            b,d,true)});if(i.isFunction(g))return this.each(function(f){var e=i(this);a[0]=g.call(this,f,b?e.html():c);e.domManip(a,b,d)});if(this[0]){f=g&&g.parentNode;f=i.support.parentNode&&f&&f.nodeType===11&&f.childNodes.length===this.length?{fragment:f}:i.buildFragment(a,this,h);k=f.fragment;if(e=k.childNodes.length===1?k=k.firstChild:k.firstChild){b=b&&i.nodeName(e,"tr");e=0;for(var j=this.length,v=j-1;e<j;e++)d.call(b?i.nodeName(this[e],"table")?this[e].getElementsByTagName("tbody")[0]||this[e].appendChild(this[e].ownerDocument.createElement("tbody")):
            this[e]:this[e],f.cacheable||j>1&&e<v?i.clone(k,true,true):k)}h.length&&i.each(h,function(a,b){b.src?i.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):i.globalEval((b.text||b.textContent||b.innerHTML||"").replace(hb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});i.buildFragment=function(a,b,c){var d,f,e,k,g=a[0];b&&b[0]&&(k=b[0].ownerDocument||b[0]);k.createDocumentFragment||(k=u);if(a.length===1&&typeof g==="string"&&g.length<512&&k===u&&g.charAt(0)===
        "<"&&!cb.test(g)&&(i.support.checkClone||!Ma.test(g))&&(i.support.html5Clone||!Ka.test(g))){f=true;(e=i.fragments[g])&&e!==1&&(d=e)}if(!d){d=k.createDocumentFragment();i.clean(a,k,d,c)}f&&(i.fragments[g]=e?d:1);return{fragment:d,cacheable:f}};i.fragments={};i.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){i.fn[a]=function(c){var d=[],c=i(c),f=this.length===1&&this[0].parentNode;if(f&&f.nodeType===11&&f.childNodes.length===
        1&&c.length===1){c[b](this[0]);return this}for(var f=0,e=c.length;f<e;f++){var k=(f>0?this.clone(true):this).get();i(c[f])[b](k);d=d.concat(k)}return this.pushStack(d,a,c.selector)}});i.extend({clone:function(a,b,c){var d,f,e;if(i.support.html5Clone||i.isXMLDoc(a)||!Ka.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=u.createElement("div");Da.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var k=d;if((!i.support.noCloneEvent||!i.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&
        !i.isXMLDoc(a)){n(a,k);d=p(a);f=p(k);for(e=0;d[e];++e)f[e]&&n(d[e],f[e])}if(b){o(a,k);if(c){d=p(a);f=p(k);for(e=0;d[e];++e)o(d[e],f[e])}}return k},clean:function(a,b,c,d){var f,e=[],b=b||u;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||u);for(var k=0,g;(g=a[k])!=null;k++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(eb.test(g)){g=g.replace(Ia,"<$1></$2>");f=(Ja.exec(g)||["",""])[1].toLowerCase();var h=ba[f]||ba._default,j=h[0],v=b.createElement("div"),
        n=Da.childNodes;b===u?Da.appendChild(v):l(b).appendChild(v);for(v.innerHTML=h[1]+g+h[2];j--;)v=v.lastChild;if(!i.support.tbody){j=db.test(g);h=f==="table"&&!j?v.firstChild&&v.firstChild.childNodes:h[1]==="<table>"&&!j?v.childNodes:[];for(f=h.length-1;f>=0;--f)i.nodeName(h[f],"tbody")&&!h[f].childNodes.length&&h[f].parentNode.removeChild(h[f])}!i.support.leadingWhitespace&&ya.test(g)&&v.insertBefore(b.createTextNode(ya.exec(g)[0]),v.firstChild);g=v.childNodes;if(v){v.parentNode.removeChild(v);if(n.length>
        0)(v=n[n.length-1])&&v.parentNode&&v.parentNode.removeChild(v)}}else g=b.createTextNode(g);var y;if(!i.support.appendChecked)if(g[0]&&typeof(y=g.length)==="number")for(f=0;f<y;f++)s(g[f]);else s(g);g.nodeType?e.push(g):e=i.merge(e,g)}}if(c){a=function(a){return!a.type||Na.test(a.type)};for(k=0;e[k];k++){b=e[k];if(d&&i.nodeName(b,"script")&&(!b.type||Na.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=i.grep(b.getElementsByTagName("script"),a);e.splice.apply(e,
        [k+1,0].concat(g))}c.appendChild(b)}}}return e},cleanData:function(a){for(var b,c,d=i.cache,f=i.event.special,e=i.support.deleteExpando,k=0,g;(g=a[k])!=null;k++)if(!g.nodeName||!i.noData[g.nodeName.toLowerCase()])if(c=g[i.expando]){if((b=d[c])&&b.events){for(var h in b.events)f[h]?i.event.remove(g,h):i.removeEvent(g,h,b.handle);if(b.handle)b.handle.elem=null}e?delete g[i.expando]:g.removeAttribute&&g.removeAttribute(i.expando);delete d[c]}}});var Ea=/alpha\([^)]*\)/i,ib=/opacity=([^)]*)/,jb=/([A-Z]|^ms)/g,
        kb=/^[\-+]?(?:\d*\.)?\d+$/i,za=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,lb=/^([\-+])=([\-+.\de]+)/,mb=/^margin/,nb={position:"absolute",visibility:"hidden",display:"block"},la=["Top","Right","Bottom","Left"],oa,Oa,Pa;i.fn.css=function(a,b){return i.access(this,function(a,b,d){return d!==c?i.style(a,b,d):i.css(a,b)},a,b,arguments.length>1)};i.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=oa(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,
        opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":i.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,f){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var e,k=i.camelCase(b),g=a.style,h=i.cssHooks[k],b=i.cssProps[k]||k;if(d!==c){f=typeof d;if(f==="string"&&(e=lb.exec(d))){d=+(e[1]+1)*+e[2]+parseFloat(i.css(a,b));f="number"}if(!(d==null||f==="number"&&isNaN(d))){f==="number"&&!i.cssNumber[k]&&(d=d+"px");if(!h||!("set"in h)||(d=h.set(a,d))!==c)try{g[b]=d}catch(j){}}}else return h&&
        "get"in h&&(e=h.get(a,false,f))!==c?e:g[b]}},css:function(a,b,d){var f,e,b=i.camelCase(b);e=i.cssHooks[b];b=i.cssProps[b]||b;b==="cssFloat"&&(b="float");if(e&&"get"in e&&(f=e.get(a,true,d))!==c)return f;if(oa)return oa(a,b)},swap:function(a,b,c){var d={},f;for(f in b){d[f]=a.style[f];a.style[f]=b[f]}c=c.call(a);for(f in b)a.style[f]=d[f];return c}});i.curCSS=i.css;u.defaultView&&u.defaultView.getComputedStyle&&(Oa=function(a,b){var c,d,f,e=a.style,b=b.replace(jb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&
        (f=d.getComputedStyle(a,null))){c=f.getPropertyValue(b);c===""&&!i.contains(a.ownerDocument.documentElement,a)&&(c=i.style(a,b))}if(!i.support.pixelMargin&&f&&mb.test(b)&&za.test(c)){d=e.width;e.width=c;c=f.width;e.width=d}return c});u.documentElement.currentStyle&&(Pa=function(a,b){var c,d,f=a.currentStyle&&a.currentStyle[b],e=a.style;if(f==null&&e&&(c=e[b]))f=c;if(za.test(f)){c=e.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;e.left=b==="fontSize"?"1em":f;
        f=e.pixelLeft+"px";e.left=c;if(d)a.runtimeStyle.left=d}return f===""?"auto":f});oa=Oa||Pa;i.each(["height","width"],function(a,b){i.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?x(a,b,d):i.swap(a,nb,function(){return x(a,b,d)})},set:function(a,b){return kb.test(b)?b+"px":b}}});i.support.opacity||(i.cssHooks.opacity={get:function(a,b){return ib.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,
        d=a.currentStyle,f=i.isNumeric(b)?"alpha(opacity="+b*100+")":"",e=d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&i.trim(e.replace(Ea,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ea.test(e)?e.replace(Ea,f):e+" "+f}});i(function(){if(!i.support.reliableMarginRight)i.cssHooks.marginRight={get:function(a,b){return i.swap(a,{display:"inline-block"},function(){return b?oa(a,"margin-right"):a.style.marginRight})}}});i.expr&&i.expr.filters&&(i.expr.filters.hidden=function(a){var b=
        a.offsetHeight;return a.offsetWidth===0&&b===0||!i.support.reliableHiddenOffsets&&(a.style&&a.style.display||i.css(a,"display"))==="none"},i.expr.filters.visible=function(a){return!i.expr.filters.hidden(a)});i.each({margin:"",padding:"",border:"Width"},function(a,b){i.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],f={},c=0;c<4;c++)f[a+la[c]+b]=d[c]||d[c-2]||d[0];return f}}});var ob=/%20/g,fb=/\[\]$/,Qa=/\r?\n/g,pb=/#.*$/,qb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,rb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
        sb=/^(?:GET|HEAD)$/,tb=/^\/\//,Ra=/\?/,ub=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,vb=/^(?:select|textarea)/i,La=/\s+/,wb=/([?&])_=[^&]*/,Sa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ta=i.fn.load,Aa={},Ua={},ma,na,Va=["*/"]+["*"];try{ma=T.href}catch(Cb){ma=u.createElement("a"),ma.href="",ma=ma.href}na=Sa.exec(ma.toLowerCase())||[];i.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ta)return Ta.apply(this,arguments);if(!this.length)return this;var f=a.indexOf(" ");if(f>=
        0)var e=a.slice(f,a.length),a=a.slice(0,f);f="GET";if(b)if(i.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=i.param(b,i.ajaxSettings.traditional);f="POST"}var k=this;i.ajax({url:a,type:f,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});k.html(e?i("<div>").append(c.replace(ub,"")).find(e):c)}d&&k.each(d,[c,b,a])}});return this},serialize:function(){return i.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
        i.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||vb.test(this.nodeName)||rb.test(this.type))}).map(function(a,b){var c=i(this).val();return c==null?null:i.isArray(c)?i.map(c,function(a){return{name:b.name,value:a.replace(Qa,"\r\n")}}):{name:b.name,value:c.replace(Qa,"\r\n")}}).get()}});i.each("ajaxStart,ajaxStop,ajaxComplete,ajaxError,ajaxSuccess,ajaxSend".split(","),function(a,b){i.fn[b]=function(a){return this.on(b,a)}});i.each(["get","post"],
        function(a,b){i[b]=function(a,d,f,e){if(i.isFunction(d)){e=e||f;f=d;d=c}return i.ajax({type:b,url:a,data:d,success:f,dataType:e})}});i.extend({getScript:function(a,b){return i.get(a,c,b,"script")},getJSON:function(a,b,c){return i.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)F(a,i.ajaxSettings);else{b=a;a=i.ajaxSettings}F(a,b);return a},ajaxSettings:{url:ma,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(na[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
        processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Va},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":i.parseJSON,"text xml":i.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:r(Aa),ajaxTransport:r(Ua),ajax:function(a,b){function d(a,b,l,n){if(K!==2){K=2;q&&clearTimeout(q);o=c;y=n||"";r.readyState=
        a>0?4:0;var p,s,C,n=b;if(l){var x=f,m=r,X=x.contents,ha=x.dataTypes,t=x.responseFields,D,u,ja,F;for(u in t)u in l&&(m[t[u]]=l[u]);for(;ha[0]==="*";){ha.shift();D===c&&(D=x.mimeType||m.getResponseHeader("content-type"))}if(D)for(u in X)if(X[u]&&X[u].test(D)){ha.unshift(u);break}if(ha[0]in l)ja=ha[0];else{for(u in l){if(!ha[0]||x.converters[u+" "+ha[0]]){ja=u;break}F||(F=u)}ja=ja||F}if(ja){ja!==ha[0]&&ha.unshift(ja);l=l[ja]}else l=void 0}else l=c;if(a>=200&&a<300||a===304){if(f.ifModified){if(D=r.getResponseHeader("Last-Modified"))i.lastModified[v]=
        D;if(D=r.getResponseHeader("Etag"))i.etag[v]=D}if(a===304){n="notmodified";p=true}else try{D=f;D.dataFilter&&(l=D.dataFilter(l,D.dataType));var z=D.dataTypes;u={};var ka,E,B=z.length,w,A=z[0],G,H,ca,I,J;for(ka=1;ka<B;ka++){if(ka===1)for(E in D.converters)typeof E==="string"&&(u[E.toLowerCase()]=D.converters[E]);G=A;A=z[ka];if(A==="*")A=G;else if(G!=="*"&&G!==A){H=G+" "+A;ca=u[H]||u["* "+A];if(!ca){J=c;for(I in u){w=I.split(" ");if(w[0]===G||w[0]==="*")if(J=u[w[1]+" "+A]){I=u[I];I===true?ca=J:J===
        true&&(ca=I);break}}}!ca&&!J&&i.error("No conversion from "+H.replace(" "," to "));ca!==true&&(l=ca?ca(l):J(I(l)))}}s=l;n="success";p=true}catch(L){n="parsererror";C=L}}else{C=n;if(!n||a){n="error";a<0&&(a=0)}}r.status=a;r.statusText=""+(b||n);p?g.resolveWith(e,[s,n,r]):g.rejectWith(e,[r,n,C]);r.statusCode(j);j=c;S&&k.trigger("ajax"+(p?"Success":"Error"),[r,f,p?s:C]);h.fireWith(e,[r,n]);if(S){k.trigger("ajaxComplete",[r,f]);--i.active||i.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=
        b||{},f=i.ajaxSetup({},b),e=f.context||f,k=e!==f&&(e.nodeType||e instanceof i)?i(e):i.event,g=i.Deferred(),h=i.Callbacks("once memory"),j=f.statusCode||{},v,l={},n={},y,p,o,q,s,K=0,S,x,r={readyState:0,setRequestHeader:function(a,b){if(!K){var c=a.toLowerCase(),a=n[c]=n[c]||a;l[a]=b}return this},getAllResponseHeaders:function(){return K===2?y:null},getResponseHeader:function(a){var b;if(K===2){if(!p)for(p={};b=qb.exec(y);)p[b[1].toLowerCase()]=b[2];b=p[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!K)f.mimeType=
        a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(r);r.success=r.done;r.error=r.fail;r.complete=h.add;r.statusCode=function(a){if(a){var b;if(K<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[r.status];r.then(b,b)}}return this};f.url=((a||f.url)+"").replace(pb,"").replace(tb,na[1]+"//");f.dataTypes=i.trim(f.dataType||"*").toLowerCase().split(La);if(f.crossDomain==null){s=Sa.exec(f.url.toLowerCase());f.crossDomain=!(!s||!(s[1]!=na[1]||s[2]!=na[2]||(s[3]||(s[1]==="http:"?
        80:443))!=(na[3]||(na[1]==="http:"?80:443))))}if(f.data&&f.processData&&typeof f.data!=="string")f.data=i.param(f.data,f.traditional);m(Aa,f,b,r);if(K===2)return false;S=f.global;f.type=f.type.toUpperCase();f.hasContent=!sb.test(f.type);S&&i.active++===0&&i.event.trigger("ajaxStart");if(!f.hasContent){if(f.data){f.url=f.url+((Ra.test(f.url)?"&":"?")+f.data);delete f.data}v=f.url;if(f.cache===false){s=i.now();var X=f.url.replace(wb,"$1_="+s);f.url=X+(X===f.url?(Ra.test(f.url)?"&":"?")+"_="+s:"")}}(f.data&&
        f.hasContent&&f.contentType!==false||b.contentType)&&r.setRequestHeader("Content-Type",f.contentType);if(f.ifModified){v=v||f.url;i.lastModified[v]&&r.setRequestHeader("If-Modified-Since",i.lastModified[v]);i.etag[v]&&r.setRequestHeader("If-None-Match",i.etag[v])}r.setRequestHeader("Accept",f.dataTypes[0]&&f.accepts[f.dataTypes[0]]?f.accepts[f.dataTypes[0]]+(f.dataTypes[0]!=="*"?", "+Va+"; q=0.01":""):f.accepts["*"]);for(x in f.headers)r.setRequestHeader(x,f.headers[x]);if(f.beforeSend&&(f.beforeSend.call(e,
        r,f)===false||K===2)){r.abort();return false}for(x in{success:1,error:1,complete:1})r[x](f[x]);if(o=m(Ua,f,b,r)){r.readyState=1;S&&k.trigger("ajaxSend",[r,f]);f.async&&f.timeout>0&&(q=setTimeout(function(){r.abort("timeout")},f.timeout));try{K=1;o.send(l,d)}catch(t){if(K<2)d(-1,t);else throw t;}}else d(-1,"No Transport");return r},param:function(a,b){var d=[],f=function(a,b){b=i.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=i.ajaxSettings.traditional;
        if(i.isArray(a)||a.jquery&&!i.isPlainObject(a))i.each(a,function(){f(this.name,this.value)});else for(var e in a)E(e,a[e],b,f);return d.join("&").replace(ob,"+")}});i.extend({active:0,lastModified:{},etag:{}});var xb=i.now(),wa=/(\=)\?(&|$)|\?\?/i;i.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return i.expando+"_"+xb++}});i.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
        false&&(wa.test(b.url)||c&&wa.test(b.data))){var f,e=b.jsonpCallback=i.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,k=a[e],g=b.url,h=b.data,j="$1"+e+"$2";if(b.jsonp!==false){g=g.replace(wa,j);if(b.url===g){c&&(h=h.replace(wa,j));b.data===h&&(g=g+((/\?/.test(g)?"&":"?")+b.jsonp+"="+e))}}b.url=g;b.data=h;a[e]=function(a){f=[a]};d.always(function(){a[e]=k;if(f&&i.isFunction(k))a[e](f[0])});b.converters["script json"]=function(){f||i.error(e+" was not called");return f[0]};b.dataTypes[0]=
        "json";return"script"}});i.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){i.globalEval(a);return a}}});i.ajaxPrefilter("script",function(a){if(a.cache===c)a.cache=false;if(a.crossDomain){a.type="GET";a.global=false}});i.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=u.head||u.getElementsByTagName("head")[0]||u.documentElement;return{send:function(f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            e){b=u.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,f){if(f||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;f||e(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Fa=a.ActiveXObject?function(){for(var a in ra)ra[a](0,1)}:!1,yb=0,ra;i.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
        !this.isLocal&&B()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:B;(function(a){i.extend(i.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(i.ajaxSettings.xhr());i.support.ajax&&i.ajaxTransport(function(b){if(!b.crossDomain||i.support.cors){var d;return{send:function(f,e){var k=b.xhr(),g,h;b.username?k.open(b.type,b.url,b.async,b.username,b.password):k.open(b.type,b.url,b.async);if(b.xhrFields)for(h in b.xhrFields)k[h]=b.xhrFields[h];b.mimeType&&k.overrideMimeType&&
    k.overrideMimeType(b.mimeType);!b.crossDomain&&!f["X-Requested-With"]&&(f["X-Requested-With"]="XMLHttpRequest");try{for(h in f)k.setRequestHeader(h,f[h])}catch(j){}k.send(b.hasContent&&b.data||null);d=function(a,f){var h,j,v,l,n;try{if(d&&(f||k.readyState===4)){d=c;if(g){k.onreadystatechange=i.noop;Fa&&delete ra[g]}if(f)k.readyState!==4&&k.abort();else{h=k.status;v=k.getAllResponseHeaders();l={};if((n=k.responseXML)&&n.documentElement)l.xml=n;try{l.text=k.responseText}catch(y){}try{j=k.statusText}catch(p){j=
        ""}!h&&b.isLocal&&!b.crossDomain?h=l.text?200:404:h===1223&&(h=204)}}}catch(o){f||e(-1,o)}l&&e(h,j,l,v)};if(!b.async||k.readyState===4)d();else{g=++yb;if(Fa){if(!ra){ra={};i(a).unload(Fa)}ra[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var Ba={},da,pa,zb=/^(?:toggle|show|hide)$/,Ab=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,xa,ua=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ta;i.fn.extend({show:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              b,c){if(a||a===0)return this.animate(A("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!i._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&i.css(a,"display")==="none"||!i.contains(a.ownerDocument.documentElement,a))&&i._data(a,"olddisplay",O(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=i._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(A("hide",
        ...
        fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function f(){e.queue===false&&i._mark(this);var b=i.extend({},e),c=this.nodeType===1,d=c&&i(this).is(":hidden"),k,g,h,j,v;b.animatedProperties={};for(h in a){k=i.camelCase(h);if(h!==k){a[k]=a[h];delete a[h]}if((g=i.cssHooks[k])&&"expand"in g){j=g.expand(a[k]);delete a[k];for(h in j)h in a||(a[h]=j[h])}}for(k in a){g=a[k];if(i.isArray(g)){b.animatedProperties[k]=
            g[1];g=a[k]=g[0]}else b.animatedProperties[k]=b.specialEasing&&b.specialEasing[k]||b.easing||"swing";if(g==="hide"&&d||g==="show"&&!d)return b.complete.call(this);if(c&&(k==="height"||k==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(i.css(this,"display")==="inline"&&i.css(this,"float")==="none")!i.support.inlineBlockNeedsLayout||O(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
            for(h in a){c=new i.fx(this,b,h);g=a[h];if(zb.test(g))if(k=i._data(this,"toggle"+h)||(g==="toggle"?d?"show":"hide":0)){i._data(this,"toggle"+h,k==="show"?"hide":"show");c[k]()}else c[g]();else{k=Ab.exec(g);j=c.cur();if(k){g=parseFloat(k[2]);v=k[3]||(i.cssNumber[h]?"":"px");if(v!=="px"){i.style(this,h,(g||1)+v);j=(g||1)/c.cur()*j;i.style(this,h,j+v)}k[1]&&(g=(k[1]==="-="?-1:1)*g+j);c.custom(j,g,v)}else c.custom(j,g,"")}}return true}var e=i.speed(b,c,d);if(i.isEmptyObject(a))return this.each(e.complete,
            [false]);a=i.extend({},a);return e.queue===false?this.each(f):this.queue(e.queue,f)},stop:function(a,b,d){if(typeof a!=="string"){d=b;b=a;a=c}b&&a!==false&&this.queue(a||"fx",[]);return this.each(function(){var b,c=false,f=i.timers,e=i._data(this);d||i._unmark(true,this);if(a==null)for(b in e){if(e[b]&&e[b].stop&&b.indexOf(".run")===b.length-4){var k=e[b];i.removeData(this,b,true);k.stop(d)}}else if(e[b=a+".run"]&&e[b].stop){e=e[b];i.removeData(this,b,true);e.stop(d)}for(b=f.length;b--;)if(f[b].elem===
            this&&(a==null||f[b].queue===a)){if(d)f[b](true);else f[b].saveState();c=true;f.splice(b,1)}(!d||!c)&&i.dequeue(this,a)})}});i.each({slideDown:A("show",1),slideUp:A("hide",1),slideToggle:A("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){i.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});i.extend({speed:function(a,b,c){var d=a&&typeof a==="object"?i.extend({},a):{complete:c||!c&&b||i.isFunction(a)&&a,duration:a,easing:c&&b||b&&!i.isFunction(b)&&
    ...
    {}}});i.fx.prototype={update:function(){this.options.step&&this.options.step.call(this.elem,this.now,this);(i.fx.step[this.prop]||i.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null))return this.elem[this.prop];var a,b=i.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||b==="auto"?0:b:a},custom:function(a,b,d){function f(a){return e.step(a)}var e=this,k=i.fx;this.startTime=ta||z();this.end=b;this.now=this.start=a;this.pos=
        this.state=0;this.unit=d||this.unit||(i.cssNumber[this.prop]?"":"px");f.queue=this.options.queue;f.elem=this.elem;f.saveState=function(){i._data(e.elem,"fxshow"+e.prop)===c&&(e.options.hide?i._data(e.elem,"fxshow"+e.prop,e.start):e.options.show&&i._data(e.elem,"fxshow"+e.prop,e.end))};f()&&i.timers.push(f)&&!xa&&(xa=setInterval(k.tick,k.interval))},show:function(){var a=i._data(this.elem,"fxshow"+this.prop);this.options.orig[this.prop]=a||i.style(this.elem,this.prop);this.options.show=true;a!==c?
        this.custom(this.cur(),a):this.custom(this.prop==="width"||this.prop==="height"?1:0,this.cur());i(this.elem).show()},hide:function(){this.options.orig[this.prop]=i._data(this.elem,"fxshow"+this.prop)||i.style(this.elem,this.prop);this.options.hide=true;this.custom(this.cur(),0)},step:function(a){var b,c=ta||z(),d=true,f=this.elem,e=this.options;if(a||c>=e.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();e.animatedProperties[this.prop]=true;for(b in e.animatedProperties)e.animatedProperties[b]!==
        true&&(d=false);if(d){e.overflow!=null&&!i.support.shrinkWrapBlocks&&i.each(["","X","Y"],function(a,b){f.style["overflow"+b]=e.overflow[a]});e.hide&&i(f).hide();if(e.hide||e.show)for(b in e.animatedProperties){i.style(f,b,e.orig[b]);i.removeData(f,"fxshow"+b,true);i.removeData(f,"toggle"+b,true)}if(a=e.complete){e.complete=false;a.call(f)}}return false}if(e.duration==Infinity)this.now=c;else{a=c-this.startTime;this.state=a/e.duration;this.pos=i.easing[e.animatedProperties[this.prop]](this.state,a,
        0,1,e.duration);this.now=this.start+(this.end-this.start)*this.pos}this.update();return true}};i.extend(i.fx,{tick:function(){for(var a,b=i.timers,c=0;c<b.length;c++){a=b[c];!a()&&b[c]===a&&b.splice(c--,1)}b.length||i.fx.stop()},interval:13,stop:function(){clearInterval(xa);xa=null},speeds:{slow:600,fast:200,_default:400},step:{opacity:function(a){i.style(a.elem,"opacity",a.now)},_default:function(a){a.elem.style&&a.elem.style[a.prop]!=null?a.elem.style[a.prop]=a.now+a.unit:a.elem[a.prop]=a.now}}});
    i.each(ua.concat.apply([],ua),function(a,b){b.indexOf("margin")&&(i.fx.step[b]=function(a){i.style(a.elem,b,Math.max(0,a.now)+a.unit)})});i.expr&&i.expr.filters&&(i.expr.filters.animated=function(a){return i.grep(i.timers,function(b){return a===b.elem}).length});var Wa,Bb=/^t(?:able|d|h)$/i,Xa=/^(?:body|html)$/i;Wa="getBoundingClientRect"in u.documentElement?function(a,b,c,d){try{d=a.getBoundingClientRect()}catch(f){}if(!d||!i.contains(c,a))return d?{top:d.top,left:d.left}:{top:0,left:0};a=b.body;
        b=I(b);return{top:d.top+(b.pageYOffset||i.support.boxModel&&c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0),left:d.left+(b.pageXOffset||i.support.boxModel&&c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0)}}:function(a,b,c){var d,f=a.offsetParent,e=b.body;d=(b=b.defaultView)?b.getComputedStyle(a,null):a.currentStyle;for(var k=a.offsetTop,g=a.offsetLeft;(a=a.parentNode)&&a!==e&&a!==c;){if(i.support.fixedPosition&&d.position==="fixed")break;d=b?b.getComputedStyle(a,null):a.currentStyle;
        k=k-a.scrollTop;g=g-a.scrollLeft;if(a===f){k=k+a.offsetTop;g=g+a.offsetLeft;if(i.support.doesNotAddBorder&&(!i.support.doesAddBorderForTableAndCells||!Bb.test(a.nodeName))){k=k+(parseFloat(d.borderTopWidth)||0);g=g+(parseFloat(d.borderLeftWidth)||0)}f=a.offsetParent}if(i.support.subtractsBorderForOverflowNotVisible&&d.overflow!=="visible"){k=k+(parseFloat(d.borderTopWidth)||0);g=g+(parseFloat(d.borderLeftWidth)||0)}}if(d.position==="relative"||d.position==="static"){k=k+e.offsetTop;g=g+e.offsetLeft}if(i.support.fixedPosition&&
        d.position==="fixed"){k=k+Math.max(c.scrollTop,e.scrollTop);g=g+Math.max(c.scrollLeft,e.scrollLeft)}return{top:k,left:g}};i.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){i.offset.setOffset(this,a,b)});var b=this[0],d=b&&b.ownerDocument;return!d?null:b===d.body?i.offset.bodyOffset(b):Wa(b,d,d.documentElement)};i.offset={bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;if(i.support.doesNotIncludeMarginInBodyOffset){b=b+(parseFloat(i.css(a,"marginTop"))||0);
        c=c+(parseFloat(i.css(a,"marginLeft"))||0)}return{top:b,left:c}},setOffset:function(a,b,c){var d=i.css(a,"position");if(d==="static")a.style.position="relative";var f=i(a),e=f.offset(),k=i.css(a,"top"),g=i.css(a,"left"),h={},j={};if((d==="absolute"||d==="fixed")&&i.inArray("auto",[k,g])>-1){j=f.position();d=j.top;g=j.left}else{d=parseFloat(k)||0;g=parseFloat(g)||0}i.isFunction(b)&&(b=b.call(a,c,e));if(b.top!=null)h.top=b.top-e.top+d;if(b.left!=null)h.left=b.left-e.left+g;"using"in b?b.using.call(a,
        h):f.css(h)}};i.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Xa.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top=c.top-(parseFloat(i.css(a,"marginTop"))||0);c.left=c.left-(parseFloat(i.css(a,"marginLeft"))||0);d.top=d.top+(parseFloat(i.css(b[0],"borderTopWidth"))||0);d.left=d.left+(parseFloat(i.css(b[0],"borderLeftWidth"))||0);return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
        this.offsetParent||u.body;a&&!Xa.test(a.nodeName)&&i.css(a,"position")==="static";)a=a.offsetParent;return a})}});i.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);i.fn[a]=function(f){return i.access(this,function(a,f,e){var k=I(a);if(e===c)return k?b in k?k[b]:i.support.boxModel&&k.document.documentElement[f]||k.document.body[f]:a[f];k?k.scrollTo(!d?e:i(k).scrollLeft(),d?e:i(k).scrollTop()):a[f]=e},a,f,arguments.length,null)}});i.each({Height:"height",Width:"width"},
        function(a,b){var d="client"+a,f="scroll"+a,e="offset"+a;i.fn["inner"+a]=function(){var a=this[0];return a?a.style?parseFloat(i.css(a,b,"padding")):this[b]():null};i.fn["outer"+a]=function(a){var c=this[0];return c?c.style?parseFloat(i.css(c,b,a?"margin":"border")):this[b]():null};i.fn[b]=function(a){return i.access(this,function(a,b,k){if(i.isWindow(a)){b=a.document;a=b.documentElement[d];return i.support.boxModel&&a||b.body&&b.body[d]||a}if(a.nodeType===9){b=a.documentElement;return b[d]>=b[f]?
            b[d]:Math.max(a.body[f],b[f],a.body[e],b[e])}if(k===c){a=i.css(a,b);b=parseFloat(a);return i.isNumeric(b)?b:a}i(a).css(b,k)},b,a,arguments.length,null)}});a.jQuery=a.$=i;"function"===typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return i})})(m);var w=m.jQuery.noConflict(!0);m.raptor=w;(function(a,c){function d(c,d){var e=c.nodeName.toLowerCase();if("area"===e){var e=c.parentNode,b=e.name;if(!c.href||!b||"map"!==e.nodeName.toLowerCase())return!1;e=a("img[usemap=#"+b+"]")[0];
    return!!e&&g(e)}return(/input|select|textarea|button|object/.test(e)?!c.disabled:"a"==e?c.href||d:d)&&g(c)}function g(c){return!a(c).parents().andSelf().filter(function(){return"hidden"===a.curCSS(this,"visibility")||a.expr.filters.hidden(this)}).length}a.ui=a.ui||{};a.ui.version||(a.extend(a.ui,{version:"1.8.20",keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:91,COMMAND_LEFT:91,COMMAND_RIGHT:93,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,MENU:93,NUMPAD_ADD:107,
    NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38,WINDOWS:91}}),a.fn.extend({propAttr:a.fn.prop||a.fn.attr,_focus:a.fn.focus,focus:function(c,d){return"number"===typeof c?this.each(function(){var e=this;setTimeout(function(){a(e).focus();d&&d.call(e)},c)}):this._focus.apply(this,arguments)},scrollParent:function(){var c;c=a.browser.msie&&/(static|relative)/.test(this.css("position"))||
    ...
    c)return this.css("zIndex",d);if(this.length)for(var d=a(this[0]),g;d.length&&d[0]!==document;){g=d.css("position");if("absolute"===g||"relative"===g||"fixed"===g)if(g=parseInt(d.css("zIndex"),10),!isNaN(g)&&0!==g)return g;d=d.parent()}return 0},disableSelection:function(){return this.bind((a.support.selectstart?"selectstart":"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}}),a.each(["Width","Height"],function(d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              g){function e(c,d,f,e){a.each(b,function(){d-=parseFloat(a.curCSS(c,"padding"+this,!0))||0;f&&(d-=parseFloat(a.curCSS(c,"border"+this+"Width",!0))||0);e&&(d-=parseFloat(a.curCSS(c,"margin"+this,!0))||0)});return d}var b="Width"===g?["Left","Right"]:["Top","Bottom"],j=g.toLowerCase(),l={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+g]=function(b){return b===c?l["inner"+g].call(this):this.each(function(){a(this).css(j,e(this,
    b)+"px")})};a.fn["outer"+g]=function(b,c){return"number"!==typeof b?l["outer"+g].call(this,b):this.each(function(){a(this).css(j,e(this,b,!0,c)+"px")})}}),a.extend(a.expr[":"],{data:function(c,d,e){return!!a.data(c,e[3])},focusable:function(c){return d(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var g=a.attr(c,"tabindex"),e=isNaN(g);return(e||0<=g)&&d(c,!e)}}),a(function(){var c=document.body,d=c.appendChild(d=document.createElement("div"));d.offsetHeight;a.extend(d.style,{minHeight:"100px",
    height:"auto",padding:0,borderWidth:0});a.support.minHeight=100===d.offsetHeight;a.support.selectstart="onselectstart"in d;c.removeChild(d).style.display="none"}),a.extend(a.ui,{plugin:{add:function(c,d,e){var c=a.ui[c].prototype,b;for(b in e)c.plugins[b]=c.plugins[b]||[],c.plugins[b].push([d,e[b]])},call:function(a,c,d){if((c=a.plugins[c])&&a.element[0].parentNode)for(var b=0;b<c.length;b++)a.options[c[b][0]]&&c[b][1].apply(a.element,d)}},contains:function(a,c){return document.compareDocumentPosition?
    a.compareDocumentPosition(c)&16:a!==c&&a.contains(c)},hasScroll:function(c,d){if("hidden"===a(c).css("overflow"))return!1;var e=d&&"left"===d?"scrollLeft":"scrollTop",b=!1;if(0<c[e])return!0;c[e]=1;b=0<c[e];c[e]=0;return b},isOverAxis:function(a,c,d){return a>c&&a<c+d},isOver:function(c,d,e,b,g,l){return a.ui.isOverAxis(c,e,g)&&a.ui.isOverAxis(d,b,l)}}))})(w);(function(a,c){if(a.cleanData){var d=a.cleanData;a.cleanData=function(c){for(var g=0,e;null!=(e=c[g]);g++)try{a(e).triggerHandler("remove")}catch(b){}d(c)}}else{var g=
    a.fn.remove;a.fn.remove=function(c,d){return this.each(function(){d||(!c||a.filter(c,[this]).length)&&a("*",this).add([this]).each(function(){try{a(this).triggerHandler("remove")}catch(c){}});return g.call(a(this),c,d)})}}a.widget=function(c,d,e){var b=c.split(".")[0],g,c=c.split(".")[1];g=b+"-"+c;e||(e=d,d=a.Widget);a.expr[":"][g]=function(b){return!!a.data(b,c)};a[b]=a[b]||{};a[b][c]=function(a,b){arguments.length&&this._createWidget(a,b)};d=new d;d.options=a.extend(!0,{},d.options);a[b][c].prototype=
    a.extend(!0,d,{namespace:b,widgetName:c,widgetEventPrefix:a[b][c].prototype.widgetEventPrefix||c,widgetBaseClass:g},e);a.widget.bridge(c,a[b][c])};a.widget.bridge=function(d,g){a.fn[d]=function(e){var b="string"===typeof e,j=Array.prototype.slice.call(arguments,1),l=this,e=!b&&j.length?a.extend.apply(null,[!0,e].concat(j)):e;if(b&&"_"===e.charAt(0))return l;b?this.each(function(){var b=a.data(this,d),g=b&&a.isFunction(b[e])?b[e].apply(b,j):b;if(g!==b&&g!==c)return l=g,!1}):this.each(function(){var b=
    a.data(this,d);b?b.option(e||{})._init():a.data(this,d,new g(e,this))});return l}};a.Widget=function(a,c){arguments.length&&this._createWidget(a,c)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:!1},_createWidget:function(c,d){a.data(d,this.widgetName,this);this.element=a(d);this.options=a.extend(!0,{},this.options,this._getCreateOptions(),c);var e=this;this.element.bind("remove."+this.widgetName,function(){e.destroy()});this._create();this._trigger("create");this._init()},
    _getCreateOptions:function(){return a.metadata&&a.metadata.get(this.element[0])[this.widgetName]},_create:function(){},_init:function(){},destroy:function(){this.element.unbind("."+this.widgetName).removeData(this.widgetName);this.widget().unbind("."+this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass+"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(d,g){var e=d;if(0===arguments.length)return a.extend({},this.options);if("string"===typeof d){if(g===
        c)return this.options[d];e={};e[d]=g}this._setOptions(e);return this},_setOptions:function(c){var d=this;a.each(c,function(a,b){d._setOption(a,b)});return this},_setOption:function(a,c){this.options[a]=c;"disabled"===a&&this.widget()[c?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",c);return this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_trigger:function(c,d,e){var b,g=this.options[c],
        e=e||{},d=a.Event(d);d.type=(c===this.widgetEventPrefix?c:this.widgetEventPrefix+c).toLowerCase();d.target=this.element[0];if(c=d.originalEvent)for(b in c)b in d||(d[b]=c[b]);this.element.trigger(d,e);return!(a.isFunction(g)&&!1===g.call(this.element[0],d,e)||d.isDefaultPrevented())}}})(w);(function(a){var c=!1;a(document).mouseup(function(){c=!1});a.widget("ui.mouse",{options:{cancel:":input,option",distance:1,delay:0},_mouseInit:function(){var c=this;this.element.bind("mousedown."+this.widgetName,
    function(a){return c._mouseDown(a)}).bind("click."+this.widgetName,function(g){if(!0===a.data(g.target,c.widgetName+".preventClickEvent"))return a.removeData(g.target,c.widgetName+".preventClickEvent"),g.stopImmediatePropagation(),!1});this.started=!1},_mouseDestroy:function(){this.element.unbind("."+this.widgetName);a(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate)},_mouseDown:function(d){if(!c){this._mouseStarted&&this._mouseUp(d);
    this._mouseDownEvent=d;var g=this,f=1==d.which,h="string"==typeof this.options.cancel&&d.target.nodeName?a(d.target).closest(this.options.cancel).length:!1;if(!f||h||!this._mouseCapture(d))return!0;this.mouseDelayMet=!this.options.delay;this.mouseDelayMet||(this._mouseDelayTimer=setTimeout(function(){g.mouseDelayMet=!0},this.options.delay));if(this._mouseDistanceMet(d)&&this._mouseDelayMet(d)&&(this._mouseStarted=!1!==this._mouseStart(d),!this._mouseStarted))return d.preventDefault(),!0;!0===a.data(d.target,
    ...
    !d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c);this.helper.addClass("ui-draggable-dragging");this._mouseDrag(c,!0);a.ui.ddmanager&&a.ui.ddmanager.dragStart(this,c);return!0},_mouseDrag:function(c,d){this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");if(!d){var g=this._uiHash();if(!1===this._trigger("drag",c,g))return this._mouseUp({}),!1;this.position=g.position}if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+
    "px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);return!1},_mouseStop:function(c){var d=!1;a.ui.ddmanager&&!this.options.dropBehaviour&&(d=a.ui.ddmanager.drop(this,c));this.dropped&&(d=this.dropped,this.dropped=!1);for(var g=this.element[0],f=!1;g&&(g=g.parentNode);)g==document&&(f=!0);if(!f&&"original"===this.options.helper)return!1;if("invalid"==this.options.revert&&!d||"valid"==this.options.revert&&d||
...
{left:parseInt(this.element.css("marginLeft"),10)||0,top:parseInt(this.element.css("marginTop"),10)||0,right:parseInt(this.element.css("marginRight"),10)||0,bottom:parseInt(this.element.css("marginBottom"),10)||0}},_cacheHelperProportions:function(){this.helperProportions={width:this.helper.outerWidth(),height:this.helper.outerHeight()}},_setContainment:function(){var c=this.options;"parent"==c.containment&&(c.containment=this.helper[0].parentNode);if("document"==c.containment||"window"==c.containment)this.containment=
    ...
    if(!/^(document|window|parent)$/.test(c.containment)&&c.containment.constructor!=Array){var c=a(c.containment),d=c[0];if(d){c.offset();var g="hidden"!=a(d).css("overflow");this.containment=[(parseInt(a(d).css("borderLeftWidth"),10)||0)+(parseInt(a(d).css("paddingLeft"),10)||0),(parseInt(a(d).css("borderTopWidth"),10)||0)+(parseInt(a(d).css("paddingTop"),10)||0),(g?Math.max(d.scrollWidth,d.offsetWidth):d.offsetWidth)-(parseInt(a(d).css("borderLeftWidth"),10)||0)-(parseInt(a(d).css("paddingRight"),
        10)||0)-this.helperProportions.width-this.margins.left-this.margins.right,(g?Math.max(d.scrollHeight,d.offsetHeight):d.offsetHeight)-(parseInt(a(d).css("borderTopWidth"),10)||0)-(parseInt(a(d).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top-this.margins.bottom];this.relative_container=c}}else c.containment.constructor==Array&&(this.containment=c.containment)},_convertPositionTo:function(c,d){d||(d=this.position);var g="absolute"==c?1:-1,f="absolute"==this.cssPosition&&
    !(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,h=/(html|body)/i.test(f[0].tagName);return{top:d.top+this.offset.relative.top*g+this.offset.parent.top*g-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():h?0:f.scrollTop())*g),left:d.left+this.offset.relative.left*g+this.offset.parent.left*g-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?
    0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():h?0:f.scrollLeft())*g)}},_generatePosition:function(c){var d=this.options,g="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(g[0].tagName),h=c.pageX,e=c.pageY;if(this.originalPosition){var b;this.containment&&(this.relative_container?(b=this.relative_container.offset(),b=[this.containment[0]+b.left,this.containment[1]+
    b.top,this.containment[2]+b.left,this.containment[3]+b.top]):b=this.containment,c.pageX-this.offset.click.left<b[0]&&(h=b[0]+this.offset.click.left),c.pageY-this.offset.click.top<b[1]&&(e=b[1]+this.offset.click.top),c.pageX-this.offset.click.left>b[2]&&(h=b[2]+this.offset.click.left),c.pageY-this.offset.click.top>b[3]&&(e=b[3]+this.offset.click.top));d.grid&&(e=d.grid[1]?this.originalPageY+Math.round((e-this.originalPageY)/d.grid[1])*d.grid[1]:this.originalPageY,e=b?!(e-this.offset.click.top<b[1]||
    e-this.offset.click.top>b[3])?e:!(e-this.offset.click.top<b[1])?e-d.grid[1]:e+d.grid[1]:e,h=d.grid[0]?this.originalPageX+Math.round((h-this.originalPageX)/d.grid[0])*d.grid[0]:this.originalPageX,h=b?!(h-this.offset.click.left<b[0]||h-this.offset.click.left>b[2])?h:!(h-this.offset.click.left<b[0])?h-d.grid[0]:h+d.grid[0]:h)}return{top:e-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?
    ...
    g||this._uiHash();a.ui.plugin.call(this,c,[d,g]);"drag"==c&&(this.positionAbs=this._convertPositionTo("absolute"));return a.Widget.prototype._trigger.call(this,c,d,g)},plugins:{},_uiHash:function(){return{helper:this.helper,position:this.position,originalPosition:this.originalPosition,offset:this.positionAbs}}});a.extend(a.ui.draggable,{version:"1.8.20"});a.ui.plugin.add("draggable","connectToSortable",{start:function(c,d){var g=a(this).data("draggable"),f=g.options,h=a.extend({},d,{item:g.element});
    g.sortables=[];a(f.connectToSortable).each(function(){var d=a.data(this,"sortable");d&&!d.options.disabled&&(g.sortables.push({instance:d,shouldRevert:d.options.revert}),d.refreshPositions(),d._trigger("activate",c,h))})},stop:function(c,d){var g=a(this).data("draggable"),f=a.extend({},d,{item:g.element});a.each(g.sortables,function(){this.instance.isOver?(this.instance.isOver=0,g.cancelHelperRemoval=!0,this.instance.cancelHelperRemoval=!1,this.shouldRevert&&(this.instance.options.revert=!0),this.instance._mouseStop(c),
    this.instance.options.helper=this.instance.options._helper,"original"==g.options.helper&&this.instance.currentItem.css({top:"auto",left:"auto"})):(this.instance.cancelHelperRemoval=!1,this.instance._trigger("deactivate",c,f))})},drag:function(c,d){var g=a(this).data("draggable"),f=this;a.each(g.sortables,function(){this.instance.positionAbs=g.positionAbs;this.instance.helperProportions=g.helperProportions;this.instance.offset.click=g.offset.click;this.instance._intersectsWith(this.instance.containerCache)?
    ...
    !0),this.instance.options.helper=this.instance.options._helper,this.instance.currentItem.remove(),this.instance.placeholder&&this.instance.placeholder.remove(),g._trigger("fromSortable",c),g.dropped=!1)})}});a.ui.plugin.add("draggable","cursor",{start:function(){var c=a("body"),d=a(this).data("draggable").options;c.css("cursor")&&(d._cursor=c.css("cursor"));c.css("cursor",d.cursor)},stop:function(){var c=a(this).data("draggable").options;c._cursor&&a("body").css("cursor",c._cursor)}});a.ui.plugin.add("draggable",
    "opacity",{start:function(c,d){var g=a(d.helper),f=a(this).data("draggable").options;g.css("opacity")&&(f._opacity=g.css("opacity"));g.css("opacity",f.opacity)},stop:function(c,d){var g=a(this).data("draggable").options;g._opacity&&a(d.helper).css("opacity",g._opacity)}});a.ui.plugin.add("draggable","scroll",{start:function(){var c=a(this).data("draggable");c.scrollParent[0]!=document&&"HTML"!=c.scrollParent[0].tagName&&(c.overflowOffset=c.scrollParent.offset())},drag:function(c){var d=a(this).data("draggable"),
    g=d.options,f=!1;if(d.scrollParent[0]!=document&&"HTML"!=d.scrollParent[0].tagName){if(!g.axis||"x"!=g.axis)d.overflowOffset.top+d.scrollParent[0].offsetHeight-c.pageY<g.scrollSensitivity?d.scrollParent[0].scrollTop=f=d.scrollParent[0].scrollTop+g.scrollSpeed:c.pageY-d.overflowOffset.top<g.scrollSensitivity&&(d.scrollParent[0].scrollTop=f=d.scrollParent[0].scrollTop-g.scrollSpeed);if(!g.axis||"y"!=g.axis)d.overflowOffset.left+d.scrollParent[0].offsetWidth-c.pageX<g.scrollSensitivity?d.scrollParent[0].scrollLeft=
    f=d.scrollParent[0].scrollLeft+g.scrollSpeed:c.pageX-d.overflowOffset.left<g.scrollSensitivity&&(d.scrollParent[0].scrollLeft=f=d.scrollParent[0].scrollLeft-g.scrollSpeed)}else{if(!g.axis||"x"!=g.axis)c.pageY-a(document).scrollTop()<g.scrollSensitivity?f=a(document).scrollTop(a(document).scrollTop()-g.scrollSpeed):a(m).height()-(c.pageY-a(document).scrollTop())<g.scrollSensitivity&&(f=a(document).scrollTop(a(document).scrollTop()+g.scrollSpeed));if(!g.axis||"y"!=g.axis)c.pageX-a(document).scrollLeft()<
    g.scrollSensitivity?f=a(document).scrollLeft(a(document).scrollLeft()-g.scrollSpeed):a(m).width()-(c.pageX-a(document).scrollLeft())<g.scrollSensitivity&&(f=a(document).scrollLeft(a(document).scrollLeft()+g.scrollSpeed))}!1!==f&&a.ui.ddmanager&&!g.dropBehaviour&&a.ui.ddmanager.prepareOffsets(d,c)}});a.ui.plugin.add("draggable","snap",{start:function(){var c=a(this).data("draggable"),d=c.options;c.snapElements=[];a(d.snap.constructor!=String?d.snap.items||":data(draggable)":d.snap).each(function(){var d=
    a(this),f=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:f.top,left:f.left})})},drag:function(c,d){for(var g=a(this).data("draggable"),f=g.options,h=f.snapTolerance,e=d.offset.left,b=e+g.helperProportions.width,j=d.offset.top,l=j+g.helperProportions.height,o=g.snapElements.length-1;0<=o;o--){var n=g.snapElements[o].left,p=n+g.snapElements[o].width,q=g.snapElements[o].top,s=q+g.snapElements[o].height;if(n-h<e&&e<p+h&&q-h<j&&j<s+h||n-h<
    e&&e<p+h&&q-h<l&&l<s+h||n-h<b&&b<p+h&&q-h<j&&j<s+h||n-h<b&&b<p+h&&q-h<l&&l<s+h){if("inner"!=f.snapMode){var x=Math.abs(q-l)<=h,r=Math.abs(s-j)<=h,m=Math.abs(n-b)<=h,F=Math.abs(p-e)<=h;x&&(d.position.top=g._convertPositionTo("relative",{top:q-g.helperProportions.height,left:0}).top-g.margins.top);r&&(d.position.top=g._convertPositionTo("relative",{top:s,left:0}).top-g.margins.top);m&&(d.position.left=g._convertPositionTo("relative",{top:0,left:n-g.helperProportions.width}).left-g.margins.left);F&&
(d.position.left=g._convertPositionTo("relative",{top:0,left:p}).left-g.margins.left)}var E=x||r||m||F;if("outer"!=f.snapMode&&(x=Math.abs(q-j)<=h,r=Math.abs(s-l)<=h,m=Math.abs(n-e)<=h,F=Math.abs(p-b)<=h,x&&(d.position.top=g._convertPositionTo("relative",{top:q,left:0}).top-g.margins.top),r&&(d.position.top=g._convertPositionTo("relative",{top:s-g.helperProportions.height,left:0}).top-g.margins.top),m&&(d.position.left=g._convertPositionTo("relative",{top:0,left:n}).left-g.margins.left),F))d.position.left=
    g._convertPositionTo("relative",{top:0,left:p-g.helperProportions.width}).left-g.margins.left;!g.snapElements[o].snapping&&(x||r||m||F||E)&&g.options.snap.snap&&g.options.snap.snap.call(g.element,c,a.extend(g._uiHash(),{snapItem:g.snapElements[o].item}));g.snapElements[o].snapping=x||r||m||F||E}else g.snapElements[o].snapping&&g.options.snap.release&&g.options.snap.release.call(g.element,c,a.extend(g._uiHash(),{snapItem:g.snapElements[o].item})),g.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable",
    "stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=d+a});this[0].style.zIndex=d+c.length}}});a.ui.plugin.add("draggable","zIndex",{start:function(c,d){var g=a(d.helper),f=a(this).data("draggable").options;g.css("zIndex")&&(f._zIndex=g.css("zIndex"));g.css("zIndex",f.zIndex)},
    stop:function(c,d){var g=a(this).data("draggable").options;g._zIndex&&a(d.helper).css("zIndex",g._zIndex)}})})(w);(function(a){a.widget("ui.droppable",{widgetEventPrefix:"drop",options:{accept:"*",activeClass:!1,addClasses:!0,greedy:!1,hoverClass:!1,scope:"default",tolerance:"intersect"},_create:function(){var c=this.options,d=c.accept;this.isover=0;this.isout=1;this.accept=a.isFunction(d)?d:function(a){return a.is(d)};this.proportions={width:this.element[0].offsetWidth,height:this.element[0].offsetHeight};
    ...
    d.currentItem||d.element))this.options.hoverClass&&this.element.addClass(this.options.hoverClass),this._trigger("over",c,this.ui(d))},_out:function(c){var d=a.ui.ddmanager.current;if(d&&(d.currentItem||d.element)[0]!=this.element[0])if(this.accept.call(this.element[0],d.currentItem||d.element))this.options.hoverClass&&this.element.removeClass(this.options.hoverClass),this._trigger("out",c,this.ui(d))},_drop:function(c,d){var g=d||a.ui.ddmanager.current;if(!g||(g.currentItem||g.element)[0]==this.element[0])return!1;
    var f=!1;this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function(){var c=a.data(this,"droppable");if(c.options.greedy&&!c.options.disabled&&c.options.scope==g.options.scope&&c.accept.call(c.element[0],g.currentItem||g.element)&&a.ui.intersect(g,a.extend(c,{offset:c.element.offset()}),c.options.tolerance))return f=!0,!1});return f?!1:this.accept.call(this.element[0],g.currentItem||g.element)?(this.options.activeClass&&this.element.removeClass(this.options.activeClass),this.options.hoverClass&&
        this.element.removeClass(this.options.hoverClass),this._trigger("drop",c,this.ui(g)),this.element):!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,g){if(!d.offset)return!1;var f=(c.positionAbs||c.position.absolute).left,h=f+c.helperProportions.width,e=(c.positionAbs||c.position.absolute).top,b=e+c.helperProportions.height,j=d.offset.left,l=j+d.proportions.width,
    o=d.offset.top,n=o+d.proportions.height;switch(g){case "fit":return j<=f&&h<=l&&o<=e&&b<=n;case "intersect":return j<f+c.helperProportions.width/2&&h-c.helperProportions.width/2<l&&o<e+c.helperProportions.height/2&&b-c.helperProportions.height/2<n;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,o,j,d.proportions.height,d.proportions.width);case "touch":return(e>=
    o&&e<=n||b>=o&&b<=n||e<o&&b>n)&&(f>=j&&f<=l||h>=j&&h<=l||f<j&&h>l);default:return!1}};a.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(c,d){var g=a.ui.ddmanager.droppables[c.options.scope]||[],f=d?d.type:null,h=(c.currentItem||c.element).find(":data(droppable)").andSelf(),e=0;a:for(;e<g.length;e++)if(!(g[e].options.disabled||c&&!g[e].accept.call(g[e].element[0],c.currentItem||c.element))){for(var b=0;b<h.length;b++)if(h[b]==g[e].element[0]){g[e].proportions.height=0;
    continue a}g[e].visible="none"!=g[e].element.css("display");g[e].visible&&("mousedown"==f&&g[e]._activate.call(g[e],d),g[e].offset=g[e].element.offset(),g[e].proportions={width:g[e].element[0].offsetWidth,height:g[e].element[0].offsetHeight})}},drop:function(c,d){var g=!1;a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(this.options&&(!this.options.disabled&&this.visible&&a.ui.intersect(c,this,this.options.tolerance)&&(g=this._drop.call(this,d)||g),!this.options.disabled&&this.visible&&
    this.accept.call(this.element[0],c.currentItem||c.element)))this.isout=1,this.isover=0,this._deactivate.call(this,d)});return g},dragStart:function(c,d){c.element.parents(":not(body,html)").bind("scroll.droppable",function(){c.options.refreshPositions||a.ui.ddmanager.prepareOffsets(c,d)})},drag:function(c,d){c.options.refreshPositions&&a.ui.ddmanager.prepareOffsets(c,d);a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var g=
    a.ui.intersect(c,this,this.options.tolerance);if(g=!g&&1==this.isover?"isout":g&&0==this.isover?"isover":null){var f;if(this.options.greedy){var h=this.element.parents(":data(droppable):eq(0)");h.length&&(f=a.data(h[0],"droppable"),f.greedyChild="isover"==g?1:0)}f&&"isover"==g&&(f.isover=0,f.isout=1,f._out.call(f,d));this[g]=1;this["isout"==g?"isover":"isout"]=0;this["isover"==g?"_over":"_out"].call(this,d);f&&"isout"==g&&(f.isout=0,f.isover=1,f._over.call(f,d))}}})},dragStop:function(c,d){c.element.parents(":not(body,html)").unbind("scroll.droppable");
    ...
    this.handles&&(this.handles="n,e,s,w,se,sw,ne,nw");var h=this.handles.split(",");this.handles={};for(var e=0;e<h.length;e++){var b=a.trim(h[e]),j=a('<div class="ui-resizable-handle ui-resizable-'+b+'"></div>');j.css({zIndex:d.zIndex});"se"==b&&j.addClass("ui-icon ui-icon-gripsmall-diagonal-se");this.handles[b]=".ui-resizable-"+b;this.element.append(j)}}this._renderAxis=function(b){var b=b||this.element,c;for(c in this.handles){this.handles[c].constructor==String&&(this.handles[c]=a(this.handles[c],
    this.element).show());if(this.elementIsWrapper&&this.originalElement[0].nodeName.match(/textarea|input|select|button/i)){var d=a(this.handles[c],this.element),f=0,f=/sw|ne|nw|se|n|s/.test(c)?d.outerHeight():d.outerWidth(),d=["padding",/ne|nw|n/.test(c)?"Top":/se|sw|s/.test(c)?"Bottom":/^e$/.test(c)?"Right":"Left"].join("");b.css(d,f);this._proportionallyResize()}a(this.handles[c])}};this._renderAxis(this.element);this._handles=a(".ui-resizable-handle",this.element).disableSelection();this._handles.mouseover(function(){if(!c.resizing){if(this.className)var a=
    ...
    if(this.elementIsWrapper){c(this.element);var d=this.element;d.after(this.originalElement.css({position:d.css("position"),width:d.outerWidth(),height:d.outerHeight(),top:d.css("top"),left:d.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);c(this.originalElement);return this},_mouseCapture:function(c){var d=!1,h;for(h in this.handles)a(this.handles[h])[0]==c.target&&(d=!0);return!this.options.disabled&&d},_mouseStart:function(d){var f=this.options,h=this.element.position(),
    e=this.element;this.resizing=!0;this.documentScroll={top:a(document).scrollTop(),left:a(document).scrollLeft()};(e.is(".ui-draggable")||/absolute/.test(e.css("position")))&&e.css({position:"absolute",top:h.top,left:h.left});this._renderProxy();var h=c(this.helper.css("left")),b=c(this.helper.css("top"));f.containment&&(h+=a(f.containment).scrollLeft()||0,b+=a(f.containment).scrollTop()||0);this.offset=this.helper.offset();this.position={left:h,top:b};this.size=this._helper?{width:e.outerWidth(),height:e.outerHeight()}:
{width:e.width(),height:e.height()};this.originalSize=this._helper?{width:e.outerWidth(),height:e.outerHeight()}:{width:e.width(),height:e.height()};this.originalPosition={left:h,top:b};this.sizeDiff={width:e.outerWidth()-e.width(),height:e.outerHeight()-e.height()};this.originalMousePosition={left:d.pageX,top:d.pageY};this.aspectRatio="number"==typeof f.aspectRatio?f.aspectRatio:this.originalSize.width/this.originalSize.height||1;f=a(".ui-resizable-"+this.axis).css("cursor");a("body").css("cursor",
    "auto"==f?this.axis+"-resize":f);e.addClass("ui-resizable-resizing");this._propagate("start",d);return!0},_mouseDrag:function(a){var c=this.helper,d=this.originalMousePosition,e=this._change[this.axis];if(!e)return!1;d=e.apply(this,[a,a.pageX-d.left||0,a.pageY-d.top||0]);this._updateVirtualBoundaries(a.shiftKey);if(this._aspectRatio||a.shiftKey)d=this._updateRatio(d,a);d=this._respectSize(d,a);this._propagate("resize",a);c.css({top:this.position.top+"px",left:this.position.left+"px",width:this.size.width+
    "px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(d);this._trigger("resize",a,this.ui());return!1},_mouseStop:function(c){this.resizing=!1;var d=this.options;if(this._helper){var h=this._proportionallyResizeElements,e=h.length&&/textarea/i.test(h[0].nodeName),h=e&&a.ui.hasScroll(h[0],"left")?0:this.sizeDiff.height,e=e?0:this.sizeDiff.width,e={width:this.helper.width()-e,height:this.helper.height()-h},h=parseInt(this.element.css("left"),
    10)+(this.position.left-this.originalPosition.left)||null,b=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null;d.animate||this.element.css(a.extend(e,{top:b,left:h}));this.helper.height(this.size.height);this.helper.width(this.size.width);this._helper&&!d.animate&&this._proportionallyResize()}a("body").css("cursor","auto");this.element.removeClass("ui-resizable-resizing");this._propagate("stop",c);this._helper&&this.helper.remove();return!1},_updateVirtualBoundaries:function(a){var c=
    this.options,h,e,b,c={minWidth:d(c.minWidth)?c.minWidth:0,maxWidth:d(c.maxWidth)?c.maxWidth:Infinity,minHeight:d(c.minHeight)?c.minHeight:0,maxHeight:d(c.maxHeight)?c.maxHeight:Infinity};if(this._aspectRatio||a)if(a=c.minHeight*this.aspectRatio,e=c.minWidth/this.aspectRatio,h=c.maxHeight*this.aspectRatio,b=c.maxWidth/this.aspectRatio,a>c.minWidth&&(c.minWidth=a),e>c.minHeight&&(c.minHeight=e),h<c.maxWidth&&(c.maxWidth=h),b<c.maxHeight)c.maxHeight=b;this._vBoundaries=c},_updateCache:function(a){this.offset=
    this.helper.offset();d(a.left)&&(this.position.left=a.left);d(a.top)&&(this.position.top=a.top);d(a.height)&&(this.size.height=a.height);d(a.width)&&(this.size.width=a.width)},_updateRatio:function(a){var c=this.position,h=this.size,e=this.axis;d(a.height)?a.width=a.height*this.aspectRatio:d(a.width)&&(a.height=a.width/this.aspectRatio);"sw"==e&&(a.left=c.left+(h.width-a.width),a.top=null);"nw"==e&&(a.top=c.top+(h.height-a.height),a.left=c.left+(h.width-a.width));return a},_respectSize:function(a){var c=
    this._vBoundaries,h=this.axis,e=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,j=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;j&&(a.width=c.minWidth);l&&(a.height=c.minHeight);e&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var o=this.originalPosition.left+this.originalSize.width,n=this.position.top+this.size.height,p=/sw|nw|w/.test(h),h=/nw|ne|n/.test(h);j&&p&&(a.left=o-c.minWidth);e&&p&&(a.left=o-c.maxWidth);
    l&&h&&(a.top=n-c.minHeight);b&&h&&(a.top=n-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var h=this._proportionallyResizeElements[d];if(!this.borderDif){var e=[h.css("borderTopWidth"),h.css("borderRightWidth"),h.css("borderBottomWidth"),h.css("borderLeftWidth")],b=[h.css("paddingTop"),
    h.css("paddingRight"),h.css("paddingBottom"),h.css("paddingLeft")];this.borderDif=a.map(e,function(a,c){var d=parseInt(a,10)||0,f=parseInt(b[c],10)||0;return d+f})}if(!a.browser.msie||!a(c).is(":hidden")&&!a(c).parents(":hidden").length)h.css({height:c.height()-this.borderDif[0]-this.borderDif[2]||0,width:c.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var c=this.options;this.elementOffset=this.element.offset();if(this._helper){this.helper=this.helper||a('<div style="overflow:hidden;"></div>');
    ...
    {start:function(){var c=a(this).data("resizable").options,d=function(c){a(c).each(function(){var c=a(this);c.data("resizable-alsoresize",{width:parseInt(c.width(),10),height:parseInt(c.height(),10),left:parseInt(c.css("left"),10),top:parseInt(c.css("top"),10)})})};"object"==typeof c.alsoResize&&!c.alsoResize.parentNode?c.alsoResize.length?(c.alsoResize=c.alsoResize[0],d(c.alsoResize)):a.each(c.alsoResize,function(a){d(a)}):d(c.alsoResize)},resize:function(c,d){var h=a(this).data("resizable"),e=h.options,
        b=h.originalSize,j=h.originalPosition,l={height:h.size.height-b.height||0,width:h.size.width-b.width||0,top:h.position.top-j.top||0,left:h.position.left-j.left||0},o=function(b,c){a(b).each(function(){var b=a(this),e=a(this).data("resizable-alsoresize"),g={},j=c&&c.length?c:b.parents(d.originalElement[0]).length?["width","height"]:["width","height","top","left"];a.each(j,function(a,b){var c=(e[b]||0)+(l[b]||0);c&&0<=c&&(g[b]=c||null)});b.css(g)})};"object"==typeof e.alsoResize&&!e.alsoResize.nodeType?
        a.each(e.alsoResize,function(a,b){o(a,b)}):o(e.alsoResize)},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","animate",{stop:function(c){var d=a(this).data("resizable"),h=d.options,e=d._proportionallyResizeElements,b=e.length&&/textarea/i.test(e[0].nodeName),j=b&&a.ui.hasScroll(e[0],"left")?0:d.sizeDiff.height,b={width:d.size.width-(b?0:d.sizeDiff.width),height:d.size.height-j},j=parseInt(d.element.css("left"),10)+(d.position.left-d.originalPosition.left)||
    null,l=parseInt(d.element.css("top"),10)+(d.position.top-d.originalPosition.top)||null;d.element.animate(a.extend(b,l&&j?{top:l,left:j}:{}),{duration:h.animateDuration,easing:h.animateEasing,step:function(){var b={width:parseInt(d.element.css("width"),10),height:parseInt(d.element.css("height"),10),top:parseInt(d.element.css("top"),10),left:parseInt(d.element.css("left"),10)};e&&e.length&&a(e[0]).css({width:b.width,height:b.height});d._updateCache(b);d._propagate("resize",c)}})}});a.ui.plugin.add("resizable",
    "containment",{start:function(){var d=a(this).data("resizable"),f=d.element,h=d.options.containment;if(f=h instanceof a?h.get(0):/parent/.test(h)?f.parent().get(0):h)if(d.containerElement=a(f),/document/.test(h)||h==document)d.containerOffset={left:0,top:0},d.containerPosition={left:0,top:0},d.parentData={element:a(document),left:0,top:0,width:a(document).width(),height:a(document).height()||document.body.parentNode.scrollHeight};else{var e=a(f),b=[];a(["Top","Right","Left","Bottom"]).each(function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            d){b[a]=c(e.css("padding"+d))});d.containerOffset=e.offset();d.containerPosition=e.position();d.containerSize={height:e.innerHeight()-b[3],width:e.innerWidth()-b[1]};var h=d.containerOffset,j=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(f,"left")?f.scrollWidth:l,j=a.ui.hasScroll(f)?f.scrollHeight:j;d.parentData={element:f,left:h.left,top:h.top,width:l,height:j}}},resize:function(c){var d=a(this).data("resizable"),h=d.options,e=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
        j={top:0,left:0},l=d.containerElement;l[0]!=document&&/static/.test(l.css("position"))&&(j=e);if(b.left<(d._helper?e.left:0))d.size.width+=d._helper?d.position.left-e.left:d.position.left-j.left,c&&(d.size.height=d.size.width/d.aspectRatio),d.position.left=h.helper?e.left:0;if(b.top<(d._helper?e.top:0))d.size.height+=d._helper?d.position.top-e.top:d.position.top,c&&(d.size.width=d.size.height*d.aspectRatio),d.position.top=d._helper?e.top:0;d.offset.left=d.parentData.left+d.position.left;d.offset.top=
        d.parentData.top+d.position.top;h=Math.abs(d.offset.left-j.left+d.sizeDiff.width);e=Math.abs((d._helper?d.offset.top-j.top:d.offset.top-e.top)+d.sizeDiff.height);b=d.containerElement.get(0)==d.element.parent().get(0);j=/relative|absolute/.test(d.containerElement.css("position"));b&&j&&(h-=d.parentData.left);h+d.size.width>=d.parentData.width&&(d.size.width=d.parentData.width-h,c&&(d.size.height=d.size.width/d.aspectRatio));e+d.size.height>=d.parentData.height&&(d.size.height=d.parentData.height-e,
        c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,h=c.containerOffset,e=c.containerPosition,b=c.containerElement,j=a(c.helper),l=j.offset(),o=j.outerWidth()-c.sizeDiff.width,j=j.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-e.left-h.left,width:o,height:j});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-e.left-h.left,width:o,height:j})}});
    a.ui.plugin.add("resizable","ghost",{start:function(){var c=a(this).data("resizable"),d=c.options,h=c.size;c.ghost=c.originalElement.clone();c.ghost.css({opacity:0.25,display:"block",position:"relative",height:h.height,width:h.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof d.ghost?d.ghost:"");c.ghost.appendTo(c.helper)},resize:function(){var c=a(this).data("resizable");c.ghost&&c.ghost.css({position:"relative",height:c.size.height,width:c.size.width})},stop:function(){var c=
        a(this).data("resizable");c.ghost&&c.helper&&c.helper.get(0).removeChild(c.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var c=a(this).data("resizable"),d=c.options,h=c.size,e=c.originalSize,b=c.originalPosition,j=c.axis;d.grid="number"==typeof d.grid?[d.grid,d.grid]:d.grid;var l=Math.round((h.width-e.width)/(d.grid[0]||1))*(d.grid[0]||1),d=Math.round((h.height-e.height)/(d.grid[1]||1))*(d.grid[1]||1);/^(se|s|e)$/.test(j)?(c.size.width=e.width+l,c.size.height=e.height+d):
        /^(ne)$/.test(j)?(c.size.width=e.width+l,c.size.height=e.height+d,c.position.top=b.top-d):(/^(sw)$/.test(j)?(c.size.width=e.width+l,c.size.height=e.height+d):(c.size.width=e.width+l,c.size.height=e.height+d,c.position.top=b.top-d),c.position.left=b.left-l)}});var c=function(a){return parseInt(a,10)||0},d=function(a){return!isNaN(parseInt(a,10))}})(w);(function(a){a.widget("ui.selectable",a.ui.mouse,{options:{appendTo:"body",autoRefresh:!0,distance:0,filter:"*",tolerance:"touch"},_create:function(){var c=
    ...
    this._mouseInit();this.helper=a("<div class='ui-selectable-helper'></div>")},destroy:function(){this.selectees.removeClass("ui-selectee").removeData("selectable-item");this.element.removeClass("ui-selectable ui-selectable-disabled").removeData("selectable").unbind(".selectable");this._mouseDestroy();return this},_mouseStart:function(c){var d=this;this.opos=[c.pageX,c.pageY];if(!this.options.disabled){var g=this.options;this.selectees=a(g.filter,this.element[0]);this._trigger("start",c);a(g.appendTo).append(this.helper);
    this.helper.css({left:c.clientX,top:c.clientY,width:0,height:0});g.autoRefresh&&this.refresh();this.selectees.filter(".ui-selected").each(function(){var f=a.data(this,"selectable-item");f.startselected=!0;!c.metaKey&&!c.ctrlKey&&(f.$element.removeClass("ui-selected"),f.selected=!1,f.$element.addClass("ui-unselecting"),f.unselecting=!0,d._trigger("unselecting",c,{unselecting:f.element}))});a(c.target).parents().andSelf().each(function(){var f=a.data(this,"selectable-item");if(f){var g=!c.metaKey&&
        !c.ctrlKey||!f.$element.hasClass("ui-selected");f.$element.removeClass(g?"ui-unselecting":"ui-selected").addClass(g?"ui-selecting":"ui-unselecting");f.unselecting=!g;f.selecting=g;(f.selected=g)?d._trigger("selecting",c,{selecting:f.element}):d._trigger("unselecting",c,{unselecting:f.element});return!1}})}},_mouseDrag:function(c){var d=this;this.dragged=!0;if(!this.options.disabled){var g=this.options,f=this.opos[0],h=this.opos[1],e=c.pageX,b=c.pageY;if(f>e)var j=e,e=f,f=j;h>b&&(j=b,b=h,h=j);this.helper.css({left:f,
    top:h,width:e-f,height:b-h});this.selectees.each(function(){var j=a.data(this,"selectable-item");if(j&&j.element!=d.element[0]){var o=false;g.tolerance=="touch"?o=!(j.left>e||j.right<f||j.top>b||j.bottom<h):g.tolerance=="fit"&&(o=j.left>f&&j.right<e&&j.top>h&&j.bottom<b);if(o){if(j.selected){j.$element.removeClass("ui-selected");j.selected=false}if(j.unselecting){j.$element.removeClass("ui-unselecting");j.unselecting=false}if(!j.selecting){j.$element.addClass("ui-selecting");j.selecting=true;d._trigger("selecting",
    c,{selecting:j.element})}}else{if(j.selecting)if((c.metaKey||c.ctrlKey)&&j.startselected){j.$element.removeClass("ui-selecting");j.selecting=false;j.$element.addClass("ui-selected");j.selected=true}else{j.$element.removeClass("ui-selecting");j.selecting=false;if(j.startselected){j.$element.addClass("ui-unselecting");j.unselecting=true}d._trigger("unselecting",c,{unselecting:j.element})}if(j.selected&&!c.metaKey&&!c.ctrlKey&&!j.startselected){j.$element.removeClass("ui-selected");j.selected=false;
    j.$element.addClass("ui-unselecting");j.unselecting=true;d._trigger("unselecting",c,{unselecting:j.element})}}}});return!1}},_mouseStop:function(c){var d=this;this.dragged=!1;a(".ui-unselecting",this.element[0]).each(function(){var g=a.data(this,"selectable-item");g.$element.removeClass("ui-unselecting");g.unselecting=!1;g.startselected=!1;d._trigger("unselected",c,{unselected:g.element})});a(".ui-selecting",this.element[0]).each(function(){var g=a.data(this,"selectable-item");g.$element.removeClass("ui-selecting").addClass("ui-selected");
    g.selecting=!1;g.selected=!0;g.startselected=!0;d._trigger("selected",c,{selected:g.element})});this._trigger("stop",c);this.helper.remove();return!1}});a.extend(a.ui.selectable,{version:"1.8.20"})})(w);(function(a){a.widget("ui.sortable",a.ui.mouse,{widgetEventPrefix:"sort",ready:!1,options:{appendTo:"parent",axis:!1,connectWith:!1,containment:!1,cursor:"auto",cursorAt:!1,dropOnEmpty:!0,forcePlaceholderSize:!1,forceHelperSize:!1,grid:!1,handle:!1,helper:"original",items:"> *",opacity:!1,placeholder:!1,
    ...
    (a.ui.ddmanager.current=this);a.ui.ddmanager&&!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c);this.dragging=!0;this.helper.addClass("ui-sortable-helper");this._mouseDrag(c);return!0},_mouseDrag:function(c){this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);if(this.options.scroll){var d=this.options,g=!1;this.scrollParent[0]!=document&&"HTML"!=this.scrollParent[0].tagName?(this.overflowOffset.top+
    this.scrollParent[0].offsetHeight-c.pageY<d.scrollSensitivity?this.scrollParent[0].scrollTop=g=this.scrollParent[0].scrollTop+d.scrollSpeed:c.pageY-this.overflowOffset.top<d.scrollSensitivity&&(this.scrollParent[0].scrollTop=g=this.scrollParent[0].scrollTop-d.scrollSpeed),this.overflowOffset.left+this.scrollParent[0].offsetWidth-c.pageX<d.scrollSensitivity)?this.scrollParent[0].scrollLeft=g=this.scrollParent[0].scrollLeft+d.scrollSpeed:c.pageX-this.overflowOffset.left<d.scrollSensitivity&&(this.scrollParent[0].scrollLeft=
    g=this.scrollParent[0].scrollLeft-d.scrollSpeed):(c.pageY-a(document).scrollTop()<d.scrollSensitivity?g=a(document).scrollTop(a(document).scrollTop()-d.scrollSpeed):a(m).height()-(c.pageY-a(document).scrollTop())<d.scrollSensitivity&&(g=a(document).scrollTop(a(document).scrollTop()+d.scrollSpeed)),c.pageX-a(document).scrollLeft()<d.scrollSensitivity?g=a(document).scrollLeft(a(document).scrollLeft()-d.scrollSpeed):a(m).width()-(c.pageX-a(document).scrollLeft())<d.scrollSensitivity&&(g=a(document).scrollLeft(a(document).scrollLeft()+
    d.scrollSpeed)));!1!==g&&a.ui.ddmanager&&!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c)}this.positionAbs=this._convertPositionTo("absolute");if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";for(d=this.items.length-1;0<=d;d--){var g=this.items[d],f=g.item[0],h=this._intersectsWithPointer(g);if(h&&f!=this.currentItem[0]&&this.placeholder[1==h?"next":"prev"]()[0]!=
    f&&!a.ui.contains(this.placeholder[0],f)&&("semi-dynamic"==this.options.type?!a.ui.contains(this.element[0],f):1)){this.direction=1==h?"down":"up";if("pointer"==this.options.tolerance||this._intersectsWithSides(g))this._rearrange(c,g);else break;this._trigger("change",c,this._uiHash());break}}this._contactContainers(c);a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);this._trigger("sort",c,this._uiHash());this.lastPositionAbs=this.positionAbs;return!1},_mouseStop:function(c,d){if(c){a.ui.ddmanager&&!this.options.dropBehaviour&&
a.ui.ddmanager.drop(this,c);if(this.options.revert){var g=this,f=g.placeholder.offset();g.reverting=!0;a(this.helper).animate({left:f.left-this.offset.parent.left-g.margins.left+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollLeft),top:f.top-this.offset.parent.top-g.margins.top+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollTop)},parseInt(this.options.revert,10)||500,function(){g._clear(c)})}else this._clear(c,d);return!1}},cancel:function(){if(this.dragging){this._mouseUp({target:null});
    ...
    this.options.helper&&this.helper&&this.helper[0].parentNode&&this.helper.remove(),a.extend(this,{helper:null,dragging:!1,reverting:!1,_noFinalSort:null}),this.domPosition.prev?a(this.domPosition.prev).after(this.currentItem):a(this.domPosition.parent).prepend(this.currentItem));return this},serialize:function(c){var d=this._getItemsAsjQuery(c&&c.connected),g=[],c=c||{};a(d).each(function(){var d=(a(c.item||this).attr(c.attribute||"id")||"").match(c.expression||/(.+)[-=_](.+)/);d&&g.push((c.key||d[1]+
    "[]")+"="+(c.key&&c.expression?d[1]:d[2]))});!g.length&&c.key&&g.push(c.key+"=");return g.join("&")},toArray:function(c){var d=this._getItemsAsjQuery(c&&c.connected),g=[],c=c||{};d.each(function(){g.push(a(c.item||this).attr(c.attribute||"id")||"")});return g},_intersectsWith:function(a){var d=this.positionAbs.left,g=d+this.helperProportions.width,f=this.positionAbs.top,h=f+this.helperProportions.height,e=a.left,b=e+a.width,j=a.top,l=j+a.height,o=this.offset.click.top,n=this.offset.click.left;return"pointer"==
    this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?f+o>j&&f+o<l&&d+n>e&&d+n<b:e<d+this.helperProportions.width/2&&g-this.helperProportions.width/2<b&&j<f+this.helperProportions.height/2&&h-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),
    c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),g=this._getDragHorizontalDirection();return!d?!1:this.floating?g&&"right"==g||"down"==c?2:1:c&&("down"==c?2:1)},_intersectsWithSides:function(c){var d=a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top+c.height/2,c.height),c=a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left+c.width/2,c.width),g=this._getDragVerticalDirection(),
    f=this._getDragHorizontalDirection();return this.floating&&f?"right"==f&&c||"left"==f&&!c:g&&("down"==g&&d||"up"==g&&!d)},_getDragVerticalDirection:function(){var a=this.positionAbs.top-this.lastPositionAbs.top;return 0!=a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return 0!=a&&(0<a?"right":"left")},refresh:function(a){this._refreshItems(a);this.refreshPositions();return this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==
    String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(c){var d=[],g=[],f=this._connectWith();if(f&&c)for(c=f.length-1;0<=c;c--)for(var h=a(f[c]),e=h.length-1;0<=e;e--){var b=a.data(h[e],this.widgetName);b&&b!=this&&!b.options.disabled&&g.push([a.isFunction(b.options.items)?b.options.items.call(b.element):a(b.options.items,b.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),b])}g.push([a.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,
    item:this.currentItem}):a(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);for(c=g.length-1;0<=c;c--)g[c][0].each(function(){d.push(this)});return a(d)},_removeCurrentsFromItems:function(){for(var a=this.currentItem.find(":data("+this.widgetName+"-item)"),d=0;d<this.items.length;d++)for(var g=0;g<a.length;g++)a[g]==this.items[d].item[0]&&this.items.splice(d,1)},_refreshItems:function(c){this.items=[];this.containers=[this];var d=this.items,g=[[a.isFunction(this.options.items)?
    this.options.items.call(this.element[0],c,{item:this.currentItem}):a(this.options.items,this.element),this]],f=this._connectWith();if(f&&this.ready)for(var h=f.length-1;0<=h;h--)for(var e=a(f[h]),b=e.length-1;0<=b;b--){var j=a.data(e[b],this.widgetName);j&&j!=this&&!j.options.disabled&&(g.push([a.isFunction(j.options.items)?j.options.items.call(j.element[0],c,{item:this.currentItem}):a(j.options.items,j.element),j]),this.containers.push(j))}for(h=g.length-1;0<=h;h--){c=g[h][1];f=g[h][0];b=0;for(e=
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            f.length;b<e;b++)j=a(f[b]),j.data(this.widgetName+"-item",c),d.push({item:j,instance:c,width:0,height:0,left:0,top:0})}},refreshPositions:function(c){this.offsetParent&&this.helper&&(this.offset.parent=this._getParentOffset());for(var d=this.items.length-1;0<=d;d--){var g=this.items[d];if(!(g.instance!=this.currentContainer&&this.currentContainer&&g.item[0]!=this.currentItem[0])){var f=this.options.toleranceElement?a(this.options.toleranceElement,g.item):g.item;c||(g.width=f.outerWidth(),g.height=
    f.outerHeight());f=f.offset();g.left=f.left;g.top=f.top}}if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);else for(d=this.containers.length-1;0<=d;d--)f=this.containers[d].element.offset(),this.containers[d].containerCache.left=f.left,this.containers[d].containerCache.top=f.top,this.containers[d].containerCache.width=this.containers[d].element.outerWidth(),this.containers[d].containerCache.height=this.containers[d].element.outerHeight();
    return this},_createPlaceholder:function(c){var d=c||this,g=d.options;if(!g.placeholder||g.placeholder.constructor==String){var f=g.placeholder;g.placeholder={element:function(){var c=a(document.createElement(d.currentItem[0].nodeName)).addClass(f||d.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];f||(c.style.visibility="hidden");return c},update:function(a,c){if(!f||g.forcePlaceholderSize)c.height()||c.height(d.currentItem.innerHeight()-parseInt(d.currentItem.css("paddingTop")||
    0,10)-parseInt(d.currentItem.css("paddingBottom")||0,10)),c.width()||c.width(d.currentItem.innerWidth()-parseInt(d.currentItem.css("paddingLeft")||0,10)-parseInt(d.currentItem.css("paddingRight")||0,10))}}}d.placeholder=a(g.placeholder.element.call(d.element,d.currentItem));d.currentItem.after(d.placeholder);g.placeholder.update(d,d.placeholder)},_contactContainers:function(c){for(var d=null,g=null,f=this.containers.length-1;0<=f;f--)if(!a.ui.contains(this.currentItem[0],this.containers[f].element[0]))if(this._intersectsWith(this.containers[f].containerCache)){if(!d||
    !a.ui.contains(this.containers[f].element[0],d.element[0]))d=this.containers[f],g=f}else this.containers[f].containerCache.over&&(this.containers[f]._trigger("out",c,this._uiHash(this)),this.containers[f].containerCache.over=0);if(d)if(1===this.containers.length)this.containers[g]._trigger("over",c,this._uiHash(this)),this.containers[g].containerCache.over=1;else if(this.currentContainer!=this.containers[g]){for(var d=1E4,f=null,h=this.positionAbs[this.containers[g].floating?"left":"top"],e=this.items.length-
    1;0<=e;e--)if(a.ui.contains(this.containers[g].element[0],this.items[e].item[0])){var b=this.items[e][this.containers[g].floating?"left":"top"];Math.abs(b-h)<d&&(d=Math.abs(b-h),f=this.items[e])}if(f||this.options.dropOnEmpty)this.currentContainer=this.containers[g],f?this._rearrange(c,f,null,!0):this._rearrange(c,null,this.containers[g].element,!0),this._trigger("change",c,this._uiHash()),this.containers[g]._trigger("change",c,this._uiHash(this)),this.options.placeholder.update(this.currentContainer,
    this.placeholder),this.containers[g]._trigger("over",c,this._uiHash(this)),this.containers[g].containerCache.over=1}},_createHelper:function(c){var d=this.options,c=a.isFunction(d.helper)?a(d.helper.apply(this.element[0],[c,this.currentItem])):"clone"==d.helper?this.currentItem.clone():this.currentItem;c.parents("body").length||a("parent"!=d.appendTo?d.appendTo:this.currentItem[0].parentNode)[0].appendChild(c[0]);c[0]==this.currentItem[0]&&(this._storedCSS={width:this.currentItem[0].style.width,height:this.currentItem[0].style.height,
    ...
    [0-this.offset.relative.left-this.offset.parent.left,0-this.offset.relative.top-this.offset.parent.top,a("document"==c.containment?document:m).width()-this.helperProportions.width-this.margins.left,(a("document"==c.containment?document:m).height()||document.body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top];if(!/^(document|window|parent)$/.test(c.containment)){var d=a(c.containment)[0],c=a(c.containment).offset(),g="hidden"!=a(d).css("overflow");this.containment=[c.left+
    (parseInt(a(d).css("borderLeftWidth"),10)||0)+(parseInt(a(d).css("paddingLeft"),10)||0)-this.margins.left,c.top+(parseInt(a(d).css("borderTopWidth"),10)||0)+(parseInt(a(d).css("paddingTop"),10)||0)-this.margins.top,c.left+(g?Math.max(d.scrollWidth,d.offsetWidth):d.offsetWidth)-(parseInt(a(d).css("borderLeftWidth"),10)||0)-(parseInt(a(d).css("paddingRight"),10)||0)-this.helperProportions.width-this.margins.left,c.top+(g?Math.max(d.scrollHeight,d.offsetHeight):d.offsetHeight)-(parseInt(a(d).css("borderTopWidth"),
    10)||0)-(parseInt(a(d).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top]}},_convertPositionTo:function(c,d){d||(d=this.position);var g="absolute"==c?1:-1,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,h=/(html|body)/i.test(f[0].tagName);return{top:d.top+this.offset.relative.top*g+this.offset.parent.top*g-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==
    this.cssPosition?-this.scrollParent.scrollTop():h?0:f.scrollTop())*g),left:d.left+this.offset.relative.left*g+this.offset.parent.left*g-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():h?0:f.scrollLeft())*g)}},_generatePosition:function(c){var d=this.options,g="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(g[0].tagName);
    "relative"==this.cssPosition&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=this.offsetParent[0])&&(this.offset.relative=this._getRelativeOffset());var h=c.pageX,e=c.pageY;if(this.originalPosition&&(this.containment&&(c.pageX-this.offset.click.left<this.containment[0]&&(h=this.containment[0]+this.offset.click.left),c.pageY-this.offset.click.top<this.containment[1]&&(e=this.containment[1]+this.offset.click.top),c.pageX-this.offset.click.left>this.containment[2]&&(h=this.containment[2]+this.offset.click.left),
        c.pageY-this.offset.click.top>this.containment[3]&&(e=this.containment[3]+this.offset.click.top)),d.grid))e=this.originalPageY+Math.round((e-this.originalPageY)/d.grid[1])*d.grid[1],e=this.containment?!(e-this.offset.click.top<this.containment[1]||e-this.offset.click.top>this.containment[3])?e:!(e-this.offset.click.top<this.containment[1])?e-d.grid[1]:e+d.grid[1]:e,h=this.originalPageX+Math.round((h-this.originalPageX)/d.grid[0])*d.grid[0],h=this.containment?!(h-this.offset.click.left<this.containment[0]||
        ...
        f?0:g.scrollLeft())}},_rearrange:function(a,d,g,f){g?g[0].appendChild(this.placeholder[0]):d.item[0].parentNode.insertBefore(this.placeholder[0],"down"==this.direction?d.item[0]:d.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var h=this,e=this.counter;m.setTimeout(function(){e==h.counter&&h.refreshPositions(!f)},0)},_clear:function(c,d){this.reverting=!1;var g=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;
    if(this.helper[0]==this.currentItem[0]){for(var f in this._storedCSS)if("auto"==this._storedCSS[f]||"static"==this._storedCSS[f])this._storedCSS[f]="";this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!d&&g.push(function(a){this._trigger("receive",a,this._uiHash(this.fromOutside))});(this.fromOutside||this.domPosition.prev!=this.currentItem.prev().not(".ui-sortable-helper")[0]||this.domPosition.parent!=this.currentItem.parent()[0])&&
        !d&&g.push(function(a){this._trigger("update",a,this._uiHash())});if(!a.ui.contains(this.element[0],this.currentItem[0])){d||g.push(function(a){this._trigger("remove",a,this._uiHash())});for(f=this.containers.length-1;0<=f;f--)a.ui.contains(this.containers[f].element[0],this.currentItem[0])&&!d&&(g.push(function(a){return function(c){a._trigger("receive",c,this._uiHash(this))}}.call(this,this.containers[f])),g.push(function(a){return function(c){a._trigger("update",c,this._uiHash(this))}}.call(this,
        this.containers[f])))}for(f=this.containers.length-1;0<=f;f--)d||g.push(function(a){return function(c){a._trigger("deactivate",c,this._uiHash(this))}}.call(this,this.containers[f])),this.containers[f].containerCache.over&&(g.push(function(a){return function(c){a._trigger("out",c,this._uiHash(this))}}.call(this,this.containers[f])),this.containers[f].containerCache.over=0);this._storedCursor&&a("body").css("cursor",this._storedCursor);this._storedOpacity&&this.helper.css("opacity",this._storedOpacity);
    this._storedZIndex&&this.helper.css("zIndex","auto"==this._storedZIndex?"":this._storedZIndex);this.dragging=!1;if(this.cancelHelperRemoval){if(!d){this._trigger("beforeStop",c,this._uiHash());for(f=0;f<g.length;f++)g[f].call(this,c);this._trigger("stop",c,this._uiHash())}return!1}d||this._trigger("beforeStop",c,this._uiHash());this.placeholder[0].parentNode.removeChild(this.placeholder[0]);this.helper[0]!=this.currentItem[0]&&this.helper.remove();this.helper=null;if(!d){for(f=0;f<g.length;f++)g[f].call(this,
    ...
    true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var j={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,
    183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,
    165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],o={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,e){a.isFunction(d)&&(e=d,d=null);return this.queue(function(){var j=a(this),o=j.attr("style")||" ",m=f(g.call(this)),F,E=j.attr("class")||"";a.each(l,function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            c){if(b[c])j[c+"Class"](b[c])});F=f(g.call(this));j.attr("class",E);j.animate(h(m,F),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);e&&e.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,[{add:b},c,d,e]):this._addClass(b)},_removeClass:a.fn.removeClass,
...
(g=1.70158);return e*(b/=f)*b*((g+1)*b-g)+d},easeOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return e*((b=b/f-1)*b*((g+1)*b+g)+1)+d},easeInOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return 1>(b/=f/2)?e/2*b*b*(((g*=1.525)+1)*b-g)+d:e/2*((b-=2)*b*(((g*=1.525)+1)*b+g)+2)+d},easeInBounce:function(b,c,d,e,f){return e-a.easing.easeOutBounce(b,f-c,0,e,f)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=1.5/2.75)*b+0.75)+c:b<2.5/2.75?d*(7.5625*(b-=2.25/
    2.75)*b+0.9375)+c:d*(7.5625*(b-=2.625/2.75)*b+0.984375)+c},easeInOutBounce:function(b,c,d,e,f){return c<f/2?0.5*a.easing.easeInBounce(b,2*c,0,e,f)+d:0.5*a.easing.easeOutBounce(b,2*c-f,0,e,f)+0.5*e+d}})}(w);(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),g=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.direction||"vertical";a.effects.save(d,g);d.show();var e=a.effects.createWrapper(d).css({overflow:"hidden"}),
    b="vertical"==h?"height":"width",h="vertical"==h?e.height():e.width();"show"==f&&e.css(b,0);var j={};j[b]="show"==f?h:0;e.animate(j,c.duration,c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(w);(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),g=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"effect"),h=c.options.direction||
    "up",e=c.options.distance||20,b=c.options.times||5,j=c.duration||250;/show|hide/.test(f)&&g.push("opacity");a.effects.save(d,g);d.show();a.effects.createWrapper(d);var l="up"==h||"down"==h?"top":"left",h="up"==h||"left"==h?"pos":"neg",e=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/3);"show"==f&&d.css("opacity",0).css(l,"pos"==h?-e:e);"hide"==f&&(e/=2*b);"hide"!=f&&b--;if("show"==f){var o={opacity:1};o[l]=("pos"==h?"+=":"-=")+e;d.animate(o,j/2,c.options.easing);
    e/=2;b--}for(o=0;o<b;o++){var n={},p={};n[l]=("pos"==h?"-=":"+=")+e;p[l]=("pos"==h?"+=":"-=")+e;d.animate(n,j/2,c.options.easing).animate(p,j/2,c.options.easing);e="hide"==f?2*e:e/2}"hide"==f?(o={opacity:0},o[l]=("pos"==h?"-=":"+=")+e,d.animate(o,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)})):(n={},p={},n[l]=("pos"==h?"-=":"+=")+e,p[l]=("pos"==h?"+=":"-=")+e,d.animate(n,j/2,c.options.easing).animate(p,j/2,
    c.options.easing,function(){a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(w);(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),g="position,top,bottom,left,right,height,width".split(","),f=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.direction||"vertical";a.effects.save(d,g);d.show();var e=a.effects.createWrapper(d).css({overflow:"hidden"}),e="IMG"==
    d[0].tagName?e:d,b="vertical"==h?"height":"width",j="vertical"==h?"top":"left",h="vertical"==h?e.height():e.width();"show"==f&&(e.css(b,0),e.css(j,h/2));var l={};l[b]="show"==f?h:0;l[j]="show"==f?0:h/2;e.animate(l,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){f=="hide"&&d.hide();a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()}})})}})(w);(function(a){a.effects.drop=function(c){return this.queue(function(){var d=
    a(this),g="position,top,bottom,left,right,opacity".split(","),f=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.direction||"left";a.effects.save(d,g);d.show();a.effects.createWrapper(d);var e="up"==h||"down"==h?"top":"left",h="up"==h||"left"==h?"pos":"neg",b=c.options.distance||("top"==e?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==f&&d.css("opacity",0).css(e,"pos"==h?-b:b);var j={opacity:"show"==f?1:0};j[e]=("show"==f?"pos"==h?"+=":"-=":"pos"==h?"-=":"+=")+b;d.animate(j,
    {queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==f&&d.hide();a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,g=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;
    var f=a(this).show().css("visibility","hidden"),h=f.offset();h.top-=parseInt(f.css("marginTop"),10)||0;h.left-=parseInt(f.css("marginLeft"),10)||0;for(var e=f.outerWidth(!0),b=f.outerHeight(!0),j=0;j<d;j++)for(var l=0;l<g;l++)f.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(e/g),top:-j*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:e/g,height:b/d,left:h.left+l*(e/g)+("show"==c.options.mode?(l-Math.floor(g/
        2))*(e/g):0),top:h.top+j*(b/d)+("show"==c.options.mode?(j-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:h.left+l*(e/g)+("show"==c.options.mode?0:(l-Math.floor(g/2))*(e/g)),top:h.top+j*(b/d)+("show"==c.options.mode?0:(j-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?f.css({visibility:"visible"}):f.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(f[0]);f.dequeue();a("div.ui-effects-explode").remove()},
        c.duration||500)})}})(w);(function(a){a.effects.fade=function(c){return this.queue(function(){var d=a(this),g=a.effects.setMode(d,c.options.mode||"hide");d.animate({opacity:g},{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),g=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.size||
    15,e=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,g);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==f!=e,o=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],n=/([0-9]+)%/.exec(h);n&&(h=parseInt(n[1],10)/100*l["hide"==f?0:1]);"show"==f&&j.css(e?{height:0,width:h}:{height:h,width:0});e={};n={};e[o[0]]="show"==f?l[0]:h;n[o[1]]="show"==f?l[1]:0;j.animate(e,b,c.options.easing).animate(n,b,
    c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(w);(function(a){a.effects.highlight=function(c){return this.queue(function(){var d=a(this),g=["backgroundImage","backgroundColor","opacity"],f=a.effects.setMode(d,c.options.mode||"show"),h={backgroundColor:d.css("backgroundColor")};"hide"==f&&(h.opacity=0);a.effects.save(d,g);d.show().css({backgroundImage:"none",backgroundColor:c.options.color||
    "#ffff99"}).animate(h,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){f=="hide"&&d.hide();a.effects.restore(d,g);f=="show"&&!a.support.opacity&&this.style.removeAttribute("filter");c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.pulsate=function(c){return this.queue(function(){var d=a(this),g=a.effects.setMode(d,c.options.mode||"show"),f=2*(c.options.times||5)-1,h=c.duration?c.duration/2:a.fx.speeds._default/2,e=d.is(":visible"),
    b=0;e||(d.css("opacity",0).show(),b=1);("hide"==g&&e||"show"==g&&!e)&&f--;for(g=0;g<f;g++)d.animate({opacity:b},h,c.options.easing),b=(b+1)%2;d.animate({opacity:b},h,c.options.easing,function(){b==0&&d.hide();c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()}).dequeue()})}})(w);(function(a){a.effects.puff=function(c){return this.queue(function(){var d=a(this),g=a.effects.setMode(d,c.options.mode||"hide"),f=parseInt(c.options.percent,10)||150,h=f/100,e={height:d.height(),
    width:d.width()};a.extend(c.options,{fade:!0,mode:g,percent:"hide"==g?f:100,from:"hide"==g?e:{height:e.height*h,width:e.width*h}});d.effect("scale",c.options,c.duration,c.callback);d.dequeue()})};a.effects.scale=function(c){return this.queue(function(){var d=a(this),g=a.extend(!0,{},c.options),f=a.effects.setMode(d,c.options.mode||"effect"),h=parseInt(c.options.percent,10)||(0==parseInt(c.options.percent,10)?0:"hide"==f?0:100),e=c.options.direction||"both",b=c.options.origin;"effect"!=f&&(g.origin=
    b||["middle","center"],g.restore=!0);b={height:d.height(),width:d.width()};d.from=c.options.from||("show"==f?{height:0,width:0}:b);d.to={height:b.height*("horizontal"!=e?h/100:1),width:b.width*("vertical"!=e?h/100:1)};if(c.options.fade&&("show"==f&&(d.from.opacity=0,d.to.opacity=1),"hide"==f))d.from.opacity=1,d.to.opacity=0;g.from=d.from;g.to=d.to;g.mode=f;d.effect("size",g,c.duration,c.callback);d.dequeue()})};a.effects.size=function(c){return this.queue(function(){var d=a(this),g="position,top,bottom,left,right,width,height,overflow,opacity".split(","),
    f="position,top,bottom,left,right,overflow,opacity".split(","),h=["width","height","overflow"],e=["fontSize"],b=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],j=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.effects.setMode(d,c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",p=c.options.origin,q={height:d.height(),width:d.width()};d.from=c.options.from||q;d.to=c.options.to||q;p&&(p=a.effects.getBaseline(p,q),d.from.top=(q.height-
    d.from.height)*p.y,d.from.left=(q.width-d.from.width)*p.x,d.to.top=(q.height-d.to.height)*p.y,d.to.left=(q.width-d.to.width)*p.x);var m=d.from.height/q.height,x=d.from.width/q.width,r=d.to.height/q.height,D=d.to.width/q.width;if("box"==n||"both"==n)if(m!=r&&(g=g.concat(b),d.from=a.effects.setTransition(d,b,m,d.from),d.to=a.effects.setTransition(d,b,r,d.to)),x!=D)g=g.concat(j),d.from=a.effects.setTransition(d,j,x,d.from),d.to=a.effects.setTransition(d,j,D,d.to);if(("content"==n||"both"==n)&&m!=r)g=
    g.concat(e),d.from=a.effects.setTransition(d,e,m,d.from),d.to=a.effects.setTransition(d,e,r,d.to);a.effects.save(d,o?g:f);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(e),j=j.concat(["marginLeft","marginRight"]),h=g.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,h);var e=d.height(),f=d.width();d.from={height:e*m,width:f*x};d.to={height:e*r,width:f*D};if(m!=
    r){d.from=a.effects.setTransition(d,b,m,d.from);d.to=a.effects.setTransition(d,b,r,d.to)}if(x!=D){d.from=a.effects.setTransition(d,j,x,d.from);d.to=a.effects.setTransition(d,j,D,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,h)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,o?g:f);a.effects.removeWrapper(d);c.callback&&
c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),g=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var f=c.options.direction||"left",h=c.options.distance||20,e=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,g);d.show();a.effects.createWrapper(d);var j="up"==f||"down"==f?"top":"left",l="up"==f||"left"==f?"pos":"neg",f={},o={},n={};f[j]=("pos"==
    l?"-=":"+=")+h;o[j]=("pos"==l?"+=":"-=")+2*h;n[j]=("pos"==l?"-=":"+=")+2*h;d.animate(f,b,c.options.easing);for(h=1;h<e;h++)d.animate(o,b,c.options.easing).animate(n,b,c.options.easing);d.animate(o,b,c.options.easing).animate(f,b/2,c.options.easing,function(){a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(w);(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),g=["position",
    "top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"show"),h=c.options.direction||"left";a.effects.save(d,g);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var e="up"==h||"down"==h?"top":"left",h="up"==h||"left"==h?"pos":"neg",b=c.options.distance||("top"==e?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==f&&d.css(e,"pos"==h?isNaN(b)?"-"+b:-b:b);var j={};j[e]=("show"==f?"pos"==h?"+=":"-=":"pos"==h?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,
    easing:c.options.easing,complete:function(){"hide"==f&&d.hide();a.effects.restore(d,g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.transfer=function(c){return this.queue(function(){var d=a(this),g=a(c.options.to),f=g.offset(),g={top:f.top,left:f.left,height:g.innerHeight(),width:g.innerWidth()},f=d.offset(),h=a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({top:f.top,left:f.left,
    height:d.innerHeight(),width:d.innerWidth(),position:"absolute"}).animate(g,c.duration,c.options.easing,function(){h.remove();c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(w);(function(a){a.widget("ui.accordion",{options:{active:0,animated:"slide",autoHeight:!0,clearStyle:!1,collapsible:!1,event:"click",fillSpace:!1,header:"> li > :first-child,> :not(li):even",icons:{header:"ui-icon-triangle-1-e",headerSelected:"ui-icon-triangle-1-s"},navigation:!1,navigationFilter:function(){return this.href.toLowerCase()===
    ...
    function(){d.disabled||a(this).addClass("ui-state-focus")}).bind("blur.accordion",function(){d.disabled||a(this).removeClass("ui-state-focus")});c.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom");if(d.navigation){var g=c.element.find("a").filter(d.navigationFilter).eq(0);if(g.length){var f=g.closest(".ui-accordion-header");c.active=f.length?f:g.closest(".ui-accordion-content").prev()}}c.active=c._findActive(c.active||d.active).addClass("ui-state-default ui-state-active").toggleClass("ui-corner-all").toggleClass("ui-corner-top");
    ...
    destroy:function(){var c=this.options;this.element.removeClass("ui-accordion ui-widget ui-helper-reset").removeAttr("role");this.headers.unbind(".accordion").removeClass("ui-accordion-header ui-accordion-disabled ui-helper-reset ui-state-default ui-corner-all ui-state-active ui-state-disabled ui-corner-top").removeAttr("role").removeAttr("aria-expanded").removeAttr("aria-selected").removeAttr("tabIndex");this.headers.find("a").removeAttr("tabIndex");this._destroyIcons();var d=this.headers.next().css("display",
        ...
        "removeClass"]("ui-accordion-disabled ui-state-disabled")},_keydown:function(c){if(!this.options.disabled&&!c.altKey&&!c.ctrlKey){var d=a.ui.keyCode,g=this.headers.length,f=this.headers.index(c.target),h=!1;switch(c.keyCode){case d.RIGHT:case d.DOWN:h=this.headers[(f+1)%g];break;case d.LEFT:case d.UP:h=this.headers[(f-1+g)%g];break;case d.SPACE:case d.ENTER:this._clickHandler({target:c.target},c.target),c.preventDefault()}return h?(a(c.target).attr("tabIndex",-1),a(h).attr("tabIndex",0),h.focus(),
        !1):!0}},resize:function(){var c=this.options,d;if(c.fillSpace){if(a.browser.msie){var g=this.element.parent().css("overflow");this.element.parent().css("overflow","hidden")}d=this.element.parent().height();a.browser.msie&&this.element.parent().css("overflow",g);this.headers.each(function(){d-=a(this).outerHeight(!0)});this.headers.next().each(function(){a(this).height(Math.max(0,d-a(this).innerHeight()+a(this).height()))}).css("overflow","auto")}else c.autoHeight&&(d=0,this.headers.next().each(function(){d=
        Math.max(d,a(this).height("").height())}).height(d));return this},activate:function(a){this.options.active=a;a=this._findActive(a)[0];this._clickHandler({target:a},a);return this},_findActive:function(c){return c?"number"===typeof c?this.headers.filter(":eq("+c+")"):this.headers.not(this.headers.not(c)):!1===c?a([]):this.headers.filter(":eq(0)")},_clickHandler:function(c,d){var g=this.options;if(!g.disabled)if(c.target){var f=a(c.currentTarget||d),h=f[0]===this.active[0];g.active=g.collapsible&&h?
        !1:this.headers.index(f);if(!(this.running||!g.collapsible&&h)){var e=this.active,b=f.next(),j=this.active.next(),l={options:g,newHeader:h&&g.collapsible?a([]):f,oldHeader:this.active,newContent:h&&g.collapsible?a([]):b,oldContent:j},o=this.headers.index(this.active[0])>this.headers.index(f[0]);this.active=h?a([]):f;this._toggle(b,j,l,h,o);e.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(g.icons.headerSelected).addClass(g.icons.header);
        ...
        l={options:g,newHeader:a([]),oldHeader:g.active,newContent:a([]),oldContent:j},b=this.active=a([]);this._toggle(b,j,l)}},_toggle:function(c,d,g,f,h){var e=this,b=e.options;e.toShow=c;e.toHide=d;e.data=g;var j=function(){return!e?void 0:e._completed.apply(e,arguments)};e._trigger("changestart",null,e.data);e.running=0===d.size()?c.size():d.size();if(b.animated){g={};g=b.collapsible&&f?{toShow:a([]),toHide:d,complete:j,down:h,autoHeight:b.autoHeight||b.fillSpace}:{toShow:c,toHide:d,complete:j,down:h,
        autoHeight:b.autoHeight||b.fillSpace};b.proxied||(b.proxied=b.animated);b.proxiedDuration||(b.proxiedDuration=b.duration);b.animated=a.isFunction(b.proxied)?b.proxied(g):b.proxied;b.duration=a.isFunction(b.proxiedDuration)?b.proxiedDuration(g):b.proxiedDuration;var f=a.ui.accordion.animations,l=b.duration,o=b.animated;o&&!f[o]&&!a.easing[o]&&(o="slide");f[o]||(f[o]=function(a){this.slide(a,{easing:o,duration:l||700})});f[o](g)}else b.collapsible&&f?c.toggle():(d.hide(),c.show()),j(!0);d.prev().attr({"aria-expanded":"false",
    ...
    animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var g=c.toShow.css("overflow"),f=0,h={},e={},b,j=c.toShow;b=j[0].style.width;j.width(j.parent().width()-parseFloat(j.css("paddingLeft"))-parseFloat(j.css("paddingRight"))-(parseFloat(j.css("borderLeftWidth"))||0)-(parseFloat(j.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){e[d]="hide";var f=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
        h[d]={value:f[1],unit:f[2]||"px"}});c.toShow.css({height:0,overflow:"hidden"}).show();c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(e,{step:function(a,b){"height"==b.prop&&(f=0===b.end-b.start?0:(b.now-b.start)/(b.end-b.start));c.toShow[0].style[b.prop]=f*h[b.prop].value+h[b.prop].unit},duration:c.duration,easing:c.easing,complete:function(){c.autoHeight||c.toShow.css("height","");c.toShow.css({width:b,overflow:g});c.complete()}})}else c.toHide.animate({height:"hide",
        paddingTop:"hide",paddingBottom:"hide"},c);else c.toShow.animate({height:"show",paddingTop:"show",paddingBottom:"show"},c)},bounceslide:function(a){this.slide(a,{easing:a.down?"easeOutBounce":"swing",duration:a.down?1E3:200})}}})})(w);(function(a){var c=0;a.widget("ui.autocomplete",{options:{appendTo:"body",autoFocus:!1,delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null},pending:0,_create:function(){var c=this,g=this.element[0].ownerDocument,f;this.isMultiLine=
    this.element.is("textarea");this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(g){if(!c.options.disabled&&!c.element.propAttr("readOnly")){f=!1;var e=a.ui.keyCode;switch(g.keyCode){case e.PAGE_UP:c._move("previousPage",g);break;case e.PAGE_DOWN:c._move("nextPage",g);break;case e.UP:c._keyEvent("previous",g);break;case e.DOWN:c._keyEvent("next",g);break;case e.ENTER:case e.NUMPAD_ENTER:c.menu.active&&
(f=!0,g.preventDefault());case e.TAB:if(!c.menu.active)break;c.menu.select(g);break;case e.ESCAPE:c.element.val(c.term);c.close(g);break;default:clearTimeout(c.searching),c.searching=setTimeout(function(){c.term!=c.element.val()&&(c.selectedItem=null,c.search(null,g))},c.options.delay)}}}).bind("keypress.autocomplete",function(a){f&&(f=!1,a.preventDefault())}).bind("focus.autocomplete",function(){c.options.disabled||(c.selectedItem=null,c.previous=c.element.val())}).bind("blur.autocomplete",function(a){c.options.disabled||
    (clearTimeout(c.searching),c.closing=setTimeout(function(){c.close(a);c._change(a)},150))});this._initSource();this.menu=a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo||"body",g)[0]).mousedown(function(f){var e=c.menu.element[0];a(f.target).closest(".ui-menu-item").length||setTimeout(function(){a(document).one("mousedown",function(b){b.target!==c.element[0]&&b.target!==e&&!a.ui.contains(e,b.target)&&c.close()})},1);setTimeout(function(){clearTimeout(c.closing)},13)}).menu({focus:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              e){var b=e.item.data("item.autocomplete");!1!==c._trigger("focus",a,{item:b})&&/^key/.test(a.originalEvent.type)&&c.element.val(b.value)},selected:function(a,e){var b=e.item.data("item.autocomplete"),f=c.previous;c.element[0]!==g.activeElement&&(c.element.focus(),c.previous=f,setTimeout(function(){c.previous=f;c.selectedItem=b},1));!1!==c._trigger("select",a,{item:b})&&c.element.val(b.value);c.term=c.element.val();c.close(a);c.selectedItem=b},blur:function(){c.menu.element.is(":visible")&&c.element.val()!==
    ...
    a.Widget.prototype.destroy.call(this)},_setOption:function(c,g){a.Widget.prototype._setOption.apply(this,arguments);"source"===c&&this._initSource();"appendTo"===c&&this.menu.element.appendTo(a(g||"body",this.element[0].ownerDocument)[0]);"disabled"===c&&g&&this.xhr&&this.xhr.abort()},_initSource:function(){var c=this,g,f;a.isArray(this.options.source)?(g=this.options.source,this.source=function(c,d){d(a.ui.autocomplete.filter(g,c.term))}):"string"===typeof this.options.source?(f=this.options.source,
    this.source=function(g,e){c.xhr&&c.xhr.abort();c.xhr=a.ajax({url:f,data:g,dataType:"json",success:function(a){e(a)},error:function(){e([])}})}):this.source=this.options.source},search:function(a,c){a=null!=a?a:this.element.val();this.term=this.element.val();if(a.length<this.options.minLength)return this.close(c);clearTimeout(this.closing);return!1===this._trigger("search",c)?void 0:this._search(a)},_search:function(a){this.pending++;this.element.addClass("ui-autocomplete-loading");this.source({term:a},
    this._response())},_response:function(){var a=this,g=++c;return function(f){g===c&&a.__response(f);a.pending--;a.pending||a.element.removeClass("ui-autocomplete-loading")}},__response:function(a){!this.options.disabled&&a&&a.length?(a=this._normalize(a),this._suggest(a),this._trigger("open")):this.close()},close:function(a){clearTimeout(this.closing);this.menu.element.is(":visible")&&(this.menu.element.hide(),this.menu.deactivate(),this._trigger("close",a))},_change:function(a){this.previous!==this.element.val()&&
this._trigger("change",a,{item:this.selectedItem})},_normalize:function(c){return c.length&&c[0].label&&c[0].value?c:a.map(c,function(c){return"string"===typeof c?{label:c,value:c}:a.extend({label:c.label||c.value,value:c.value||c.label},c)})},_suggest:function(c){var g=this.menu.element.empty().zIndex(this.element.zIndex()+1);this._renderMenu(g,c);this.menu.deactivate();this.menu.refresh();g.show();this._resizeMenu();g.position(a.extend({of:this.element},this.options.position));this.options.autoFocus&&
this.menu.next(new a.Event("mouseover"))},_resizeMenu:function(){var a=this.menu.element;a.outerWidth(Math.max(a.width("").outerWidth()+1,this.element.outerWidth()))},_renderMenu:function(c,g){var f=this;a.each(g,function(a,e){f._renderItem(c,e)})},_renderItem:function(c,g){return a("<li></li>").data("item.autocomplete",g).append(a("<a></a>").text(g.label)).appendTo(c)},_move:function(a,c){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(a)||this.menu.last()&&/^next/.test(a))this.element.val(this.term),
    this.menu.deactivate();else this.menu[a](c);else this.search(null,c)},widget:function(){return this.menu.element},_keyEvent:function(a,c){if(!this.isMultiLine||this.menu.element.is(":visible"))this._move(a,c),c.preventDefault()}});a.extend(a.ui.autocomplete,{escapeRegex:function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},filter:function(c,g){var f=RegExp(a.ui.autocomplete.escapeRegex(g),"i");return a.grep(c,function(a){return f.test(a.label||a.value||a)})}})})(w);(function(a){a.widget("ui.menu",
    {_create:function(){var c=this;this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({role:"listbox","aria-activedescendant":"ui-active-menuitem"}).click(function(d){a(d.target).closest(".ui-menu-item a").length&&(d.preventDefault(),c.select(d))});this.refresh()},refresh:function(){var c=this;this.element.children("li:not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role","menuitem").children("a").addClass("ui-corner-all").attr("tabindex",-1).mouseenter(function(d){c.activate(d,
        a(this).parent())}).mouseleave(function(){c.deactivate()})},activate:function(a,d){this.deactivate();if(this.hasScroll()){var g=d.offset().top-this.element.offset().top,f=this.element.scrollTop(),h=this.element.height();0>g?this.element.scrollTop(f+g):g>=h&&this.element.scrollTop(f+g-h+d.height())}this.active=d.eq(0).children("a").addClass("ui-state-hover").attr("id","ui-active-menuitem").end();this._trigger("focus",a,{item:d})},deactivate:function(){this.active&&(this.active.children("a").removeClass("ui-state-hover").removeAttr("id"),
        this._trigger("blur"),this.active=null)},next:function(a){this.move("next",".ui-menu-item:first",a)},previous:function(a){this.move("prev",".ui-menu-item:last",a)},first:function(){return this.active&&!this.active.prevAll(".ui-menu-item").length},last:function(){return this.active&&!this.active.nextAll(".ui-menu-item").length},move:function(a,d,g){this.active?(a=this.active[a+"All"](".ui-menu-item").eq(0),a.length?this.activate(g,a):this.activate(g,this.element.children(d))):this.activate(g,this.element.children(d))},
        nextPage:function(c){if(this.hasScroll())if(!this.active||this.last())this.activate(c,this.element.children(".ui-menu-item:first"));else{var d=this.active.offset().top,g=this.element.height(),f=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d-g+a(this).height();return 10>c&&-10<c});f.length||(f=this.element.children(".ui-menu-item:last"));this.activate(c,f)}else this.activate(c,this.element.children(".ui-menu-item").filter(!this.active||this.last()?":first":":last"))},
        previousPage:function(c){if(this.hasScroll())if(!this.active||this.first())this.activate(c,this.element.children(".ui-menu-item:last"));else{var d=this.active.offset().top,g=this.element.height(),f=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d+g-a(this).height();return 10>c&&-10<c});f.length||(f=this.element.children(".ui-menu-item:first"));this.activate(c,f)}else this.activate(c,this.element.children(".ui-menu-item").filter(!this.active||this.first()?":last":
            ":first"))},hasScroll:function(){return this.element.height()<this.element[a.fn.prop?"prop":"attr"]("scrollHeight")},select:function(a){this._trigger("selected",a,{item:this.active})}})})(w);(function(a){var c,d,g,f,h=function(){var b=a(this).find(":ui-button");setTimeout(function(){b.button("refresh")},1)},e=function(b){var c=b.name,d=b.form,e=a([]);c&&(e=d?a(d).find("[name='"+c+"']"):a("[name='"+c+"']",b.ownerDocument).filter(function(){return!this.form}));return e};a.widget("ui.button",{options:{disabled:null,
    text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset.button").bind("reset.button",h);"boolean"!==typeof this.options.disabled?this.options.disabled=!!this.element.propAttr("disabled"):this.element.propAttr("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var b=this,j=this.options,l="checkbox"===this.type||"radio"===this.type,o="ui-state-hover"+(!l?" ui-state-active":"");null===
    j.label&&(j.label=this.buttonElement.html());this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",function(){if(!j.disabled){a(this).addClass("ui-state-hover");this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){j.disabled||a(this).removeClass(o)}).bind("click.button",function(a){if(j.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",
    function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){f||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!j.disabled){f=false;d=a.pageX;g=a.pageY}}).bind("mouseup.button",function(a){if(!j.disabled&&(d!==a.pageX||g!==a.pageY))f=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||f)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):
    "radio"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||f)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=b.element[0];e(c).not(c).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown.button",function(){if(j.disabled)return false;a(this).addClass("ui-state-active");c=this;a(document).one("mouseup",function(){c=null})}).bind("mouseup.button",
        function(){if(j.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(b){if(j.disabled)return false;(b.keyCode==a.ui.keyCode.SPACE||b.keyCode==a.ui.keyCode.ENTER)&&a(this).addClass("ui-state-active")}).bind("keyup.button",function(){a(this).removeClass("ui-state-active")}),this.buttonElement.is("a")&&this.buttonElement.keyup(function(b){b.keyCode===a.ui.keyCode.SPACE&&a(this).click()}));this._setOption("disabled",j.disabled);this._resetButton()},_determineButtonType:function(){this.type=
    ...
    minDate:null,maxDate:null,duration:"fast",beforeShowDay:null,beforeShow:null,onSelect:null,onChangeMonthYear:null,onClose:null,numberOfMonths:1,showCurrentAtPos:0,stepMonths:1,stepBigMonths:12,altField:"",altFormat:"",constrainInput:!0,showButtonPanel:!1,autoSize:!1,disabled:!1};a.extend(this._defaults,this.regional[""]);this.dpDiv=g(a('<div id="'+this._mainDivId+'" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'))}function g(b){return b.bind("mouseout",
    function(b){b=a(b.target).closest("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a");b.length&&b.removeClass("ui-state-hover ui-datepicker-prev-hover ui-datepicker-next-hover")}).bind("mouseover",function(c){c=a(c.target).closest("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a");if(!a.datepicker._isDisabledDatepicker(e.inline?b.parent()[0]:e.input[0])&&c.length)c.parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
        c.addClass("ui-state-hover"),c.hasClass("ui-datepicker-prev")&&c.addClass("ui-datepicker-prev-hover"),c.hasClass("ui-datepicker-next")&&c.addClass("ui-datepicker-next-hover")})}function f(b,d){a.extend(b,d);for(var e in d)if(null==d[e]||d[e]==c)b[e]=d[e];return b}a.extend(a.ui,{datepicker:{version:"1.8.20"}});var h=(new Date).getTime(),e;a.extend(d.prototype,{markerClassName:"hasDatepicker",maxRows:4,log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},
    setDefaults:function(a){f(this._defaults,a||{});return this},_attachDatepicker:function(b,c){var d=null,e;for(e in this._defaults){var f=b.getAttribute("date:"+e);if(f){d=d||{};try{d[e]=eval(f)}catch(g){d[e]=f}}}e=b.nodeName.toLowerCase();f="div"==e||"span"==e;b.id||(this.uuid+=1,b.id="dp"+this.uuid);var h=this._newInst(a(b),f);h.settings=a.extend({},c||{},d||{});"input"==e?this._connectDatepicker(b,h):f&&this._inlineDatepicker(b,h)},_newInst:function(b,c){return{id:b[0].id.replace(/([^A-Za-z0-9_-])/g,
        ...
        c.dpDiv.css("display","block"))},_dialogDatepicker:function(b,c,d,e,g){b=this._dialogInst;b||(this.uuid+=1,this._dialogInput=a('<input type="text" id="dp'+this.uuid+'" style="position: absolute; top: -100px; width: 0px; z-index: -10;"/>'),this._dialogInput.keydown(this._doKeyDown),a("body").append(this._dialogInput),b=this._dialogInst=this._newInst(this._dialogInput,!1),b.settings={},a.data(this._dialogInput[0],"datepicker",b));f(b.settings,e||{});c=c&&c.constructor==Date?this._formatDate(b,c):c;
    ...
    _enableDatepicker:function(b){var c=a(b),d=a.data(b,"datepicker");if(c.hasClass(this.markerClassName)){var e=b.nodeName.toLowerCase();if("input"==e)b.disabled=!1,d.trigger.filter("button").each(function(){this.disabled=!1}).end().filter("img").css({opacity:"1.0",cursor:""});else if("div"==e||"span"==e)c=c.children("."+this._inlineClass),c.children().removeClass("ui-state-disabled"),c.find("select.ui-datepicker-month, select.ui-datepicker-year").removeAttr("disabled");this._disabledInputs=a.map(this._disabledInputs,
        ...
        "disabled");this._disabledInputs=a.map(this._disabledInputs,function(a){return a==b?null:a});this._disabledInputs[this._disabledInputs.length]=b}},_isDisabledDatepicker:function(a){if(!a)return!1;for(var c=0;c<this._disabledInputs.length;c++)if(this._disabledInputs[c]==a)return!0;return!1},_getInst:function(b){try{return a.data(b,"datepicker")}catch(c){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(b,d,e){var g=this._getInst(b);if(2==arguments.length&&"string"==typeof d)return"defaults"==
        d?a.extend({},a.datepicker._defaults):g?"all"==d?a.extend({},g.settings):this._get(g,d):null;var h=d||{};"string"==typeof d&&(h={},h[d]=e);if(g){this._curInst==g&&this._hideDatepicker();var p=this._getDateDatepicker(b,!0),q=this._getMinMaxDate(g,"min"),m=this._getMinMaxDate(g,"max");f(g.settings,h);null!==q&&h.dateFormat!==c&&h.minDate===c&&(g.settings.minDate=this._formatDate(g,q));null!==m&&h.dateFormat!==c&&h.maxDate===c&&(g.settings.maxDate=this._formatDate(g,m));this._attachments(a(b),g);this._autoSize(g);
    ...
    (b=a("input",b.parentNode)[0]);if(!(a.datepicker._isDisabledDatepicker(b)||a.datepicker._lastInput==b)){var c=a.datepicker._getInst(b);a.datepicker._curInst&&a.datepicker._curInst!=c&&(a.datepicker._curInst.dpDiv.stop(!0,!0),c&&a.datepicker._datepickerShowing&&a.datepicker._hideDatepicker(a.datepicker._curInst.input[0]));var d=a.datepicker._get(c,"beforeShow"),d=d?d.apply(b,[b,c]):{};if(!1!==d){f(c.settings,d);c.lastVal=null;a.datepicker._lastInput=b;a.datepicker._setDateFromField(c);a.datepicker._inDialog&&
    (b.value="");a.datepicker._pos||(a.datepicker._pos=a.datepicker._findPos(b),a.datepicker._pos[1]+=b.offsetHeight);var e=!1;a(b).parents().each(function(){e=e|a(this).css("position")=="fixed";return!e});e&&a.browser.opera&&(a.datepicker._pos[0]-=document.documentElement.scrollLeft,a.datepicker._pos[1]-=document.documentElement.scrollTop);d={left:a.datepicker._pos[0],top:a.datepicker._pos[1]};a.datepicker._pos=null;c.dpDiv.empty();c.dpDiv.css({position:"absolute",display:"block",top:"-1000px"});a.datepicker._updateDatepicker(c);
        ...
        b.dpDiv.find("."+this._dayOverClass+" a").mouseover();c=this._getNumberOfMonths(b);d=c[1];b.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<d&&b.dpDiv.addClass("ui-datepicker-multi-"+d).css("width",17*d+"em");b.dpDiv[(1!=c[0]||1!=c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");b.dpDiv[(this._get(b,"isRTL")?"add":"remove")+"Class"]("ui-datepicker-rtl");b==a.datepicker._curInst&&a.datepicker._datepickerShowing&&b.input&&b.input.is(":visible")&&
            !b.input.is(":disabled")&&b.input[0]!=document.activeElement&&b.input.focus();if(b.yearshtml){var f=b.yearshtml;setTimeout(function(){f===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);f=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),
    ...
    _clearDate:function(b){b=a(b);this._getInst(b[0]);this._selectDate(b,"")},_selectDate:function(b,c){var d=this._getInst(a(b)[0]),c=null!=c?c:this._formatDate(d);d.input&&d.input.val(c);this._updateAlternate(d);var e=this._get(d,"onSelect");e?e.apply(d.input?d.input[0]:null,[c,d]):d.input&&d.input.trigger("change");d.inline?this._updateDatepicker(d):(this._hideDatepicker(),this._lastInput=d.input[0],"object"!=typeof d.input[0]&&d.input.focus(),this._lastInput=null)},_updateAlternate:function(b){var c=
        ...
        c="object"==typeof c?c.toString():c+"";if(""==c)return null;for(var e=(d?d.shortYearCutoff:null)||this._defaults.shortYearCutoff,e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,h=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,m=(d?d.monthNames:null)||this._defaults.monthNames,x=d=-1,r=-1,D=-1,F=!1,w=function(a){(a=O+1<b.length&&b.charAt(O+1)==a)&&O++;return a},B=function(a){var b=
            w(a),a=c.substring(A).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+A;A+=a[0].length;return parseInt(a[0],10)},z=function(b,d,e){var b=a.map(w(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(A,d.length).toLowerCase()==d.toLowerCase())return f=b[0],A+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+A;},H=function(){if(c.charAt(A)!=
            b.charAt(O))throw"Unexpected literal at position "+A;A++},A=0,O=0;O<b.length;O++)if(F)"'"==b.charAt(O)&&!w("'")?F=!1:H();else switch(b.charAt(O)){case "d":r=B("d");break;case "D":z("D",f,g);break;case "o":D=B("o");break;case "m":x=B("m");break;case "M":x=z("M",h,m);break;case "y":d=B("y");break;case "@":var I=new Date(B("@")),d=I.getFullYear(),x=I.getMonth()+1,r=I.getDate();break;case "!":I=new Date((B("!")-this._ticksTo1970)/1E4);d=I.getFullYear();x=I.getMonth()+1;r=I.getDate();break;case "'":w("'")?
            H():F=!0;break;default:H()}if(A<c.length)throw"Extra/unparsed characters found in date: "+c.substring(A);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<D){x=1;r=D;do{e=this._getDaysInMonth(d,x-1);if(r<=e)break;x++;r-=e}while(1)}I=this._daylightSavingAdjust(new Date(d,x-1,r));if(I.getFullYear()!=d||I.getMonth()+1!=x||I.getDate()!=r)throw"Invalid date";return I},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",
    RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,h=function(c){(c=w+1<
        a.length&&a.charAt(w+1)==c)&&w++;return c},m=function(a,b,c){b=""+b;if(h(a))for(;b.length<c;)b="0"+b;return b},x=function(a,b,c,d){return h(a)?d[b]:c[b]},r="",D=!1;if(c)for(var w=0;w<a.length;w++)if(D)"'"==a.charAt(w)&&!h("'")?D=!1:r+=a.charAt(w);else switch(a.charAt(w)){case "d":r+=m("d",c.getDate(),2);break;case "D":r+=x("D",c.getDay(),e,f);break;case "o":r+=m("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;
        case "m":r+=m("m",c.getMonth()+1,2);break;case "M":r+=x("M",c.getMonth(),g,d);break;case "y":r+=h("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":r+=c.getTime();break;case "!":r+=1E4*c.getTime()+this._ticksTo1970;break;case "'":h("'")?r+="'":D=!0;break;default:r+=a.charAt(w)}return r},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+=
        ...
        c.getMonth(),c.getDate())),d=this._get(b,"isRTL"),e=this._get(b,"showButtonPanel"),f=this._get(b,"hideIfNoPrevNext"),g=this._get(b,"navigationAsDateFormat"),m=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),x=this._get(b,"stepMonths"),r=1!=m[0]||1!=m[1],w=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),F=this._getMinMaxDate(b,"min"),E=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,B=b.drawYear;0>s&&(s+=12,B--);if(E)for(var z=
        this._daylightSavingAdjust(new Date(E.getFullYear(),E.getMonth()-m[0]*m[1]+1,E.getDate())),z=F&&z<F?F:z;this._daylightSavingAdjust(new Date(B,s,1))>z;)s--,0>s&&(s=11,B--);b.drawMonth=s;b.drawYear=B;var z=this._get(b,"prevText"),z=!g?z:this.formatDate(z,this._daylightSavingAdjust(new Date(B,s-x,1)),this._getFormatConfig(b)),z=this._canAdjustMonth(b,-1,B,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', -"+x+", 'M');\" title=\""+z+'"><span class="ui-icon ui-icon-circle-triangle-'+
        (d?"e":"w")+'">'+z+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>",H=this._get(b,"nextText"),H=!g?H:this.formatDate(H,this._daylightSavingAdjust(new Date(B,s+x,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,B,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', +"+x+", 'M');\" title=\""+H+'"><span class="ui-icon ui-icon-circle-triangle-'+
        (d?"w":"e")+'">'+H+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+H+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+H+"</span></a>",x=this._get(b,"currentText"),H=this._get(b,"gotoCurrent")&&b.currentDay?w:c,x=!g?x:this.formatDate(x,H,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+h+'.datepicker._hideDatepicker();">'+this._get(b,
        "closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,H)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._gotoToday('#"+b.id+"');\">"+x+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,x=this._get(b,"showWeek"),H=this._get(b,"dayNames");this._get(b,"dayNamesShort");var A=this._get(b,"dayNamesMin"),O=
        this._get(b,"monthNames"),I=this._get(b,"monthNamesShort"),u=this._get(b,"beforeShowDay"),Y=this._get(b,"showOtherMonths"),T=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var i=this._getDefaultDate(b),U="",G=0;G<m[0];G++){var t="";this.maxRows=4;for(var R=0;R<m[1];R++){var N=this._daylightSavingAdjust(new Date(B,s,b.selectedDay)),L=" ui-corner-all",J="";if(r){J+='<div class="ui-datepicker-group';if(1<m[1])switch(R){case 0:J+=" ui-datepicker-group-first";L=" ui-corner-"+(d?"right":
        "left");break;case m[1]-1:J+=" ui-datepicker-group-last";L=" ui-corner-"+(d?"left":"right");break;default:J+=" ui-datepicker-group-middle",L=""}J+='">'}for(var J=J+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+L+'">'+(/all|left/.test(L)&&0==G?d?f:z:"")+(/all|right/.test(L)&&0==G?d?z:f:"")+this._generateMonthYearHeader(b,s,B,F,E,0<G||0<R,O,I)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),Q=x?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":
        "",L=0;7>L;L++)var M=(L+g)%7,Q=Q+("<th"+(5<=(L+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+H[M]+'">'+A[M]+"</span></th>");J+=Q+"</tr></thead><tbody>";Q=this._getDaysInMonth(B,s);B==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,Q));L=(this._getFirstDayOfMonth(B,s)-g+7)%7;Q=Math.ceil((L+Q)/7);this.maxRows=Q=r?this.maxRows>Q?this.maxRows:Q:Q;for(var M=this._daylightSavingAdjust(new Date(B,s,1-L)),aa=0;aa<Q;aa++){for(var J=J+"<tr>",V=!x?"":'<td class="ui-datepicker-week-col">'+
        this._get(b,"calculateWeek")(M)+"</td>",L=0;7>L;L++){var W=u?u.apply(b.input?b.input[0]:null,[M]):[!0,""],P=M.getMonth()!=s,Z=P&&!T||!W[0]||F&&M<F||E&&M>E,V=V+('<td class="'+(5<=(L+g+6)%7?" ui-datepicker-week-end":"")+(P?" ui-datepicker-other-month":"")+(M.getTime()==N.getTime()&&s==b.selectedMonth&&b._keyEvent||i.getTime()==M.getTime()&&i.getTime()==N.getTime()?" "+this._dayOverClass:"")+(Z?" "+this._unselectableClass+" ui-state-disabled":"")+(P&&!Y?"":" "+W[1]+(M.getTime()==w.getTime()?" "+this._currentClass:
        "")+(M.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!P||Y)&&W[2]?' title="'+W[2]+'"':"")+(Z?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+b.id+"',"+M.getMonth()+","+M.getFullYear()+', this);return false;"')+">"+(P&&!Y?"&#xa0;":Z?'<span class="ui-state-default">'+M.getDate()+"</span>":'<a class="ui-state-default'+(M.getTime()==c.getTime()?" ui-state-highlight":"")+(M.getTime()==w.getTime()?" ui-state-active":"")+(P?" ui-priority-secondary":"")+'" href="#">'+M.getDate()+"</a>")+
        "</td>");M.setDate(M.getDate()+1);M=this._daylightSavingAdjust(M)}J+=V+"</tr>"}s++;11<s&&(s=0,B++);J+="</tbody></table>"+(r?"</div>"+(0<m[0]&&R==m[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");t+=J}U+=t}U+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return U},_generateMonthYearHeader:function(a,c,d,e,f,g,m,s){var x=this._get(a,"changeMonth"),r=this._get(a,"changeYear"),
        w=this._get(a,"showMonthAfterYear"),F='<div class="ui-datepicker-title">',E="";if(g||!x)E+='<span class="ui-datepicker-month">'+m[c]+"</span>";else{for(var m=e&&e.getFullYear()==d,B=f&&f.getFullYear()==d,E=E+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+h+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),z=0;12>z;z++)if((!m||z>=e.getMonth())&&(!B||z<=f.getMonth()))E+='<option value="'+z+'"'+(z==c?' selected="selected"':"")+">"+s[z]+"</option>";E+="</select>"}w||(F+=E+(g||
        !x||!r?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!r)F+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,"yearRange").split(":"),H=(new Date).getFullYear(),m=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?H+parseInt(a,10):parseInt(a,10);return isNaN(a)?H:a},c=m(s[0]),s=Math.max(c,m(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=f?Math.min(s,f.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+
        h+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':"")+">"+c+"</option>";a.yearshtml+="</select>";F+=a.yearshtml;a.yearshtml=null}F+=this._get(a,"yearSuffix");w&&(F+=(g||!x||!r?"&#xa0;":"")+E);return F+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,
    ...
    (new Date).getTime();a.datepicker.version="1.8.20";m["DP_jQuery_"+h]=a})(w);(function(a,c){var d={buttons:!0,height:!0,maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0,width:!0},g={maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0},f=a.attrFn||{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0,click:!0};a.widget("ui.dialog",{options:{autoOpen:!0,buttons:{},closeOnEscape:!0,closeText:"close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:!1,maxWidth:!1,minHeight:150,
    minWidth:150,modal:!1,position:{my:"center",at:"center",collision:"fit",using:function(c){var d=a(this).css(c).offset().top;0>d&&a(this).css("top",c.top-d)}},resizable:!0,show:null,stack:!0,title:"",width:300,zIndex:1E3},_create:function(){this.originalTitle=this.element.attr("title");"string"!==typeof this.originalTitle&&(this.originalTitle="");this.options.title=this.options.title||this.originalTitle;var c=this,d=c.options,b=d.title||"&#160;",f=a.ui.dialog.getTitleId(c.element),g=(c.uiDialog=a("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+
    d.dialogClass).css({zIndex:d.zIndex}).attr("tabIndex",-1).css("outline",0).keydown(function(b){if(d.closeOnEscape&&!b.isDefaultPrevented()&&b.keyCode&&b.keyCode===a.ui.keyCode.ESCAPE){c.close(b);b.preventDefault()}}).attr({role:"dialog","aria-labelledby":f}).mousedown(function(a){c.moveToTop(false,a)});c.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(g);var o=(c.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(g),
    ...
    f).html(b).prependTo(o);a.isFunction(d.beforeclose)&&!a.isFunction(d.beforeClose)&&(d.beforeClose=d.beforeclose);o.find("*").add(o).disableSelection();d.draggable&&a.fn.draggable&&c._makeDraggable();d.resizable&&a.fn.resizable&&c._makeResizable();c._createButtons(d.buttons);c._isOpen=!1;a.fn.bgiframe&&g.bgiframe()},_init:function(){this.options.autoOpen&&this.open()},destroy:function(){this.overlay&&this.overlay.destroy();this.uiDialog.hide();this.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");
    this.uiDialog.remove();this.originalTitle&&this.element.attr("title",this.originalTitle);return this},widget:function(){return this.uiDialog},close:function(c){var d=this,b,f;if(!1!==d._trigger("beforeClose",c))return d.overlay&&d.overlay.destroy(),d.uiDialog.unbind("keypress.ui-dialog"),d._isOpen=!1,d.options.hide?d.uiDialog.hide(d.options.hide,function(){d._trigger("close",c)}):(d.uiDialog.hide(),d._trigger("close",c)),a.ui.dialog.overlay.resize(),d.options.modal&&(b=0,a(".ui-dialog").each(function(){if(this!==
    d.uiDialog[0]){f=a(this).css("z-index");isNaN(f)||(b=Math.max(b,f))}}),a.ui.dialog.maxZ=b),d},isOpen:function(){return this._isOpen},moveToTop:function(c,d){var b=this.options;if(b.modal&&!c||!b.stack&&!b.modal)return this._trigger("focus",d);b.zIndex>a.ui.dialog.maxZ&&(a.ui.dialog.maxZ=b.zIndex);this.overlay&&(a.ui.dialog.maxZ+=1,this.overlay.$el.css("z-index",a.ui.dialog.overlay.maxZ=a.ui.dialog.maxZ));b={scrollTop:this.element.scrollTop(),scrollLeft:this.element.scrollLeft()};a.ui.dialog.maxZ+=
    ...
    !1;if(b.target===d[0]&&b.shiftKey)return c.focus(1),!1}});a(this.element.find(":tabbable").get().concat(d.find(".ui-dialog-buttonpane :tabbable").get().concat(d.get()))).eq(0).focus();this._isOpen=!0;this._trigger("open");return this}},_createButtons:function(c){var d=this,b=!1,g=a("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),l=a("<div></div>").addClass("ui-dialog-buttonset").appendTo(g);d.uiDialog.find(".ui-dialog-buttonpane").remove();"object"===typeof c&&
    null!==c&&a.each(c,function(){return!(b=!0)});b&&(a.each(c,function(b,c){var c=a.isFunction(c)?{click:c,text:b}:c,g=a('<button type="button"></button>').click(function(){c.click.apply(d.element[0],arguments)}).appendTo(l);a.each(c,function(a,b){if("click"!==a)if(a in f)g[a](b);else g.attr(a,b)});a.fn.button&&g.button()}),g.appendTo(d.uiDialog))},_makeDraggable:function(){function c(a){return{position:a.position,offset:a.offset}}var d=this,b=d.options,f=a(document),g;d.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",
    handle:".ui-dialog-titlebar",containment:"document",start:function(f,j){g="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",f,c(j))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(o,n){b.position=[n.position.left-f.scrollLeft(),n.position.top-f.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(g);d._trigger("dragStop",o,c(n));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
    originalSize:a.originalSize,position:a.position,size:a.size}}var d=d===c?this.options.resizable:d,b=this,f=b.options,g=b.uiDialog.css("position"),d="string"===typeof d?d:"n,e,s,w,se,sw,ne,nw";b.uiDialog.resizable({cancel:".ui-dialog-content",containment:"document",alsoResize:b.element,maxWidth:f.maxWidth,maxHeight:f.maxHeight,minWidth:f.minWidth,minHeight:b._minHeight(),handles:d,start:function(c,d){a(this).addClass("ui-dialog-resizing");b._trigger("resizeStart",c,e(d))},resize:function(a,c){b._trigger("resize",
    a,e(c))},stop:function(c,d){a(this).removeClass("ui-dialog-resizing");f.height=a(this).height();f.width=a(this).width();b._trigger("resizeStop",c,e(d));a.ui.dialog.overlay.resize()}}).css("position",g).find(".ui-resizable-se").addClass("ui-icon ui-icon-grip-diagonal-se")},_minHeight:function(){var a=this.options;return"auto"===a.height?a.minHeight:Math.min(a.minHeight,a.height)},_position:function(c){var d=[],b=[0,0],f;if(c){if("string"===typeof c||"object"===typeof c&&"0"in c)d=c.split?c.split(" "):
    [c[0],c[1]],1===d.length&&(d[1]=d[0]),a.each(["left","top"],function(a,c){+d[a]===d[a]&&(b[a]=d[a],d[a]=c)}),c={my:d.join(" "),at:d.join(" "),offset:b.join(" ")};c=a.extend({},a.ui.dialog.prototype.options.position,c)}else c=a.ui.dialog.prototype.options.position;(f=this.uiDialog.is(":visible"))||this.uiDialog.show();this.uiDialog.css({top:0,left:0}).position(a.extend({of:m},c));f||this.uiDialog.hide()},_setOptions:function(c){var e=this,b={},f=!1;a.each(c,function(a,c){e._setOption(a,c);a in d&&
(f=!0);a in g&&(b[a]=c)});f&&this._size();this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option",b)},_setOption:function(c,d){var b=this.uiDialog;switch(c){case "beforeclose":c="beforeClose";break;case "buttons":this._createButtons(d);break;case "closeText":this.uiDialogTitlebarCloseText.text(""+d);break;case "dialogClass":b.removeClass(this.options.dialogClass).addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+d);break;case "disabled":d?b.addClass("ui-dialog-disabled"):
    b.removeClass("ui-dialog-disabled");break;case "draggable":var f=b.is(":data(draggable)");f&&!d&&b.draggable("destroy");!f&&d&&this._makeDraggable();break;case "position":this._position(d);break;case "resizable":(f=b.is(":data(resizable)"))&&!d&&b.resizable("destroy");f&&"string"===typeof d&&b.resizable("option","handles",d);!f&&!1!==d&&this._makeResizable(d);break;case "title":a(".ui-dialog-title",this.uiDialogTitlebar).html(""+(d||"&#160;"))}a.Widget.prototype._setOption.apply(this,arguments)},
    _size:function(){var c=this.options,d,b,f=this.uiDialog.is(":visible");this.element.show().css({width:"auto",minHeight:0,height:0});c.minWidth>c.width&&(c.width=c.minWidth);d=this.uiDialog.css({height:"auto",width:c.width}).height();b=Math.max(0,c.minHeight-d);"auto"===c.height?a.support.minHeight?this.element.css({minHeight:b,height:"auto"}):(this.uiDialog.show(),c=this.element.css("height","auto").height(),f||this.uiDialog.hide(),this.element.height(Math.max(c,b))):this.element.height(Math.max(c.height-
    ...
    create:function(c){0===this.instances.length&&(setTimeout(function(){a.ui.dialog.overlay.instances.length&&a(document).bind(a.ui.dialog.overlay.events,function(b){if(a(b.target).zIndex()<a.ui.dialog.overlay.maxZ)return!1})},1),a(document).bind("keydown.dialog-overlay",function(b){c.options.closeOnEscape&&!b.isDefaultPrevented()&&b.keyCode&&b.keyCode===a.ui.keyCode.ESCAPE&&(c.close(b),b.preventDefault())}),a(m).bind("resize.dialog-overlay",a.ui.dialog.overlay.resize));var d=(this.oldInstances.pop()||
        ...
        a([]);a.each(a.ui.dialog.overlay.instances,function(){c=c.add(this)});c.css({width:0,height:0}).css({width:a.ui.dialog.overlay.width(),height:a.ui.dialog.overlay.height()})}});a.extend(a.ui.dialog.overlay.prototype,{destroy:function(){a.ui.dialog.overlay.destroy(this.$el)}})})(w);(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,g,f=a.fn.position,h=a.fn.offset;a.fn.position=function(e){if(!e||!e.of)return f.apply(this,arguments);var e=a.extend({},e),b=a(e.of),h=b[0],l=(e.collision||
    "flip").split(" "),o=e.offset?e.offset.split(" "):[0,0],n,m,q;9===h.nodeType?(n=b.width(),m=b.height(),q={top:0,left:0}):h.setTimeout?(n=b.width(),m=b.height(),q={top:b.scrollTop(),left:b.scrollLeft()}):h.preventDefault?(e.at="left top",n=m=0,q={top:e.of.pageY,left:e.of.pageX}):(n=b.outerWidth(),m=b.outerHeight(),q=b.offset());a.each(["my","at"],function(){var a=(e[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=
    c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";e[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===e.at[0]?q.left+=n:"center"===e.at[0]&&(q.left+=n/2);"bottom"===e.at[1]?q.top+=m:"center"===e.at[1]&&(q.top+=m/2);q.left+=o[0];q.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),f=parseInt(a.curCSS(this,"marginLeft",true))||0,h=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+f+
    (parseInt(a.curCSS(this,"marginRight",true))||0),w=d+h+(parseInt(a.curCSS(this,"marginBottom",true))||0),z=a.extend({},q),H;if(e.my[0]==="right")z.left=z.left-c;else if(e.my[0]==="center")z.left=z.left-c/2;if(e.my[1]==="bottom")z.top=z.top-d;else if(e.my[1]==="center")z.top=z.top-d/2;if(!g){z.left=Math.round(z.left);z.top=Math.round(z.top)}H={left:z.left-f,top:z.top-h};a.each(["left","top"],function(b,f){if(a.ui.position[l[b]])a.ui.position[l[b]][f](z,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,
    collisionPosition:H,collisionWidth:j,collisionHeight:w,offset:o,my:e.my,at:e.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(z,{using:e.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(m),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();c.left=0<d?c.left-d:Math.max(c.left-b.collisionPosition.left,c.left)},top:function(c,b){var d=a(m),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop();c.top=0<d?c.top-d:Math.max(c.top-b.collisionPosition.top,c.top)}},
    flip:{left:function(c,b){if("center"!==b.at[0]){var d=a(m),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft(),f="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,g="left"===b.at[0]?b.targetWidth:-b.targetWidth,h=-2*b.offset[0];c.left+=0>b.collisionPosition.left?f+g+h:0<d?f+g+h:0}},top:function(c,b){if("center"!==b.at[1]){var d=a(m),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop(),f="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,g=
        "top"===b.at[1]?b.targetHeight:-b.targetHeight,h=-2*b.offset[1];c.top+=0>b.collisionPosition.top?f+g+h:0<d?f+g+h:0}}}};a.offset.setOffset||(a.offset.setOffset=function(c,b){/static/.test(a.curCSS(c,"position"))&&(c.style.position="relative");var d=a(c),f=d.offset(),g=parseInt(a.curCSS(c,"top",!0),10)||0,h=parseInt(a.curCSS(c,"left",!0),10)||0,f={top:b.top-f.top+g,left:b.left-f.left+h};"using"in b?b.using.call(c,f):d.css(f)},a.fn.offset=function(c){var b=this[0];return!b||!b.ownerDocument?null:c?this.each(function(){a.offset.setOffset(this,
    c)}):h.call(this)});(function(){var c=document.getElementsByTagName("body")[0],b=document.createElement("div"),d,f;d=document.createElement(c?"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};c&&a.extend(f,{position:"absolute",left:"-1000px",top:"-1000px"});for(var h in f)d.style[h]=f[h];d.appendChild(b);f=c||document.documentElement;f.insertBefore(d,f.firstChild);b.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";
    b=a(b).offset(function(a,b){return b}).offset();d.innerHTML="";f.removeChild(d);c=b.top+b.left+(c?2E3:0);g=c>21&&c<22})()})(w);(function(a,c){a.widget("ui.progressbar",{options:{value:0,max:100},min:0,_create:function(){this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min,"aria-valuemax":this.options.max,"aria-valuenow":this._value()});this.valueDiv=a("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);
    this.oldValue=this._value();this._refreshValue()},destroy:function(){this.element.removeClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");this.valueDiv.remove();a.Widget.prototype.destroy.apply(this,arguments)},value:function(a){if(a===c)return this._value();this._setOption("value",a);return this},_setOption:function(c,g){"value"===c&&(this.options.value=g,this._refreshValue(),this._value()===
    ...
    "%");this.element.attr("aria-valuenow",a)}});a.extend(a.ui.progressbar,{version:"1.8.20"})})(w);(function(a){a.widget("ui.slider",a.ui.mouse,{widgetEventPrefix:"slide",options:{animate:!1,distance:0,max:100,min:0,orientation:"horizontal",range:!1,step:1,value:0,values:null},_create:function(){var c=this,d=this.options,g=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),f=d.values&&d.values.length||1,h=[];this._mouseSliding=this._keySliding=!1;this._animateOff=!0;this._handleIndex=
    ...
    d.range?" ui-slider-range-"+d.range:""))}for(var e=g.length;e<f;e+=1)h.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");this.handles=g.add(a(h.join("")).appendTo(c.element));this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(a){a.preventDefault()}).hover(function(){d.disabled||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).focus(function(){d.disabled?a(this).blur():(a(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),
    ...
    this._mouseDestroy();return this},_mouseCapture:function(c){var d=this.options,g,f,h,e,b;if(d.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();g=this._normValueFromMouse({x:c.pageX,y:c.pageY});f=this._valueMax()-this._valueMin()+1;e=this;this.handles.each(function(c){var d=Math.abs(g-e.values(c));f>d&&(f=d,h=a(this),b=c)});!0===d.range&&this.values(1)===d.min&&(b+=1,h=a(this.handles[b]));if(!1===this._start(c,
    b))return!1;this._mouseSliding=!0;e._handleIndex=b;h.addClass("ui-state-active").focus();d=h.offset();this._clickOffset=!a(c.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:c.pageX-d.left-h.width()/2,top:c.pageY-d.top-h.height()/2-(parseInt(h.css("borderTopWidth"),10)||0)-(parseInt(h.css("borderBottomWidth"),10)||0)+(parseInt(h.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(c,b,g);return this._animateOff=!0},_mouseStart:function(){return!0},
    _mouseDrag:function(a){var d=this._normValueFromMouse({x:a.pageX,y:a.pageY});this._slide(a,this._handleIndex,d);return!1},_mouseStop:function(a){this.handles.removeClass("ui-state-active");this._mouseSliding=!1;this._stop(a,this._handleIndex);this._change(a,this._handleIndex);this._clickOffset=this._handleIndex=null;return this._animateOff=!1},_detectOrientation:function(){this.orientation="vertical"===this.options.orientation?"vertical":"horizontal"},_normValueFromMouse:function(a){var d;"horizontal"===
        this.orientation?(d=this.elementSize.width,a=a.x-this.elementOffset.left-(this._clickOffset?this._clickOffset.left:0)):(d=this.elementSize.height,a=a.y-this.elementOffset.top-(this._clickOffset?this._clickOffset.top:0));d=a/d;1<d&&(d=1);0>d&&(d=0);"vertical"===this.orientation&&(d=1-d);a=this._valueMax()-this._valueMin();return this._trimAlignValue(this._valueMin()+d*a)},_start:function(a,d){var g={handle:this.handles[d],value:this.value()};this.options.values&&this.options.values.length&&(g.value=
        this.values(d),g.values=this.values());return this._trigger("start",a,g)},_slide:function(a,d,g){var f;if(this.options.values&&this.options.values.length){f=this.values(d?0:1);if(2===this.options.values.length&&!0===this.options.range&&(0===d&&g>f||1===d&&g<f))g=f;g!==this.values(d)&&(f=this.values(),f[d]=g,a=this._trigger("slide",a,{handle:this.handles[d],value:g,values:f}),this.values(d?0:1),!1!==a&&this.values(d,g,!0))}else g!==this.value()&&(a=this._trigger("slide",a,{handle:this.handles[d],value:g}),
        !1!==a&&this.value(g))},_stop:function(a,d){var g={handle:this.handles[d],value:this.value()};this.options.values&&this.options.values.length&&(g.value=this.values(d),g.values=this.values());this._trigger("stop",a,g)},_change:function(a,d){if(!this._keySliding&&!this._mouseSliding){var g={handle:this.handles[d],value:this.value()};this.options.values&&this.options.values.length&&(g.value=this.values(d),g.values=this.values());this._trigger("change",a,g)}},value:function(a){if(arguments.length)this.options.value=
        this._trimAlignValue(a),this._refreshValue(),this._change(null,0);else return this._value()},values:function(c,d){var g,f,h;if(1<arguments.length)this.options.values[c]=this._trimAlignValue(d),this._refreshValue(),this._change(null,c);else if(arguments.length)if(a.isArray(arguments[0])){g=this.options.values;f=arguments[0];for(h=0;h<g.length;h+=1)g[h]=this._trimAlignValue(f[h]),this._change(null,h);this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(c):this.value();
    else return this._values()},_setOption:function(c,d){var g,f=0;a.isArray(this.options.values)&&(f=this.options.values.length);a.Widget.prototype._setOption.apply(this,arguments);switch(c){case "disabled":d?(this.handles.filter(".ui-state-focus").blur(),this.handles.removeClass("ui-state-hover"),this.handles.propAttr("disabled",!0),this.element.addClass("ui-disabled")):(this.handles.propAttr("disabled",!1),this.element.removeClass("ui-disabled"));break;case "orientation":this._detectOrientation();
        this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+this.orientation);this._refreshValue();break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(g=0;g<f;g+=1)this._change(null,g);this._animateOff=!1}},_value:function(){var a=this.options.value;return a=this._trimAlignValue(a)},_values:function(a){var d,g;if(arguments.length)return d=this.options.values[a],
        d=this._trimAlignValue(d);d=this.options.values.slice();for(g=0;g<d.length;g+=1)d[g]=this._trimAlignValue(d[g]);return d},_trimAlignValue:function(a){if(a<=this._valueMin())return this._valueMin();if(a>=this._valueMax())return this._valueMax();var d=0<this.options.step?this.options.step:1,g=(a-this._valueMin())%d,a=a-g;2*Math.abs(g)>=d&&(a+=0<g?d:-d);return parseFloat(a.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var c=
        this.options.range,d=this.options,g=this,f=!this._animateOff?d.animate:!1,h,e={},b,j,l,m;if(this.options.values&&this.options.values.length)this.handles.each(function(c){h=100*((g.values(c)-g._valueMin())/(g._valueMax()-g._valueMin()));e["horizontal"===g.orientation?"left":"bottom"]=h+"%";a(this).stop(1,1)[f?"animate":"css"](e,d.animate);if(!0===g.options.range)if("horizontal"===g.orientation){if(0===c)g.range.stop(1,1)[f?"animate":"css"]({left:h+"%"},d.animate);if(1===c)g.range[f?"animate":"css"]({width:h-
        b+"%"},{queue:!1,duration:d.animate})}else{if(0===c)g.range.stop(1,1)[f?"animate":"css"]({bottom:h+"%"},d.animate);if(1===c)g.range[f?"animate":"css"]({height:h-b+"%"},{queue:!1,duration:d.animate})}b=h});else{j=this.value();l=this._valueMin();m=this._valueMax();h=m!==l?100*((j-l)/(m-l)):0;e["horizontal"===g.orientation?"left":"bottom"]=h+"%";this.handle.stop(1,1)[f?"animate":"css"](e,d.animate);if("min"===c&&"horizontal"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({width:h+"%"},d.animate);
        if("max"===c&&"horizontal"===this.orientation)this.range[f?"animate":"css"]({width:100-h+"%"},{queue:!1,duration:d.animate});if("min"===c&&"vertical"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({height:h+"%"},d.animate);if("max"===c&&"vertical"===this.orientation)this.range[f?"animate":"css"]({height:100-h+"%"},{queue:!1,duration:d.animate})}}});a.extend(a.ui.slider,{version:"1.8.20"})})(w);(function(a,c){var d=0,g=0;a.widget("ui.tabs",{options:{add:null,ajaxOptions:null,cache:!1,cookie:null,
    ...
    "_").replace(/[^\w\u00c0-\uFFFF-]/g,"")||this.options.idPrefix+ ++d},_sanitizeSelector:function(a){return a.replace(/:/g,"\\:")},_cookie:function(){var c=this.cookie||(this.cookie=this.options.cookie.name||"ui-tabs-"+ ++g);return a.cookie.apply(null,[c].concat(a.makeArray(arguments)))},_ui:function(a,c){return{tab:a,panel:c,index:this.anchors.index(a)}},_cleanup:function(){this.lis.filter(".ui-state-processing").removeClass("ui-state-processing").find("span:data(label.tabs)").each(function(){var c=
    a(this);c.html(c.data("label.tabs")).removeData("label.tabs")})},_tabify:function(d){function g(b,c){b.css("display","");!a.support.opacity&&c.opacity&&b[0].style.removeAttribute("filter")}var e=this,b=this.options,j=/^#.+/;this.list=this.element.find("ol,ul").eq(0);this.lis=a(" > li:has(a[href])",this.list);this.anchors=this.lis.map(function(){return a("a",this)[0]});this.panels=a([]);this.anchors.each(function(c,d){var f=a(d).attr("href"),g=f.split("#")[0],h;if(g&&(g===location.toString().split("#")[0]||
    (h=a("base")[0])&&g===h.href))f=d.hash,d.href=f;j.test(f)?e.panels=e.panels.add(e.element.find(e._sanitizeSelector(f))):f&&"#"!==f?(a.data(d,"href.tabs",f),a.data(d,"load.tabs",f.replace(/#.*$/,"")),f=e._tabId(d),d.href="#"+f,g=e.element.find("#"+f),g.length||(g=a(b.panelTemplate).attr("id",f).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(e.panels[c-1]||e.list),g.data("destroy.tabs",!0)),e.panels=e.panels.add(g)):b.disabled.push(c)});d?(this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
    this.list.addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all"),this.lis.addClass("ui-state-default ui-corner-top"),this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom"),b.selected===c?(location.hash&&this.anchors.each(function(a,c){if(c.hash==location.hash)return b.selected=a,!1}),"number"!==typeof b.selected&&b.cookie&&(b.selected=parseInt(e._cookie(),10)),"number"!==typeof b.selected&&this.lis.filter(".ui-tabs-selected").length&&(b.selected=
    this.lis.index(this.lis.filter(".ui-tabs-selected"))),b.selected=b.selected||(this.lis.length?0:-1)):null===b.selected&&(b.selected=-1),b.selected=0<=b.selected&&this.anchors[b.selected]||0>b.selected?b.selected:0,b.disabled=a.unique(b.disabled.concat(a.map(this.lis.filter(".ui-state-disabled"),function(a){return e.lis.index(a)}))).sort(),-1!=a.inArray(b.selected,b.disabled)&&b.disabled.splice(a.inArray(b.selected,b.disabled),1),this.panels.addClass("ui-tabs-hide"),this.lis.removeClass("ui-tabs-selected ui-state-active"),
    0<=b.selected&&this.anchors.length&&(e.element.find(e._sanitizeSelector(e.anchors[b.selected].hash)).removeClass("ui-tabs-hide"),this.lis.eq(b.selected).addClass("ui-tabs-selected ui-state-active"),e.element.queue("tabs",function(){e._trigger("show",null,e._ui(e.anchors[b.selected],e.element.find(e._sanitizeSelector(e.anchors[b.selected].hash))[0]))}),this.load(b.selected)),a(m).bind("unload",function(){e.lis.add(e.anchors).unbind(".tabs");e.lis=e.anchors=e.panels=null})):b.selected=this.lis.index(this.lis.filter(".ui-tabs-selected"));
    this.element[b.collapsible?"addClass":"removeClass"]("ui-tabs-collapsible");b.cookie&&this._cookie(b.selected,b.cookie);for(var d=0,l;l=this.lis[d];d++)a(l)[-1!=a.inArray(d,b.disabled)&&!a(l).hasClass("ui-tabs-selected")?"addClass":"removeClass"]("ui-state-disabled");!1===b.cache&&this.anchors.removeData("cache.tabs");this.lis.add(this.anchors).unbind(".tabs");if("mouseover"!==b.event){var o=function(a,b){b.is(":not(.ui-state-disabled)")&&b.addClass("ui-state-"+a)};this.lis.bind("mouseover.tabs",
        function(){o("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){o("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var n,p;b.fx&&(a.isArray(b.fx)?(n=b.fx[0],p=b.fx[1]):n=p=b.fx);var q=p?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(p,p.duration||"normal",
        function(){g(c,p);e._trigger("show",null,e._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");e._trigger("show",null,e._ui(b,c[0]))},s=n?function(a,b){b.animate(n,n.duration||"normal",function(){e.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");g(b,n);e.element.dequeue("tabs")})}:function(a,b){e.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e.element.dequeue("tabs")};
    this.anchors.bind(b.event+".tabs",function(){var c=this,d=a(c).closest("li"),f=e.panels.filter(":not(.ui-tabs-hide)"),g=e.element.find(e._sanitizeSelector(c.hash));if(d.hasClass("ui-tabs-selected")&&!b.collapsible||d.hasClass("ui-state-disabled")||d.hasClass("ui-state-processing")||e.panels.filter(":animated").length||e._trigger("select",null,e._ui(this,g[0]))===false){this.blur();return false}b.selected=e.anchors.index(this);e.abort();if(b.collapsible){if(d.hasClass("ui-tabs-selected")){b.selected=
        -1;b.cookie&&e._cookie(b.selected,b.cookie);e.element.queue("tabs",function(){s(c,f)}).dequeue("tabs");this.blur();return false}if(!f.length){b.cookie&&e._cookie(b.selected,b.cookie);e.element.queue("tabs",function(){q(c,g)});e.load(e.anchors.index(this));this.blur();return false}}b.cookie&&e._cookie(b.selected,b.cookie);if(g.length){f.length&&e.element.queue("tabs",function(){s(c,f)});e.element.queue("tabs",function(){q(c,g)});e.load(e.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
    ...
    a.data(this,"href.tabs");c&&(this.href=c);var d=a(this).unbind(".tabs");a.each(["href","load","cache"],function(a,c){d.removeData(c+".tabs")})});this.lis.unbind(".tabs").add(this.panels).each(function(){a.data(this,"destroy.tabs")?a(this).remove():a(this).removeClass("ui-state-default ui-corner-top ui-tabs-selected ui-state-active ui-state-hover ui-state-focus ui-state-disabled ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide")});c.cookie&&this._cookie(null,c.cookie);return this},add:function(d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   g,e){e===c&&(e=this.anchors.length);var b=this,j=this.options,g=a(j.tabTemplate.replace(/#\{href\}/g,d).replace(/#\{label\}/g,g)),d=!d.indexOf("#")?d.replace("#",""):this._tabId(a("a",g)[0]);g.addClass("ui-state-default ui-corner-top").data("destroy.tabs",!0);var l=b.element.find("#"+d);l.length||(l=a(j.panelTemplate).attr("id",d).data("destroy.tabs",!0));l.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide");e>=this.lis.length?(g.appendTo(this.list),l.appendTo(this.list[0].parentNode)):
    (g.insertBefore(this.lis[e]),l.insertBefore(this.panels[e]));j.disabled=a.map(j.disabled,function(a){return a>=e?++a:a});this._tabify();1==this.anchors.length&&(j.selected=0,g.addClass("ui-tabs-selected ui-state-active"),l.removeClass("ui-tabs-hide"),this.element.queue("tabs",function(){b._trigger("show",null,b._ui(b.anchors[0],b.panels[0]))}),this.load(0));this._trigger("add",null,this._ui(this.anchors[e],this.panels[e]));return this},remove:function(c){var c=this._getIndex(c),d=this.options,e=this.lis.eq(c).remove(),
    b=this.panels.eq(c).remove();e.hasClass("ui-tabs-selected")&&1<this.anchors.length&&this.select(c+(c+1<this.anchors.length?1:-1));d.disabled=a.map(a.grep(d.disabled,function(a){return a!=c}),function(a){return a>=c?--a:a});this._tabify();this._trigger("remove",null,this._ui(e.find("a")[0],b[0]));return this},enable:function(c){var c=this._getIndex(c),d=this.options;if(-1!=a.inArray(c,d.disabled))return this.lis.eq(c).removeClass("ui-state-disabled"),d.disabled=a.grep(d.disabled,function(a){return a!=
    ...
    ".tabs");return this},load:function(c){var c=this._getIndex(c),d=this,e=this.options,b=this.anchors.eq(c)[0],g=a.data(b,"load.tabs");this.abort();if(!g||0!==this.element.queue("tabs").length&&a.data(b,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(c).addClass("ui-state-processing");if(e.spinner){var l=a("span",b);l.data("label.tabs",l.html()).html(e.spinner)}this.xhr=a.ajax(a.extend({},e.ajaxOptions,{url:g,success:function(g,j){d.element.find(d._sanitizeSelector(b.hash)).html(g);d._cleanup();
    e.cache&&a.data(b,"cache.tabs",!0);d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{e.ajaxOptions.success(g,j)}catch(l){}},error:function(a,g){d._cleanup();d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{e.ajaxOptions.error(a,g,c,b)}catch(j){}}}));d.element.dequeue("tabs");return this}},abort:function(){this.element.queue([]);this.panels.stop(!1,!0);this.element.queue("tabs",this.element.queue("tabs").splice(-2,2));this.xhr&&(this.xhr.abort(),delete this.xhr);this._cleanup();
    return this},url:function(a,c){this.anchors.eq(a).removeData("cache.tabs").data("load.tabs",c);return this},length:function(){return this.anchors.length}});a.extend(a.ui.tabs,{version:"1.8.20"});a.extend(a.ui.tabs.prototype,{rotation:null,rotate:function(a,c){var d=this,b=this.options,g=d._rotate||(d._rotate=function(c){clearTimeout(d.rotation);d.rotation=setTimeout(function(){var a=b.selected;d.select(++a<d.anchors.length?a:0)},a);c&&c.stopPropagation()}),l=d._unrotate||(d._unrotate=!c?function(a){a.clientX&&
d.rotate(null)}:function(){g()});a?(this.element.bind("tabsshow",g),this.anchors.bind(b.event+".tabs",l),g()):(clearTimeout(d.rotation),this.element.unbind("tabsshow",g),this.anchors.unbind(b.event+".tabs",l),delete this._rotate,delete this._unrotate);return this}})})(w);(function(a){function c(c){if("string"===typeof c.data){var g=c.handler,f=c.data.toLowerCase().split(" ");c.handler=function(c){if(!(this!==c.target&&(/textarea|select/i.test(c.target.nodeName)||"text"===c.target.type))){var d="keypress"!==
    c.type&&a.hotkeys.specialKeys[c.which],b=String.fromCharCode(c.which).toLowerCase(),j="",l={};c.altKey&&"alt"!==d&&(j+="alt+");c.ctrlKey&&"ctrl"!==d&&(j+="ctrl+");c.metaKey&&!c.ctrlKey&&"meta"!==d&&(j+="meta+");c.shiftKey&&"shift"!==d&&(j+="shift+");d?l[j+d]=!0:(l[j+b]=!0,l[j+a.hotkeys.shiftNums[b]]=!0,"shift+"===j&&(l[a.hotkeys.shiftNums[b]]=!0));d=0;for(b=f.length;d<b;d++)if(l[f[d]])return g.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",
...
(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(x(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function L(a,b,c){H(function(d){d=U(d);d.is(a)?d.attr(b):N(a,{classes:c,attributes:b})},null,this)}function J(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=G()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),h=d.createRange();h.setStart(e.endContainer,
    ...
    reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct(!0);this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var b=a("<div/>").html(this.element.val()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),
        ...
        d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;H(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);!b.isRoot(g)&&!a.contains(b.getElement().get(0),g.get(0))&&(g=b.getElement());f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=
        this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(I(d[c[0]][c[1]]),b.updateTagTree()):I(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify){var d=this;a.ui.editor.eachInstance(function(a){a!==d&&a.options.unify&&b(a)})}},
    getUniqueId:function(){return a.ui.editor.getUniqueId()},loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(b,d,e){var e=a.extend({},this.options.message,e),f;f={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=c.setTimeout(function(){this.timer=null;f.hide()},e.delay,this)},hide:function(){this.timer&&(c.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(e.hide)&&
    e.hide.call(this);this.element.remove()},this))}};f.element=a(this.getTemplate("message",{type:b,message:d})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){f.hide()}).end();f.show();return f},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",a,b)},showError:function(a,b){return this.showMessage("circle-close",a,b)},showConfirm:function(a,b){return this.showMessage("circle-check",a,b)},showWarning:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    b){return this.showMessage("alert",a,b)},loadToolbar:function(){var b=this.toolbar=a("<div/>").addClass(this.options.baseClass+"-toolbar"),b=this.toolbarWrapper=a("<div/>").addClass(this.options.baseClass+"-toolbar-wrapper").addClass("ui-widget-content").append(b),d=this.path=a("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),e=this.wrapper=a("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(d).append(b);
        a.fn.draggable&&this.options.draggable&&(e.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:a.proxy(function(){var a=this.persist("position",[e.css("top"),e.css("left")]);e.css({top:Math.abs(a[0]),left:Math.abs(a[1])})},this)}),e.css("position",""),(b=this.persist("position")||this.options.dialogPosition)||(b=[10,10]),parseInt(b[0],10)+e.outerHeight()>a(c).height()&&(b[0]=a(c).height()-e.outerHeight()),parseInt(b[1],10)+e.outerWidth()>a(c).width()&&(b[1]=a(c).width()-e.outerWidth()),
            e.css({top:Math.abs(parseInt(b[0],10)),left:Math.abs(parseInt(b[1],10))}),this.loadMessages());a(function(){e.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(b){this.isToolbarLoaded()||this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(b)if(b.select)b.select();
    else{var d=c.getSelection();d.removeAllRanges();d.addRange(b)}var e=this;a(function(){e.fire("show");e.element.is(":input")||e.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),this.element.is(":input")&&this.element.show(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(){this.unify(function(a){a.hideToolbar()},!1)},isVisible:function(){return this.visible},getTemplate:function(b,c){var d;d=this.templates[b]?this.templates[b]:a.ui.editor.getTemplate(b,
        this.options.urlPrefix);d=d.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return e(b)});c=a.extend({},this.options,c||{});c=this.getTemplateVars(c);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,b){return c[b]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},e;for(e in a)if("object"===typeof a[e]&&5>c){var f=this.getTemplateVars(a[e],b+e,++c),g;for(g in f)d[g]=
        f[g]}else d[b+e]=a[e];return d},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=
        ...
        this.widgetName,a,function(a){E();var c=b.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&B();b.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&"undefined"===typeof this.options.ui[b]||!1===this.options.ui[b]||-1!==a.inArray(b,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var b=0,c=this.options.uiOrder.length;b<c;b++){for(var d=this.options.uiOrder[b],e=a("<div/>"),f=0,g=d.length;f<
        g;f++)if(this.uiEnabled(d[f])){var h=d[f].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(a.ui.editor.ui[d[f]]){var i=a.extend({},a.ui.editor.ui[d[f]]),h=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+h},i.options,this.options.ui[d[f]]);i.editor=this;i.options=h;i.ui=i.init(this,h);i.hotkeys&&ia&&(this.registerHotkey(i.hotkeys,null,i),i.ui.title+=" ("+a.map(i.hotkeys,function(a,b){return b})[0]+")");i.ui.init(d[f],this,h,i).appendTo(e);this.uiObjects[d[f]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
        "-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(b){return a.extend({button:null,options:{},init:function(b,c,d,f){var g=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend({},c.options,{baseClass:c.options.baseClass+"-"+g+"-button"},this.options,c.options.ui[b]);this.title||(this.title=e("Unnamed Button"));this.button=a("<div/>").html(this.label||this.title).addClass(d.baseClass).attr("name",
        b).attr("title",this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+f.editor.widgetName,function(a){a.preventDefault()});var k=this;this.button.bind("mouseup."+f.editor.widgetName,function(a){a.preventDefault();k.click.apply(f,arguments);c.checkChange()});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+g},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||
        null});this.ready.call(f);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},b)},uiSelectMenu:function(b){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(b,c){var d=this;d.select.attr("disabled","disabled");var f=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},c.options,{baseClass:c.options.baseClass+
        f+"-select-menu"},d.options,c.options.ui[b]);d.title||(d.title=e("Unnamed Select Menu"));d.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(d.select.hide()).addClass(d.select.attr("class"));d.selectMenu=a('<div class="ui-editor-selectmenu"/>').appendTo(d.wrapper);d.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(d.wrapper);d.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(d.menu).bind("mouseenter."+
        c.widgetName,function(){a(this).addClass("ui-state-focus")}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-focus")}).bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){var b=d.select.find("option, .ui-editor-selectmenu-option").eq(a(this).index()),b=b.attr("value")||b.val();d.select.val(b);d.update();d.wrapper.removeClass("ui-editor-selectmenu-visible");d.button.addClass("ui-corner-all").removeClass("ui-corner-top");d.change(b);
            return false})});var f=a("<div/>").addClass("ui-editor-selectmenu-text"),g=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",d.title).append(f).append(g).prependTo(d.selectMenu);d.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+
        10&&d.menu.css("min-width",d.button.outerWidth()+10);d.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+c.widgetName,function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover",a(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-hover")});f=d.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html()||d.select.find("option, .ui-editor-selectmenu-option").first().html();
    ...
    getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(b,c,d){var e=this.events;a.each(b.split(","),function(b,f){f=a.trim(f);e[f]||(e[f]=[]);e[f].push({context:d,callback:c})})},unbind:function(a,b,c){for(var d=0,e=this.events[a].length;d<e;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===
        c&&this.events[a].splice(d,1)},fire:function(b,c,d){d||this.fire("before:"+b,c,!0);if(this.events[b])for(var e=0,f=this.events[b].length;e<f;e++){var g=this.events[b][e];"undefined"!==typeof g.callback&&g.callback.call(g.context||this)}!1!==c&&a.ui.editor.fire(b);d||this.fire("after:"+b,c,!0)}});a.extend(a.ui.editor,{elementRemoveComments:function(b){b.contents().each(function(){8==this.nodeType&&a(this).remove()});b.children().each(function(){element.removeComments(a(this))});return b},elementRemoveAttributes:function(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:j,elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===m(a.tagName)},elementDefaultDisplay:m,elementIsValid:n,elementGetStyles:p,elementWrapInner:q,elementToggleStyle:s,elementSwapStyles:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])},fragmentToHtml:x,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:D,rangeIsEmpty:F,selectionSave:E,selectionRestore:B,selectionDestroy:z,selectionEachRange:H,selectionReplace:A,
    selectionSelectInner:O,selectionSelectOuter:I,selectionSelectEdge:u,selectionSelectEnd:Y,selectionSelectStart:T,selectionGetHtml:i,selectionGetElements:G,selectionToggleWrapper:N,selectionExists:function(a){var b=!1;H(function(a){F(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:J,selectionReplaceWithinValidTags:Q,selectionToggleBlockStyle:M,stringStripTags:V,typeIsNumber:W,defaults:{plugins:{},ui:{},bind:{},domTools:{unwrapParentTag:function(b){G().each(function(){a(this).is(b)&&
    a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){H(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){H(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){H(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){H(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:
        this.cloneNode(!0))})},d,this)},inverseWrapWithTagClass:function(b,c,e,f){E();var g="domTools"+Math.ceil(1E7*Math.random());H(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});B()}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,
    ...
    persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===g)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var fa,ga,ia;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:e("Left Align"),click:function(){M({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:e("Justify"),click:function(){M({"text-align":"justify"},a.getElement())}})}},
    alignCenter:{init:function(a){return a.uiButton({title:e("Center Align"),click:function(){M({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:e("Right Align"),click:function(){M({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:e("Bold"),click:function(){N("strong",{classes:b.classes||b.cssPrefix+"bold"})}})}},
    textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:e("Italic"),click:function(){N("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:e("Underline"),click:function(){N("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:e("Strikethrough"),
        click:function(){N("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:e("Sub script"),click:function(){N("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:e("Super script"),click:function(){N("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:e("Blockquote"),icon:"ui-icon-quote",click:function(){N("blockquote",
    {classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{esc:{action:function(){this.confirm()}}},init:function(a){return a.uiButton({name:"cancel",title:e("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor,d=function(){return b.options.callback&&a.isFunction(b.options.callback)&&!1===b.options.callback.call(b)?!1:!0};c.isDirty()?(this.dialog||(this.dialog=
    a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,resizable:!1,title:e("Confirm Cancel Editing"),dialogClass:c.options.dialogClass+" "+c.options.baseClass,show:c.options.dialogShowAnimation,hide:c.options.dialogHideAnimation,buttons:[{text:e("OK"),click:function(){d()&&b.cancel();a(this).dialog("close")}},{text:e("Cancel"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
    b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove()}})):d()&&b.cancel()}}});a.ui.editor.registerPlugin({cancel:{options:{callback:null},cancel:function(){this.editor.unify(function(a){a.fire("cancel");a.resetHtml();a.hideToolbar();a.disableEditing();z()})}}});a.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"span,h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div".split(","),
    stripEmptyAttrs:["class","id","style"],stripDomains:[{selector:"a",attributes:["href"]},{selector:"img",attributes:["src"]}]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var b,d=this.editor;for(b=0;b<this.options.stripAttrs.length;b++)d.getElement().find("["+this.options.stripAttrs[b]+"]").removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripAttrContent.length;b++)d.getElement().find("["+b+'="'+this.options.stripAttrs[b]+'"]').removeAttr(this.options.stripAttrs[b]);
    for(b=0;b<this.options.stripEmptyTags.length;b++)d.getElement().find(this.options.stripEmptyTags[b]).filter(function(){if(a(this).hasClass(d.options.supplementaryClass)||a(this).hasClass("rangySelectionBoundary")&&!1!==$)return!1;if(""===a.trim(a(this).html()))return!0}).remove();for(b=0;b<this.options.stripEmptyAttrs.length;b++){var e=this.options.stripEmptyAttrs[b];d.getElement().find("["+this.options.stripEmptyAttrs[b]+"]").filter(function(){return""===a.trim(a(this).attr(e))}).removeAttr(this.options.stripEmptyAttrs[b])}var f=
        c.location.protocol+"//"+c.location.host,g="//"+c.location.host;for(b=0;b<this.options.stripDomains.length;b++){var h=this.options.stripDomains[b];this.editor.getElement().find(h.selector).each(function(){for(var b=0;b<h.attributes.length;b++){var c=a(this).attr(h.attributes[b]);"undefined"!==typeof c&&(0===c.indexOf(f)?a(this).attr(h.attributes[b],c.substr(f.length)):0===c.indexOf(g)&&a(this).attr(h.attributes[b],c.substr(g.length)))}})}this.editor.getElement().find("ul, ol").each(function(){a(this).find(" > :not(li)").each(function(){m(a(this).attr("tag"))?
        a(this).replaceWith(a("<li>"+a(this).html()+"</li>").appendTo("body")):a(this).wrap(a("<li>"))})})}});a.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:e("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});a.ui.editor.registerUi({clearFormatting:{init:function(b){return this.editor.uiButton({title:e("Clear Formatting"),click:function(){var c=d.getSelection();if(0<c.rangeCount){var e=c.getRangeAt(0).cloneRange(),f=e.extractContents();
    ""===x(f)&&(b.expandToParent(e),c.setSingleRange(e),f=e.extractContents());f=a("<div/>").append(x(f)).text();for(c=e.commonAncestorContainer;c&&c.parentNode!=b.getElement().get(0);)c=c.parentNode;if(c){e.setEndAfter(c);var g=e.extractContents();e.collapseAfter(c);e.insertNode(g);e.collapseAfter(c)}e.insertNode(document.createTextNode(f))}b.checkChange()}})}}});a.ui.editor.registerPlugin({clickButtonToEdit:{hovering:!1,buttonClass:null,buttonSelector:null,button:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}},
    callback:null},init:function(b,d){var e=this;this.buttonClass=this.options.baseClass+"-button-element";this.buttonSelector="."+this.buttonClass;this.show=function(){if(!b.isEditing()){b.getElement().addClass(d.baseClass+"-highlight");b.getElement().addClass(d.baseClass+"-hover");var f=e.getButton();var g=b.getElement(),g=a(g),h=Math.round(g.offset().top),i=Math.round(g.offset().left),j=Math.round(g.outerWidth()),g=Math.round(g.outerHeight()),l=a(c).scrollTop(),m=a(c).height(),n=l+m,o=Math.round(g+
    h);l<h&&n>o||(l>h&&(h=l),g=n<o?n-h:m-(n-o));f.css({position:"absolute",top:h+(g/2-a(f).outerHeight()/2),left:i+j/2-a(f).outerWidth()/2})}};this.hide=function(c){var f=e.getButton();if(!c||!(c.relatedTarget===f.get(0)||f.get(0)===a(c.relatedTarget).parent().get(0)))b.getElement().removeClass(d.baseClass+"-highlight"),b.getElement().removeClass(d.baseClass+"-hover"),e.destroyButton()};this.edit=function(){if(e.options.callback&&a.isFunction(e.options.callback)&&!1===e.options.callback.call(e))return!1;
    e.hide();b.isEditing()||b.enableEditing();b.isVisible()||b.showToolbar()};this.buttonOut=function(c){c.relatedTarget===e.getButton().get(0)||c.relatedTarget===b.getElement().get(0)||a.contains(b.getElement().get(0),c.relatedTarget)||e.hide()};b.getElement().addClass("ui-editor-click-button-to-edit");b.bind("ready, hide, cancel",function(){b.getElement().bind("mouseenter."+b.widgetName,e.show);b.getElement().bind("mouseleave."+b.widgetName,e.hide)});b.bind("show",function(){e.destroyButton();b.getElement().unbind("mouseenter."+
    ...
    this.bind("cancel",this.cancel);this.bind("destroy",this.destroy,this)},show:function(){this.enabled?this.isDocked()&&this.showSpacers():((this.loadState()||this.options.docked)&&this.dock(),this.enabled=!0)},hide:function(){this.hideSpacers();this.editor.toolbar.css("width","auto")},resize:function(){if(this.editor.toolbar&&!this.options.dockToElement&&this.editor.toolbar.is(":visible")){var b=a("."+this.options.baseClass+"-top-spacer");b.length&&b.height(this.editor.toolbar.outerHeight())}},showSpacers:function(){!this.options.dockToElement&&
    ...
    swapStyle:function(a,b,c){var d={},e;for(e in c)a.css(e,b.css(e)),d[e]=b.css(e),b.css(e,c[e]);return d},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},getDockToElementWrapper:function(){var b=this.options.baseClass+"-docked-to-element-wrapper-"+this.editor.getElement().attr("id");wrapper=a("#"+b);wrapper.length||(wrapper=a("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper").attr("id",b));return wrapper},dockToElement:function(){wrapper=
        ...
        "-docked-to-element");this.editor.wrapper.css("width","auto")},dockToBody:function(){var b=0;a(this.options.dockUnder).length&&(b=a(this.options.dockUnder).outerHeight());this.top=this.editor.toolbarWrapper.css("top");this.editor.toolbarWrapper.css("top",b);this.editor.wrapper.addClass(this.options.baseClass+"-docked");this.editor.messages.css("top",b+this.editor.toolbar.outerHeight())},undockFromBody:function(){this.editor.toolbarWrapper.css("top",this.top);this.editor.wrapper.removeClass(this.options.baseClass+
...
a(this.dialog).dialog("destroy").remove();this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;E();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:e("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:e("Embed Object"),click:function(){B();A(a(this).find("textarea").val());
    ...
    this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:e("Insert Horizontal Rule"),click:function(){A("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=a('<select autocomplete="off" name="i18n"/>'),f;for(f in Z){var g=a('<option value="'+f+'" class="'+f+'"/>');g.html(ea[f]);P===f&&g.attr("selected","selected");d.append(g)}return b.uiSelectMenu({title:e("Change Language"),select:d,change:function(a){h(c.persist("locale",a))}})}}});f("de",
    "Deutsch",{"A preview of your embedded object is displayed below.":"Eine Vorschau ihres eingebundenen Objekts wird unterhalb angezeigt.","Added link: {{link}}":"Link hinzugef\u00fcgt: {{link}}","All changes will be lost!":"Alle \u00c4nderungen gehen verloren!","Apply Source":"Quellcode anwenden","Are you sure you want to stop editing?":"Wollen Sie wirklich mit der Bearbeitung aufh\u00f6ren?",Blockquote:"Zitat",Bold:"Fett",Cancel:"Abbrechen","Center Align":"Zentrieren","Change HTML tag of selected element":"HTML Tag des selektierten Elements \u00e4ndern",
        ...
        "{{sentences}} sentences":"{{sentences}} S\u00e4tze","{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});f("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",
    ...
    "{{sentences}} sentences":"{{sentences}} oraciones","{{words}} word":"{{words}} palabra","{{words}} words":"{{words}} palabras"});f("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.","Added link: {{link}}":"Lien ajout\u00e9 : {{link}}","All changes will be lost!":"Toutes les modifications seront perdues !","Apply Source":"Appliquer la source","Are you sure you want to stop editing?":"\u00cates-vous s\u00fbr(e) de vouloir arr\u00eater la modification ?",
    ...
    "{{words}} words":"{{words}} mots"});f("nl","Nederlands",{"A preview of your embedded object is displayed below.":"Een voorbeeldweergave van uw ingenestelde object is hieronder weergeven.","Added link: {{link}}":"Link toegevoegd:: {{link}}","All changes will be lost!":"Alle aanpassingen zullen verloren gaan!","Apply Source":"Broncode toepassen","Are you sure you want to stop editing?":"Weet u zeker dat u wilt stoppen met aanpassen? ",Blockquote:"Blokcitaat",Bold:"Vetgedrukt",Cancel:"Annuleren","Center Align":"Centreren",
    ...
    "{{sentences}} sentences":"{{sentences}} meningar","{{words}} word":"{{words}} ord","{{words}} words":"{{words}} ord"});f("zh-CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
    ...
    this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&this.detachEvent("onpropertychange",a.resized)})},imageResizedByUser:function(b){var c=a(b.target);c.is("img")&&c.attr("_moz_resizing")&&"style"==b.attrName&&b.newValue.match(/width|height/)&&this.editor.fire("change")},scanForOversizedImages:function(){var b=this.editor.getElement(),c=[];a(b.find("img")).each(function(){b.width()<a(this).outerWidth()&&c.push(a(this))});c.length&&this.resizeOversizedImages(c,b.width())},resizeOversizedImages:function(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   c){for(var d=a("<a>",{href:"",target:"_blank"}),e=0;e<b.length;e++){var f=b[e],g=f.outerWidth();f.outerHeight();var h=Math.min(c/g),g=Math.round(Math.abs(h*(g-(f.outerWidth()-f.width()))));f.addClass(this.options.resizingClass);d=d.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));a(f).css({width:g});var i=this;this.showOversizeWarning(l(a(d)),{hide:function(){f.removeClass(i.options.resizingClass)}})}},cancel:function(){this.removeClasses();
        this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(e("The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.",{image:a}),b)},removeClasses:function(b){b||(b=[this.options.resizingClass,this.options.manuallyResizingClass]);a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},
        manuallyResizeImage:function(b){this.removeToolsButtons();var c=this.editor.getElement().find("img."+this.options.manuallyResizingClass),d=a(c).innerWidth(),f=a(c).innerHeight(),g="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,j=function(b){b=Math.round(b||a(g).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:f,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:e("Modify Image Size"),
            autoOpen:!0,buttons:[{text:e("Resize Image"),click:function(){j(a(this).find(g).val());a(this).dialog("close")}},{text:e("Cancel"),click:function(){j(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(g),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(f/d*a(this).val())));j()});c.keyup(function(){b.val(Math.round(Math.abs(d/f*a(this).val())));j()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=
        a("<button>"+e("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",top:a(b).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,this));c.addClass(this.editor.options.supplementaryClass).find("span").addClass(this.editor.options.supplementaryClass);a(b).before(c)},removeToolsButtons:function(){this.editor.getElement().find("."+
        this.options.resizeButtonClass).each(function(){a(this).remove()})},imageMouseEnter:function(b){a(b.target).addClass(this.options.manuallyResizingClass);this.displayToolsButtonRelativeToImage(b.target)},imageMouseLeave:function(b){a(b.relatedTarget).hasClass(this.options.resizeButtonClass)||(a(b.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:function(){return e("Page on this or another website")},
...
this.plugin.editor.showWarning(e("The url for the file you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-file-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||b.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-file-url",message:e("The URL does not look well formed")}))),
    b.find(c).not(":visible").show(),d=!1);return d}}],init:function(b,c){this.options=a.extend({},{panelAnimation:"fade",replaceTypes:!1,customTypes:[],typeDataName:"uiWidgetEditorLinkType",dialogWidth:750,dialogHeight:"auto",dialogMinWidth:670,regexLink:/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i,regexEmail:/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/},c);b.bind("save",
    this.repairLinks,this);b.bind("cancel",this.cancel,this)},initTypes:function(){this.types={};for(var b={type:null,title:null,content:null,plugin:this,options:this.options,attributes:function(){},init:function(){return this},show:function(){},editing:function(b){if(b.attr("class"))for(var c=this.classes.split(/\s/gi),d=0;d<c.length;d++)if(c[d].trim()&&a(b).hasClass(c[d]))return!0;return!1},focusSelector:null,focus:function(){if(this.focusSelector){var b=a(this.focusSelector),c=b.val();b.val("");b.focus().val(c)}}},
                                                                                                         c=null,c=this.options.replaceTypes?this.options.customTypes:a.merge(this.defaultLinkTypes,this.options.customTypes),d,e=0;e<c.length;e++)d=a.extend({},b,c[e],{classes:this.options.baseClass+"-"+c[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){E();this.selectedElement=G().first();var b=this.selectedElement.is("a"),c=this.options,d=this,f=this.dialog=a(this.editor.getTemplate("link.dialog",c)).appendTo("body");this.initTypes();var g=this.dialog.find("fieldset"),h;for(h in this.types){var i=
    a.extend({},this.types[h],{title:this.types[h].title()});a(this.editor.getTemplate("link.label",i)).appendTo(g)}g.find('input[type="radio"]').bind("change."+this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});f.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?e("Edit Link"):e("Insert Link"),dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?e("Update Link"):e("Insert Link"),click:function(){B();d.apply(b)&&
a(this).dialog("close")}},{text:e("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+"-content").hide()},open:function(){d.visible=!0;var c=f.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var e=f.find('.ui-editor-link-menu input[type="radio"]');e.first().attr("checked","checked");var g=!1;if(b)for(var h in d.types)if(g=
    d.types[h].editing(d.selectedElement)){e.filter('[value="'+h+'"]').attr("checked","checked");d.typeChange(d.types[h],b);break}(!b||b&&!g)&&d.typeChange(d.types[e.filter(":checked").val()],b);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(b){13==b.keyCode&&(b=d.types[e.filter(":checked").val()],(!a.isFunction(b.validate)||b.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){B();d.visible=
    !1;f.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;B();var f=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),
    this.editor.showConfirm(e("Updated link: {{link}}",{link:f}))):(L("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(e("Added link: {{link}}",{link:f})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);I(this.selectedElement);E();return!0},typeChange:function(b,c){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=b.ajaxUri&&!this.types[b.type].content;
    f&&e.addClass(this.options.baseClass+"-loading");var g=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:b.ajaxUri,type:"get",success:function(f){d.html(f);g.types[b.type].content=f;e.removeClass(g.options.baseClass+"-loading");b.show(d,c);d.show(g.options.panelAnimation,a.proxy(b.focus,b))}}):(d.html(b.content),b.show(d,c),d.show(g.options.panelAnimation,a.proxy(b.focus,b)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var b=this;this.editor.getElement().find('a[class^="'+
    this.options.baseClass+'"]').each(function(){a(this).data(b.options.baseClass+"-href")&&a(this).attr("href",a(this).data(b.options.baseClass+"-href"))})},cancel:function(){this.dialog&&a(this.dialog.dialog("close"))}});a.ui.editor.registerUi({link:{hotkeys:{"ctrl+l":{action:function(){this.editor.getPlugin("link").show()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);return a.uiButton({title:e("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){G().length?
    this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:e("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){G().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
    validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(b){a(G()).is("li")&&a(G()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){E();var b=[],c=[],d=t(),e=R();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),
        c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),B(),b=G()[0],I(b)):(f?a(d).before(b.join("")):e?a(d).after(b.join("")):J(b.join("")),B(),this.editor.checkChange())},wrapList:function(b){aa(this.editor.getElement());""===a.trim(i())&&O(G());var c=
        a("<div>").html(i()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===m(this.tagName)?V(a(this).html(),e.validChildren):V(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";B();var f=a(G()[0]).parent(),g=this.editor.getElement()[0];f===g||G()[0]===g?A(b):Q(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));O(c.find("li:first")[0]);this.editor.checkChange()},
    toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=t();if(null===e||!e.length)e=this.editor.getElement();var f=R();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),i=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,j=a(f).is(b+" > li")||a(f).parentsUntil(h,
        b+" > li").length;if(i&&j&&g){g=a(D());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],e)&&a.contains(h[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=a.uiButton({title:e("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=
    a.uiButton({title:e("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",b)});return b}}});a.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:e("Learn More About the Raptor WYSIWYG Editor"),click:function(){c.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var b=function(c){var d=typeof c;if("object"!=d||null===c)return"string"==
    d&&(c='"'+c+'"'),""+c;var e=[],f=c&&a.isArray(c);a.each(c,function(a,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=b(c));e.push((f?"":'"'+a+'":')+(""+c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.30?"+
    ...
    hotkeys:{"return":{action:function(){z();var b=""===d.getSelection().toHtml(),c;c=d.getSelection();var e=c.isBackwards()?c.focusNode:c.anchorNode;(c.isBackwards()?c.focusOffset:0!==c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",
        g);Q(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?T(e.next()):f?T(e):(T(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&e.remove()):(T(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){z();var b=this.options.baseClass+"-enter-break",c=a(this.shiftEnter).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?Q(this.options.shiftEnter,this.options.shiftEnterValidTags):A(c);b=a("#"+b).removeAttr("id").next();T(b)},restoreSelection:!1}}});
    a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href","title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var f=!1,g=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(f)return!1;f=!0;E();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");
        a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=V(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};g=a(b.getTemplate("paste.dialog",c));a(g).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
            dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:e("Insert"),click:function(){var c=null,c=a(this).find(".ui-editor-paste-area:visible"),c=c.hasClass("ui-editor-paste-plain")||c.hasClass("ui-editor-paste-source")?c.val():c.html(),c=h.filterAttributes(c),c=h.filterChars(c);B();A(c);b.checkChange();f=!1;a(this).dialog("close")}},{text:e("Cancel"),click:function(){B();f=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
                a(this).addClass("ui-state-active").addClass("ui-tabs-selected");b.children("div").hide().eq(a(this).index()).show()});var c=g.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){f=!1;a(this).dialog("destroy").remove()}});a(".uiWidgetEditorPasteBin").remove()},0);return!0},this))},filterAttributes:function(b){a.each([{regexp:/(<meta\s*[^>]*\s*>)|(<\s*link\s* href="file:[^>]*\s*>)|(<\/?\s*\w+:[^>]*\s*>)/gi,
        ...
        {init:function(b,c){c=a.extend({},{content:"[Your content here]",tag:"p",select:!0},c);this.show=function(){if(!a.trim(b.getElement().html())){var d=a(document.createElement(c.tag)).html(c.content);b.getElement().html(d);c.select&&O(d)}};b.bind("show",this.show)}});a.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:e("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});a.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",
    ...
    c.options.callback.call(c)})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&this.editor.showError(a.responseText)},always:function(){this.dirty===this.saved+this.failed&&(this.options.showResponse||(0<this.failed&&0===this.saved?this.editor.showError(e("Failed to save {{failed}} content block(s).",this)):0<this.failed?this.editor.showError(e("Saved {{saved}} out of {{dirty}} content blocks.",this)):this.editor.showConfirm(e("Successfully saved {{saved}} content block(s).",
        ...
        a.hideToolbar()})}})),this.message.hide(),this.message=null)},ajax:function(b,c){var d=a.extend(!0,{},this.options.ajax);a.isFunction(d.data)?d.data=d.data.apply(this,[b]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(b));a.isFunction(d.url)&&(d.url=d.url.apply(this));c.requests++;a.ajax(d).done(a.proxy(c.done,c)).fail(a.proxy(c.fail,c)).always(a.proxy(c.always,c))}});a.ui.editor.registerUi({save:{options:{plugin:"saveJson"},init:function(a){return a.uiButton({title:e("Save"),
        icon:"ui-icon-save",click:function(){a.checkChange();a.getPlugin(this.options.plugin).save()}})}}});a.ui.editor.registerPlugin({snippet:{ids:[],enabled:!1,init:function(a,b){if(b.snippets){for(var c=0,d=b.snippets.length;c<d;c++)this.createSnippet(b.snippets[c],a);a.bind("restore",this.createButtons,this);a.bind("save",this.disable,this);a.bind("cancel",this.disable,this);a.bind("enabled",this.enable,this);a.bind("disabled",this.disable,this)}},createSnippet:function(){},enable:function(){this.enabled=
        ...
        b,c,this)}),g=b.buttonAfter||c.getElement();a.isFunction(g)?g.call(this,f,b):f.insertAfter(g);a("."+e).button({icons:{primary:"ui-icon-plusthick"}})}},removeButtons:function(){if(this.enabled){for(var b=0,c=this.ids.length;b<c;b++)a("."+this.ids[b]).remove();b=0;for(c=this.options.snippets.length;b<c;b++){var d=this.options.snippets[b];a.isFunction(d.clean)&&d.clean.call(d,this,this.editor)}}},insertSnippet:function(b,c,d){var e=a(b.template).html(),f=b.appendTo||c.getElement();a.isFunction(f)?f.call(this,
        e,b,d):a(e).appendTo(f);c.disableEditing();c.enableEditing()}}});a.ui.editor.registerUi({statistics:{options:{maximum:null,showCountInButton:!0,characterLimitTitle:e("Remaining characters before the recommended character limit is reached. Click to view statistics"),characterCountTitle:e("Click to view statistics")},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.editor.uiButton({title:W(this.options.maximum)?this.options.characterLimitTitle:
        this.options.characterCountTitle,label:e("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=null,c=null,c=a("<div/>").html(this.editor.getCleanHtml()).text().length;W(this.options.maximum)?(b=this.options.maximum-c,c=0<=b?e("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):e("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b})):c=e("{{characters}} characters",{characters:c});var d=this.ui.button;
        !1===this.options.showCountInButton&&d.button("option","text",!1);d.button("option","label",c);d.button("option","text",!0);W(this.options.maximum)&&(0>b?d.addClass("ui-state-error").removeClass("ui-state-default"):0<=b&&15>=b?d.addClass("ui-state-highlight").removeClass("ui-state-error ui-state-default"):d.removeClass("ui-state-highlight ui-state-error").addClass("ui-state-default"))},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:e("Content Statistics"),dialogClass:this.editor.options.dialogClass+
        " "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:e("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,d=this.options.maximum?this.options.maximum-
        b.length:"&infin;",c=W(d)?e("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.maximum}):e("Content will not be truncated"),f=null,f=b.split(" ").length,f=1==f?e("{{words}} word",{words:f}):e("{{words}} words",{words:f}),g=null,g=b.split(". ").length,g=e("{{sentences}} sentences",{sentences:g}),h=null,h=0<=d||!W(d)?e("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:d}):e("{{characters}} characters, {{charactersRemaining}} over the recommended limit",
        {characters:b.length,charactersRemaining:-1*d});return a(this.editor.getTemplate("statistics.dialog",{characters:h,words:f,sentences:g,truncation:c}))}}});a.ui.editor.registerUi({tagMenu:{validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);return b.uiSelectMenu({name:"tagMenu",title:e("Change HTML tag of selected element"),select:a(b.getTemplate("tagmenu.menu")),
        change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=G();if(!i()||""===i()){if(a(e)[0]===a(d)[0])return;E();d=a("<"+c+">").html(e.html());e.replaceWith(d);B()}else{var e=a(G()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(i()).addClass(f);e===d||G()[0]===d?A(c):Q(c,this.validParents);O(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=G()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
        b+"]").length?this.ui.val(b):this.ui.val("na"),a(this.ui.button).toggleClass("ui-state-disabled",this.editor.getElement()[0]===G()[0])):a(this.ui.button).toggleClass("ui-state-disabled",!0)}}});a.ui.editor.registerPlugin("toolbarTip",{init:function(){a.browser.msie||this.bind("show, tagTreeUpdated",function(){a(".ui-editor-wrapper [title]").each(function(){a(this).attr("data-title",a(this).attr("title"));a(this).removeAttr("title")})})}});(function(){var b=null,c=0;a.ui.editor.registerPlugin("unsavedEditWarning",
        {init:function(d){var e=this;b||(b=a(d.getTemplate("unsavededitwarning.warning",this.options)).attr("id",d.getUniqueId()).appendTo("body").bind("mouseenter."+d.widgetName,function(){a.ui.editor.eachInstance(function(a){a.isDirty()&&a.getElement().addClass(e.options.baseClass+"-dirty")})}).bind("mouseleave."+d.widgetName,function(){a("."+e.options.baseClass+"-dirty").removeClass(e.options.baseClass+"-dirty")}));d.bind("dirty",function(){c++;0<c&&(j(b),b.addClass(e.options.baseClass+"-visible"))});
            d.bind("cleaned",function(){c--;0===c&&b.removeClass(e.options.baseClass+"-visible")})}})})();a.ui.editor.registerUi({viewSource:{init:function(a){return a.uiButton({title:e("View / Edit Source"),click:function(){this.show()}})},show:function(){var b=this,c=a(this.editor.getTemplate("viewsource.dialog",{baseClass:b.options.baseClass,source:b.editor.getHtml()})),d=this.ui.button;a(d).button("option","disabled",!0);c.dialog({modal:!1,width:600,height:400,resizable:!0,title:e("View Source"),autoOpen:!0,
        dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:e("Apply Source"),click:function(){var c=a(this).find("textarea").val();b.editor.setHtml(c);a(this).find("textarea").val(b.editor.getHtml())}},{text:e("Close"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove();
            a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var $=!1})(w,m,rangy)})(window);
