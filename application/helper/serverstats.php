...
function build_server_stats($is_install=1, $prev_version='', $charset='')
{
    ...
    $info['is_install'] = ($is_install == 1 ? 1 : 0 );
    ...
    // Check GD & Version
    $info['gd'] = ( array_key_exists('gd', $phpinfo ) ? $phpinfo['gd']['GD Version'] : 0 );
    ...
    $info['allow_url_fopen'] = (ini_get('safe_mode') == 0 && ini_get('allow_url_fopen') ? 1 : 0 );
