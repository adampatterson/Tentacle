...
function email_header( $subject='' )
{
	...
	$html .= 	'</title>
				...
				body {
					...
					font-size:20px;
					line-height:18px;
					background: #DDD url(http://tentaclecms.com/tentacle/images/bg_texturetastic_gray.png);
				}
				img {
					line-height:0;
				}
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#dddddd">
					<tr>
						<td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="3"><img src="http://tentaclecms.com/tentacle/images/spacer.gif" alt="" width="1" height="30" style="display:block;" /></td>
								</tr>
							<tr>
								<td width="14">&nbsp;</td>
								<td colspan="2"><strong style="display:block; color:#000000; font-size:1.8em; font-weight:normal;"><font color="#000000"><img src="http://tentaclecms.com/tentacle/images/tentacle_logo_large.png" alt="Tentacle CMS" width="258" height="63" style="vertical-align:bottom; line-height:0;"></font></strong></td>
								</tr>
							<tr>
								<td colspan="3"><img src="http://tentaclecms.com/tentacle/images/spacer.gif" alt="" width="1" height="30" style="display:block;" /></td>
								</tr>
...
function email_footer( )
{
	$html ='			</td>
							...
							<tr>
								<td><img src="http://tentaclecms.com/tentacle/images/spacer.gif" alt="" width="14" height="1" style="display:block;" /></td>
