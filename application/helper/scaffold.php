                ...
                switch($input['type']) {
                  ...
                  case 'password':
                    $return_data .= '<div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="'.$input_name.'" />
                                        <span class="help-block">'.$input_notes.'</span>
                                    </div>';
                  break;
                  case 'button':
        ...
        unset($data[ 'display' ]);
          ...
          switch($input['type']) {
            case 'text':
                $return_data .= '<div class="form-group">
                                  <label for="'.$input_name.'">'.$input['name'].'</label>
                                  <input type="text" class="form-control" name="'.$input_name.'" value="'.$get_page_meta->$input_name.'"/>
                                </div>';
            break;
            case 'password':
                $return_data .= '<div class="form-group">
                                  <label for="'.$input['name'].'">'.$input['name'].'</label>
                                  <input type="password" class="form-control" name="'.$input['name'].'" value="'.$get_page_meta->$input_name.'"/>
                                </div>';
            break;
            case 'button':
