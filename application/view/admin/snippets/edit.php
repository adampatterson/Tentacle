<? load::view('admin/partials/header', array('title' => 'Edit snippet', 'assets' => array('application')));?>
<div id="wrap">
				...
				<form action="<?= BASE_URL ?>action/update_snippet/<?= $snippet->id; ?>" method="post">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="controls">
								<input type="text" value="<?= text::escape_string($snippet->name); ?>" name="name" id='name' />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="controls">
								<textarea name="content" cols="40" rows="5" name="content"><?= text::escape_string($snippet->content); ?></textarea>
							</div>
						</div>
