<? load::view('admin/partials/template-header', array('title' => 'Comment settings', 'assets' => array('application')));?>
			...
			<!--	<h2>Comment Blacklist</h2>
				...
				<fieldset>
					<div class="clearfix">
						...
						<div class="input">
							<textarea cols="50" rows="10" name="blacklist_keys"><?= get::option('blacklist_keys'); ?></textarea>
