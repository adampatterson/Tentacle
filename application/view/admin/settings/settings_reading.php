<? load::view('admin/partials/template-header', array('title' => 'Reading settings', 'assets' => array('application')));?>
			...
			<div class="one-half">				
				...
				<fieldset>
					<div class="clearfix">
						...
						<div class="input">
							<input type="text" class="mini" value="<?= get::option('posts_per_page'); ?>" id="posts_per_page" name="posts_per_page">
						</div>
					</div>
					<div class="clearfix">
						<label for="posts_per_rss"> Syndication items in feed </label>
						<div class="input">
							<input type="text" class="mini" value="<?= get::option('posts_per_rss'); ?>" id="posts_per_rss" name="posts_per_rss">
						</div>
					</div>
				</fieldset>
			</div>
			<div class="one-half">
				...
				<fieldset>
					<div class="clearfix">
						...
						<div class="input">
							<input type="text" value="<?= get::option('feed_url'); ?>" id="feed_url" name="feed_url">
						</div>
					</div>
					<div class="clearfix">
					...
					<div class="clearfix">
						...
						<div class="input">
							<input type="text" value="<?= get::option('blog_charset'); ?>" id="blog_charset" name="blog_charset">
