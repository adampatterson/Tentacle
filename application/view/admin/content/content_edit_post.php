					...
					<div class="tab-content tab-body" id="my-tab-content">
						<div id="content" class="active tab-pane">
							...
							<? if (user_editor() == 'cke'): ?>
								...
								<p>
									<textarea name="content" id="cke" cols="40" rows="5" class="jquery_ckeditor" placeholder='Content'><?= stripslashes( $get_post->content ) ?></textarea>
								</p>
							<? elseif(user_editor() == 'wysiwyg'):?>
								...
								<p class="wysiwyg">
									<textarea id="Content" name="content" rows="15" cols="80" class="tinymce"><?= stripslashes( $get_post->content ) ?></textarea>
								</p>
