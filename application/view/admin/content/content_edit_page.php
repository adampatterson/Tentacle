<? load::view('admin/templates/template-header', array('title' => 'Edit '.$get_page->title, 'assets' => array('application') ) );?>
					...
					<div class="tab-content tab-body">
						...
						<div id="content" class="active tab-pane">
							...
							<? if(user_editor() == 'wysiwyg'):?>
								...
								<p class="wysiwyg">
									<textarea id="Content" name="content" rows="15" cols="80" class="editor"><?= stripslashes( $get_page->content ) ?></textarea>
								</p>
