<? load::view('admin/template-header', array('title' => 'Manage Pages', 'assets' => 'application'));?>
...
$user_meta = $user->get_meta ( $page->author );
			...
			<tr>
				...
				<td ><?= $page->id?></td>
				<td><?= $page->status?></td>
				<td><a href="<?= ADMIN ?>content_add_page/<?= $page->id;?>" class="btn small">Add</a> <a href="<?= ADMIN ?>content_update_page/<?= $page->id;?>" class="btn small">Edit</a> <a href="#" class="btn small">Duplicate</a> <a href="#" class="btn small danger">Delete</a></td>
