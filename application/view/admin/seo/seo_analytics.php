<? load::view('admin/templates/template-header',array('title'=>'Analytics','assets'=>'application')); ?>
	...
	<div class="full-content">
		<div id="post-body">
			<div id="post-body-content">
			    <div class="one-full">
			     <h1><img src="<?=ADMIN_URL; ?>images/icons/icon_pages_32.png" alt="" /> Analytics</h1>
					<div class="one-half">
						<div class="table">
							<p>
