<? load::view('admin/templates/template-header',array('title'=>'Meta keywords','assets'=>'application')); ?>
<div id="wrap">
	<div class="full-content">
		<div id="post-body">
			<div id="post-body-content">
			    <div class="one-full">
			     <h1><img src="<?=ADMIN_URL; ?>images/icon_pages_32.png" alt="" /> Meta keywords</h1>
					<div class="one-half">
						<div class="table">
							<p>
