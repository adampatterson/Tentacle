	...
	<form class="form-horizontal">
		<fieldset>
			...
			<div class="clearfix">
				...
				<div class="input">
					<input type="text" class="input-xlarge" id="alt_text" name="alt_text">
				</div>
			</div>
			<div class="clearfix">
				<label class="control-label" for="caption">Caption</label>
				<div class="input">
					<input type="text" class="input-xlarge" id="caption" name="caption">
				</div>
			</div>
			<div class="clearfix">
				<label class="control-label" for="link_utl">Link URL</label>
				<div class="input">
					<input type="text" class="input-xlarge" id="link_utl" name="link_utl">
				</div>
			</div>
			<div class="clearfix">
